...
api_process (dwg_object *obj)
{
  ...
  CHK_ENTITY_UTF8TEXT (_obj, SECTIONVIEWSTYLE, name);
  CHK_ENTITY_TYPE (_obj, SECTIONVIEWSTYLE, is_modified_for_recompute, B);
  CHK_ENTITY_UTF8TEXT (_obj, SECTIONVIEWSTYLE, description);
  ...
  CHK_ENTITY_UTF8TEXT (_obj, SECTIONVIEWSTYLE, viewlabel_field);
