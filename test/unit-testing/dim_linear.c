...
api_process (dwg_object *obj)
{
  ...
  double elevation, act_measurement, horiz_dir, lspace_factor,
    text_rotation, ins_rotation, ext_line_rotation, dim_rotation;
  ...
  CHK_ENTITY_TYPE_W_OLD (dim, DIMENSION_LINEAR, lspace_style, BS, lspace_style);
  CHK_ENTITY_TYPE_W_OLD (dim, DIMENSION_LINEAR, lspace_factor, BD, lspace_factor);
  CHK_ENTITY_TYPE_W_OLD (dim, DIMENSION_LINEAR, act_measurement,
                         BD, act_measurement);
  ...
  CHK_ENTITY_TYPE_W_OLD (dim, DIMENSION_LINEAR, text_rotation, BD, text_rotation);
  CHK_ENTITY_3RD_W_OLD (dim, DIMENSION_LINEAR, ins_scale, ins_scale);
  CHK_ENTITY_TYPE_W_OLD (dim, DIMENSION_LINEAR, ins_rotation, BD, ins_rotation);
