...
api_process (dwg_object *obj)
{
  ...
  CHK_ENTITY_TYPE (_obj, FCFOBJECTCONTEXTDATA, class_version, BS, class_version);
  CHK_ENTITY_TYPE (_obj, FCFOBJECTCONTEXTDATA, is_default, B, is_default);
  CHK_ENTITY_TYPE (_obj, FCFOBJECTCONTEXTDATA, in_dwg, B, in_dwg);
