...
api_process (dwg_object *obj)
{
  ...
  CHK_ENTITY_MAX (dim, DIMENSION_DIAMETER, text_rotation, BD, 6.284);
  CHK_ENTITY_MAX (dim, DIMENSION_DIAMETER, ins_rotation, BD, 6.284);
  CHK_ENTITY_MAX (dim, DIMENSION_DIAMETER, horiz_dir, BD, 6.284);
