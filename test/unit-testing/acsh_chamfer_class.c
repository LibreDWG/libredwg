...
api_process (dwg_object *obj)
{
  ...
  CHK_ENTITY_TYPE (_obj, ACSH_CHAMFER_CLASS, class_version, BL); // 90
  CHK_ENTITY_TYPE (_obj, ACSH_CHAMFER_CLASS, ee_bl98, BL); //33
  CHK_ENTITY_TYPE (_obj, ACSH_CHAMFER_CLASS, ee_bl99, BL); //29
  ...
  CHK_ENTITY_TYPE (_obj, ACSH_CHAMFER_CLASS, bl90, BL);
  CHK_ENTITY_TYPE (_obj, ACSH_CHAMFER_CLASS, bl91, BL);
