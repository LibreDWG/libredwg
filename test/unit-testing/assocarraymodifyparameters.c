...
api_process (dwg_object *obj)
{
...
#ifdef DEBUG_CLASSES
  dwg_obj_assocarraymodifyparameters *_obj = dwg_object_to_ASSOCARRAYMODIFYPARAMETERS (obj);
  ...
  if (!dwg_dynapi_entity_value (_obj, "ASSOCARRAYMODIFYPARAMETERS", "items", &items, NULL))
