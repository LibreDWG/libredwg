...
api_process (dwg_object *obj)
{
  ...
  CHK_ENTITY_MAX (dim, DIMENSION_ANG2LN, text_rotation, BD, 6.284);
  CHK_ENTITY_MAX (dim, DIMENSION_ANG2LN, ins_rotation, BD, 6.284);
  CHK_ENTITY_MAX (dim, DIMENSION_ANG2LN, horiz_dir, BD, 6.284);
