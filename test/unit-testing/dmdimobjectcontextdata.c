// TODO DEBUGGING
#define DWG_TYPE DWG_TYPE_DMDIMOBJECTCONTEXTDATA
#include "common.c"
...
api_process (dwg_object *obj)
{
...
#ifdef DEBUG_CLASSES
  dwg_obj_dmdimobjectcontextdata *_obj = dwg_object_to_DMDIMOBJECTCONTEXTDATA (obj);

  CHK_ENTITY_TYPE (_obj, DMDIMOBJECTCONTEXTDATA, class_version, BS);
  CHK_ENTITY_TYPE (_obj, DMDIMOBJECTCONTEXTDATA, is_default, B);
  CHK_ENTITY_TYPE (_obj, DMDIMOBJECTCONTEXTDATA, has_xdic, B);
  CHK_ENTITY_H (_obj, DMDIMOBJECTCONTEXTDATA, scale);
  ...
  CHK_ENTITY_3RD (_obj, DMDIMOBJECTCONTEXTDATA, first_arc_pt);
  CHK_ENTITY_3RD (_obj, DMDIMOBJECTCONTEXTDATA, def_pt);
#endif
}
