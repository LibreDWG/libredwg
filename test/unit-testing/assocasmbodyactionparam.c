...
api_process (dwg_object *obj)
{
  ...
  if (!dwg_dynapi_entity_value (_obj, "ASSOCASMBODYACTIONPARAM", "acis_data", &acis_data, NULL))
  ...
  if (dwg_dynapi_entity_value (_obj, "ASSOCASMBODYACTIONPARAM", "wires", &wires, NULL))
    {
  ...
  if (dwg_dynapi_entity_value (_obj, "ASSOCASMBODYACTIONPARAM", "silhouettes", &silhouettes, NULL))
    {
