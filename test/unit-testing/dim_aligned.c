...
api_process (dwg_object *obj)
{
  ...
  double elevation, act_measurement, horiz_dir, lspace_factor,
    text_rotation, ins_rotation, ext_line_rotation;
  ...
  CHK_ENTITY_TYPE_W_OLD (dim, DIMENSION_ALIGNED, lspace_style, BS, lspace_style);
  CHK_ENTITY_TYPE_W_OLD (dim, DIMENSION_ALIGNED, lspace_factor, BD, lspace_factor);
  CHK_ENTITY_TYPE_W_OLD (dim, DIMENSION_ALIGNED, act_measurement,
                         BD, act_measurement);
  ...
  CHK_ENTITY_TYPE_W_OLD (dim, DIMENSION_ALIGNED, text_rotation, BD, text_rotation);
  CHK_ENTITY_3RD_W_OLD (dim, DIMENSION_ALIGNED, ins_scale, ins_scale);
  CHK_ENTITY_TYPE_W_OLD (dim, DIMENSION_ALIGNED, ins_rotation, BD, ins_rotation);
  ...
  CHK_ENTITY_TYPE (dim_aligned, DIMENSION_ALIGNED, ext_line_rotation,
