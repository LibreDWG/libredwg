...
api_process (dwg_object *obj)
{
  ...
  CHK_ENTITY_TYPE_W_OLD (dim, DIMENSION_ANG3PT, lspace_style, BS, lspace_style);
  CHK_ENTITY_TYPE_W_OLD (dim, DIMENSION_ANG3PT, lspace_factor, BD, lspace_factor);
  CHK_ENTITY_TYPE_W_OLD (dim, DIMENSION_ANG3PT, act_measurement,
                         BD, act_measurement);
  ...
  CHK_ENTITY_TYPE_W_OLD (dim, DIMENSION_ANG3PT, text_rotation, BD, text_rotation);
  CHK_ENTITY_3RD_W_OLD (dim, DIMENSION_ANG3PT, ins_scale, ins_scale);
  CHK_ENTITY_TYPE_W_OLD (dim, DIMENSION_ANG3PT, ins_rotation, BD, ins_rotation);
