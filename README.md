...
at [doc/ODA-5.4.2-libredwg-diff.pdf](doc/ODA-5.4.2-libredwg-diff.pdf)
...
See INSTALL for generic instructions.  Basically, you do:
    ...
    ./configure [--disable-write] [--disable-shared]
    make
    make check
    sudo make install
...
[![Packaging status](https://repology.org/badge/vertical-allrepos/libredwg.svg)](https://repology.org/project/libredwg/versions)
