...
Add a legacy REPEAT entity. Valid only for DWG versions C<r2.10> and older.

=item B<endrep> numcols numrows colspacing rowspacing

Add a legacy ENDREP entity. Valid only for DWG versions C<r2.10> and older.
