...
export const Dwg_Object_Type = Object.freeze({
  ...
  DWG_TYPE_BLOCKANGULARCONSTRAINTPARAMETER: 578,
  DWG_TYPE_BLOCKARRAYACTION: 579,
  DWG_TYPE_BLOCKBASEPOINTPARAMETER: 580,
  DWG_TYPE_BLOCKDIAMETRICCONSTRAINTPARAMETER: 581,
  DWG_TYPE_BLOCKFLIPACTION: 582,
  DWG_TYPE_BLOCKFLIPGRIP: 583,
  DWG_TYPE_BLOCKFLIPPARAMETER: 584,
  DWG_TYPE_BLOCKGRIPLOCATIONCOMPONENT: 585,
  DWG_TYPE_BLOCKHORIZONTALCONSTRAINTPARAMETER: 586,
  DWG_TYPE_BLOCKLINEARCONSTRAINTPARAMETER: 587,
  DWG_TYPE_BLOCKLINEARGRIP: 588,
  DWG_TYPE_BLOCKLINEARPARAMETER: 589,
  DWG_TYPE_BLOCKLOOKUPACTION: 590,
  DWG_TYPE_BLOCKLOOKUPGRIP: 591,
  DWG_TYPE_BLOCKLOOKUPPARAMETER: 592,
  DWG_TYPE_BLOCKMOVEACTION: 593,
  DWG_TYPE_BLOCKPARAMDEPENDENCYBODY: 594,
  DWG_TYPE_BLOCKPOINTPARAMETER: 595,
  DWG_TYPE_BLOCKPOLARGRIP: 596,
  DWG_TYPE_BLOCKPOLARPARAMETER: 597,
  DWG_TYPE_BLOCKPOLARSTRETCHACTION: 598,
  DWG_TYPE_BLOCKPROPERTIESTABLE: 599,
  DWG_TYPE_BLOCKPROPERTIESTABLEGRIP: 600,
  DWG_TYPE_BLOCKRADIALCONSTRAINTPARAMETER: 601,
  DWG_TYPE_BLOCKREPRESENTATION: 602,
  DWG_TYPE_BLOCKROTATEACTION: 603,
  DWG_TYPE_BLOCKROTATIONGRIP: 604,
  DWG_TYPE_BLOCKROTATIONPARAMETER: 605,
  DWG_TYPE_BLOCKSCALEACTION: 606,
  DWG_TYPE_BLOCKSTRETCHACTION: 607,
  DWG_TYPE_BLOCKUSERPARAMETER: 608,
  DWG_TYPE_BLOCKVERTICALCONSTRAINTPARAMETER: 609,
  DWG_TYPE_BLOCKVISIBILITYGRIP: 610,
  DWG_TYPE_BLOCKVISIBILITYPARAMETER: 611,
  DWG_TYPE_BLOCKXYGRIP: 612,
  DWG_TYPE_BLOCKXYPARAMETER: 613,
  DWG_TYPE_CAMERA: 614,
  DWG_TYPE_CELLSTYLEMAP: 615,
  DWG_TYPE_CONTEXTDATAMANAGER: 616,
  DWG_TYPE_CSACDOCUMENTOPTIONS: 617,
  DWG_TYPE_CURVEPATH: 618,
  DWG_TYPE_DATALINK: 619,
  DWG_TYPE_DATATABLE: 620,
  DWG_TYPE_DBCOLOR: 621,
  DWG_TYPE_DETAILVIEWSTYLE: 622,
  DWG_TYPE_DGNDEFINITION: 623,
  DWG_TYPE_DGNUNDERLAY: 624,
  DWG_TYPE_DICTIONARYVAR: 625,
  DWG_TYPE_DICTIONARYWDFLT: 626,
  DWG_TYPE_DIMASSOC: 627,
  DWG_TYPE_DMDIMOBJECTCONTEXTDATA: 628,
  DWG_TYPE_DWFDEFINITION: 629,
  DWG_TYPE_DWFUNDERLAY: 630,
  DWG_TYPE_DYNAMICBLOCKPROXYNODE: 631,
  DWG_TYPE_DYNAMICBLOCKPURGEPREVENTER: 632,
  DWG_TYPE_EVALUATION_GRAPH: 633,
  DWG_TYPE_EXTRUDEDSURFACE: 634,
  DWG_TYPE_FCFOBJECTCONTEXTDATA: 635,
  DWG_TYPE_FIELD: 636,
  DWG_TYPE_FIELDLIST: 637,
  DWG_TYPE_FLIPPARAMETERENTITY: 638,
  ...
  DWG_TYPE_MOTIONPATH: 666,
  DWG_TYPE_MPOLYGON: 667,
  DWG_TYPE_MTEXTATTRIBUTEOBJECTCONTEXTDATA: 668,
  DWG_TYPE_MTEXTOBJECTCONTEXTDATA: 669,
  DWG_TYPE_MULTILEADER: 670,
  DWG_TYPE_NAVISWORKSMODEL: 671,
  DWG_TYPE_NAVISWORKSMODELDEF: 672,
  DWG_TYPE_NPOCOLLECTION: 673,
  DWG_TYPE_NURBSURFACE: 674,
  DWG_TYPE_OBJECT_PTR: 675,
  DWG_TYPE_ORDDIMOBJECTCONTEXTDATA: 676,
  ...
  DWG_TYPE_RTEXT: 704,
  DWG_TYPE_SCALE: 705,
  DWG_TYPE_SECTIONOBJECT: 706,
  DWG_TYPE_SECTIONVIEWSTYLE: 707,
  DWG_TYPE_SECTION_MANAGER: 708,
  DWG_TYPE_SECTION_SETTINGS: 709,
  DWG_TYPE_SKYLIGHT_BACKGROUND: 710,
  DWG_TYPE_SOLID_BACKGROUND: 711,
  DWG_TYPE_SORTENTSTABLE: 712,
  DWG_TYPE_SPATIAL_FILTER: 713,
  DWG_TYPE_SPATIAL_INDEX: 714,
  DWG_TYPE_SUN: 715,
  DWG_TYPE_SUNSTUDY: 716,
  DWG_TYPE_SWEPTSURFACE: 717,
  DWG_TYPE_TABLE: 718,
  DWG_TYPE_TABLECONTENT: 719,
  DWG_TYPE_TABLEGEOMETRY: 720,
  DWG_TYPE_TABLESTYLE: 721,
  DWG_TYPE_TEXTOBJECTCONTEXTDATA: 722,
  DWG_TYPE_TVDEVICEPROPERTIES: 723,
  DWG_TYPE_VISIBILITYGRIPENTITY: 724,
  DWG_TYPE_VISIBILITYPARAMETERENTITY: 725,
  DWG_TYPE_VISUALSTYLE: 726,
  DWG_TYPE_WIPEOUT: 727,
  DWG_TYPE_WIPEOUTVARIABLES: 728,
  DWG_TYPE_XREFPANELOBJECT: 729,
  DWG_TYPE_XYPARAMETERENTITY: 730,
  DWG_TYPE_BREAKDATA: 731,
  DWG_TYPE_BREAKPOINTREF: 732,
  DWG_TYPE_FLIPGRIPENTITY: 733,
  DWG_TYPE_LINEARGRIPENTITY: 734,
  DWG_TYPE_ROTATIONGRIPENTITY: 735,
  DWG_TYPE_XYGRIPENTITY: 736,

  /* preR13 entities */
  DWG_TYPE__3DLINE: 737,
  DWG_TYPE_REPEAT: 738,
  DWG_TYPE_ENDREP: 739,
  DWG_TYPE_JUMP: 740,
  /* pre2.0 entities */
...
export const dwg_getall_LTYPE = (libredwg, data) => {
  return dwg_getall_by_type(libredwg, data, Dwg_Object_Type.DWG_TYPE_LTYPE);
}