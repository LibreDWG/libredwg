...
add_line ( xmlNodePtr rootnode, Dwg_Object dwgobject )
{
  ...
  pointprepare =
    spointprepare ( line->start.x, line->start.y, line->start.z );
...
add_arc ( xmlNodePtr rootnode, Dwg_Object dwgobject )
{
  ...
  pointprepare =
    spointprepare ( arc->center.x, arc->center.y, arc->center.z );
  xmlNewProp ( dwgentity, "Center", pointprepare );
...
add_ray ( xmlNodePtr rootnode, Dwg_Object dwgobject )
{
  ...
  pointprepare =
    spointprepare ( ray->vector.x, ray->vector.y, ray->vector.z );
...
add_text ( xmlNodePtr rootnode, Dwg_Object dwgobject )
{
  ...
  pointprepare =
    spointprepare2 ( text->insertion_pt.x, text->insertion_pt.y );
