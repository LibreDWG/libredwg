...
low_level_process ( dwg_object * obj )
{
  ...
  printf ( "pt10 of dim_linear : x = %f, y = %f, z = %f\t\n",
	   dim_linear->_10_pt.x, dim_linear->_10_pt.y, dim_linear->_10_pt.z );

  // prints 13 point
  printf ( "pt13 of dim_linear : x = %f, y = %f, z = %f\t\n",
	   dim_linear->_13_pt.x, dim_linear->_13_pt.y, dim_linear->_13_pt.z );

  // prints point 14
  printf ( "pt14 of dim_linear : x = %f, y = %f, z = %f\t\n",
	   dim_linear->_14_pt.x, dim_linear->_14_pt.y, dim_linear->_14_pt.z );
...
api_process ( dwg_object * obj )
{
  ...
  // returns user text
  user_text =
    dwg_ent_dim_linear_get_user_text ( dim_linear, &user_text_error );
  ...
  ins_rot =
    dwg_ent_dim_linear_get_ins_rotation ( dim_linear, &ins_rot_error );
