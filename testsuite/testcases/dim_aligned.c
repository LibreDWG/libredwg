...
api_process ( dwg_object * obj )
{
  ...
  ecs11 =
    dwg_ent_dim_aligned_get_elevation_ecs11 ( dim_aligned, &ecs11_error );
  ...
  ecs12 =
    dwg_ent_dim_aligned_get_elevation_ecs12 ( dim_aligned, &ecs12_error );
  ...
  text_rot =
    dwg_ent_dim_aligned_get_text_rot ( dim_aligned, &text_rot_error );
