...
low_level_process ( dwg_object * obj )
{
  ...
  printf ( "pt10 of dim_ang3pt : x = %f, y = %f, z = %f\t\n",
	   dim_ang3pt->_10_pt.x, dim_ang3pt->_10_pt.y, dim_ang3pt->_10_pt.z );

  // prints 13 pt
  printf ( "pt13 of dim_ang3pt : x = %f, y = %f, z = %f\t\n",
	   dim_ang3pt->_13_pt.x, dim_ang3pt->_13_pt.y, dim_ang3pt->_13_pt.z );

  // prints 14 pt
  printf ( "pt14 of dim_ang3pt : x = %f, y = %f, z = %f\t\n",
	   dim_ang3pt->_14_pt.x, dim_ang3pt->_14_pt.y, dim_ang3pt->_14_pt.z );

  // prints 15 pt
  printf ( "pt15 of dim_ang3pt : x = %f, y = %f, z = %f\t\n",
	   dim_ang3pt->_15_pt.x, dim_ang3pt->_15_pt.y, dim_ang3pt->_15_pt.z );
...
api_process ( dwg_object * obj )
{
  ...
  // returns user text
  user_text =
    dwg_ent_dim_ang3pt_get_user_text ( dim_ang3pt, &user_text_error );
  ...
  ins_rot =
    dwg_ent_dim_ang3pt_get_ins_rotation ( dim_ang3pt, &ins_rot_error );
