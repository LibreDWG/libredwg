...
// DWG_GETALL_OBJECT_DECL (VISIBILITYGRIPENTITY)
// DWG_GETALL_OBJECT_DECL (VISIBILITYPARAMETERENTITY)
...
// CAST_DWG_OBJECT_TO_OBJECT_DECL (VISIBILITYGRIPENTITY)
// CAST_DWG_OBJECT_TO_OBJECT_DECL (VISIBILITYPARAMETERENTITY)
