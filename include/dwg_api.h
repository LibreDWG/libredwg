...
GET_DWG_ENTITY_DECL(EXTRUDEDSURFACE)
GET_DWG_ENTITY_DECL(LOFTEDSURFACE)
GET_DWG_ENTITY_DECL(REVOLVEDSURFACE)
GET_DWG_ENTITY_DECL(SWEPTSURFACE)
GET_DWG_ENTITY_DECL(GEOPOSITIONMARKER)
GET_DWG_ENTITY_DECL(HELIX)
