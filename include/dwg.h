...
enum {
  FLAG_APPID_XREF_DEPENDENT = 16,
  FLAG_APPID_XREF_RESOLVED = 32,
  FLAG_APPID_IS_REFERENCED = 64
};

enum {
  FLAG_DIMSTYLE_XREF_DEPENDENT = 16,
  FLAG_DIMSTYLE_XREF_RESOLVED = 32,
  FLAG_DIMSTYLE_IS_REFERENCED = 64
};

enum {
  FLAG_LAYER_FROZEN = 1,
  FLAG_LAYER_FROZEN_IN_NEW_VPORTS = 2,
  FLAG_LAYER_LOCKED = 4,
  FLAG_LAYER_UNKNOWN_8 = 8,
  FLAG_LAYER_XREF_DEPENDENT = 16,
  FLAG_LAYER_XREF_RESOLVED = 32,
  FLAG_LAYER_IS_REFERENCED = 64
};

enum {
  FLAG_LTYPE_XREF_DEPENDENT = 16,
  FLAG_LTYPE_XREF_RESOLVED = 32,
  FLAG_LTYPE_IS_REFERENCED = 64
};

enum {
  FLAG_STYLE_SHAPE = 1,
  FLAG_STYLE_VERTICAL_TEXT = 4,
  FLAG_STYLE_XREF_DEPENDENT = 16,
  FLAG_STYLE_XREF_RESOLVED = 32,
  FLAG_STYLE_IS_REFERENCED = 64
};

enum {
  FLAG_UCS_XREF_DEPENDENT = 16,
  FLAG_UCS_XREF_RESOLVED = 32,
  FLAG_UCS_IS_REFERENCED = 64
};

enum {
  FLAG_VIEW_PSPACE = 1,
  FLAG_VIEW_XREF_DEPENDENT = 16,
  FLAG_VIEW_XREF_RESOLVED = 32,
  FLAG_VIEW_IS_REFERENCED = 64
};

enum {
  FLAG_VPORT_XREF_DEPENDENT = 16,
  FLAG_VPORT_XREF_RESOLVED = 32,
  FLAG_VPORT_IS_REFERENCED = 64
};

enum {
  FLAG_LWPOLYLINE_CLOSED = 1,
