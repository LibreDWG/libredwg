...
enum {
  ...
  OPTS_R11_DIMENSION_UNKNOWN_16384 = 0x4000,
...
enum {
  OPTS_R11_PLINE_HAS_FLAG = 1,
  OPTS_R11_PLINE_HAS_START_WIDTH = 2,
  OPTS_R11_PLINE_HAS_END_WIDTH = 4,
  OPTS_R11_PLINE_HAS_EXTRUSION = 8,
  OPTS_R11_PLINE_HAS_M_VERTS = 16,
  OPTS_R11_PLINE_HAS_N_VERTS = 32,
  OPTS_R11_PLINE_HAS_M_DENSITY = 64,
  OPTS_R11_PLINE_HAS_N_DENSITY = 128,
  OPTS_R11_PLINE_HAS_CURVETYPE = 256,
  OPTS_R11_PLINE_UNKNOWN_512 = 0x200,
  OPTS_R11_PLINE_UNKNOWN_1024 = 0x400,
  OPTS_R11_PLINE_UNKNOWN_2048 = 0x800,
  OPTS_R11_PLINE_UNKNOWN_4096 = 0x1000,
  OPTS_R11_PLINE_UNKNOWN_8192 = 0x2000,
  OPTS_R11_PLINE_UNKNOWN_16384 = 0x4000,
  OPTS_R11_PLINE_REPLACED_IN_EXTRA = 0x8000,
};
