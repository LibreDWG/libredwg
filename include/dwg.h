...
enum {
  ...
  FLAG_BLOCK_HAS_NON_CONSTANT_ATTRIBS = 2,
  FLAG_BLOCK_IS_EXTERNAL_REF = 4,
  FLAG_BLOCK_XREF_OVERLAY = 8,
  FLAG_BLOCK_EXT_DEPENDENT = 16,
  FLAG_BLOCK_RESOLVED_OR_DEPENDENT_EXT_REF = 32,
  FLAG_BLOCK_REFERENCED_EXT_REF = 64,
};
