...
// DWG_GETALL_OBJECT (VISIBILITYGRIPENTITY)
// DWG_GETALL_OBJECT (VISIBILITYPARAMETERENTITY)
...
// CAST_DWG_OBJECT_TO_OBJECT (VISIBILITYGRIPENTITY)
// CAST_DWG_OBJECT_TO_OBJECT (VISIBILITYPARAMETERENTITY)
...
#  ifdef DEBUG_CLASSES
  ...
  dwg_get_OBJECT (obj_assocedgeacfacetionparam, ASSOCEDGEACTIONPARAM)
  dwg_get_OBJECT (obj_assocpathactionparam, ASSOCFACEACTIONPARAM)
  dwg_get_OBJECT (obj_assocactionparam, ASSOCPATHACTIONPARAM)
