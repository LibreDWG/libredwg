...
#define DWG_OBJECT(name) FREE_NOCLASS (name)
  ...
  switch (obj->fixedtype)
    ...
    case DWG_TYPE_ASSOCARRAYMODIFYPARAMETERS:
    case DWG_TYPE_ASSOCARRAYPATHPARAMETERS:
    case DWG_TYPE_ASSOCARRAYPOLARPARAMETERS:
    case DWG_TYPE_ASSOCARRAYRECTANGULARPARAMETERS:
