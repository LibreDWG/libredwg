  ...
  switch (obj->type)
    ...
    default:
      ...
      /* > 500 */
               ...
               dwg_dxfb_variable_type(obj->parent, dat, (Dwg_Object*)obj))
        {
      ...
      for (i=0; i<dwg->dimstyle_control.num_entries; i++)
        {
          ...
          if (obj) dwg_dxfb_DIMSTYLE(dat, obj);
        }
      ENDTAB();
    }
#if 0
