...
#  define LOG_OPTS_R11_MAX(e, v)                                              \
    if (obj->type == DWG_TYPE_##e##_R11 && _obj->opts_r11 > v)                \
        LOG_WARN ("Unknown opts_r11 (0x%x)", _obj->opts_r11 & ~(v))
            ...
            LOG_OPTS_R11 (PLINE, HAS_FLAG);
            LOG_OPTS_R11 (PLINE, HAS_START_WIDTH);
            LOG_OPTS_R11 (PLINE, HAS_END_WIDTH);
            LOG_OPTS_R11 (PLINE, HAS_EXTRUSION);
            LOG_OPTS_R11 (PLINE, HAS_M_VERTS);
            LOG_OPTS_R11 (PLINE, HAS_N_VERTS);
            LOG_OPTS_R11 (PLINE, HAS_M_DENSITY);
            LOG_OPTS_R11 (PLINE, HAS_N_DENSITY);
            LOG_OPTS_R11 (PLINE, HAS_CURVETYPE);
            LOG_OPTS_R11 (PLINE, UNKNOWN_512);
            LOG_OPTS_R11 (PLINE, UNKNOWN_1024);
            LOG_OPTS_R11 (PLINE, UNKNOWN_2048);
            LOG_OPTS_R11 (PLINE, UNKNOWN_4096);
            LOG_OPTS_R11 (PLINE, UNKNOWN_8192);
            LOG_OPTS_R11 (PLINE, UNKNOWN_16384);
            LOG_OPTS_R11 (PLINE, REPLACED_IN_EXTRA);
            LOG_OPTS_R11_MAX (PLINE, 65535);
