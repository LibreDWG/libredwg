...
= { 0x00, 0x00, 0x00, 0x00, /* RL 0 */
    ...
    0xA7, 0x62, 0x25, 0x00,
    0xF6, 0xAF, 0x25, 0x02,
    0x3B, 0x04, 0x00, 0x00, /* obj start_address as RL (off 16) */
    0x04, 0x32, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00,
    0x00, 0x64, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00,
...
static int encode_preR13_DIMENSION (Bit_Chain *restrict dat, Dwg_Object *restrict obj)
{
  ...
  switch (obj->tio.entity->flag_r11 & 63)
    {
    case 0:
    ...
    case 32:
      ...
      break;
    default:
      LOG_ERROR ("Unknown preR13 DIMENSION type %u",
                 obj->tio.entity->flag_r11 & 63);
      error |= DWG_ERR_VALUEOUTOFBOUNDS;
    }
  return error;
}
