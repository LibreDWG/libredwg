...
/* from typedef struct _dwg_BLOCKSTRETCHACTION_code_indexes: (sorted by offset) */
static const Dwg_DYNAPI_field _dwg_BLOCKSTRETCHACTION_code_indexes_fields[] = {
  { "parent",	"struct _dwg_object_BLOCKSTRETCHACTION*", sizeof (void *),  OFF (struct _dwg_BLOCKSTRETCHACTION_code_indexes, parent),
    1,1,0, 0 },
  { "index",	"BL", sizeof (BITCODE_BL),  OFF (struct _dwg_BLOCKSTRETCHACTION_code_indexes, index),
    0,0,0, 94 },
  {NULL,	NULL,	0,	0,	0,0,0, 0},
};
...
static const Dwg_DYNAPI_field _dwg_BLOCKSTRETCHACTION_codes_fields[] = {
  ...
  { "num_indexes",	"BS", sizeof (BITCODE_BS),  OFF (struct _dwg_BLOCKSTRETCHACTION_codes, num_indexes),
    0,0,0, 76 },
  { "indexes",	"Dwg_BLOCKSTRETCHACTION_code_indexes*", sizeof (Dwg_BLOCKSTRETCHACTION_code_indexes*),  OFF (struct _dwg_BLOCKSTRETCHACTION_codes, indexes),
    1,1,0, 0 },
  {NULL,	NULL,	0,	0,	0,0,0, 0},
};
...
static const struct _name_subclass_fields dwg_list_subclasses[] = {
  ...
  { "BLOCKSTRETCHACTION_code_indexes", (int)DWG_TYPE_BLOCKSTRETCHACTION, NULL, _dwg_BLOCKSTRETCHACTION_code_indexes_fields, sizeof (Dwg_BLOCKSTRETCHACTION_code_indexes) },	/* 41 */
  { "BLOCKSTRETCHACTION_codes", (int)DWG_TYPE_BLOCKSTRETCHACTION, NULL, _dwg_BLOCKSTRETCHACTION_codes_fields, sizeof (Dwg_BLOCKSTRETCHACTION_codes) },	/* 42 */
  { "BLOCKSTRETCHACTION_handle_indexes", (int)DWG_TYPE_BLOCKSTRETCHACTION, NULL, _dwg_BLOCKSTRETCHACTION_handle_indexes_fields, sizeof (Dwg_BLOCKSTRETCHACTION_handle_indexes) },	/* 43 */
  { "BLOCKSTRETCHACTION_handles", (int)DWG_TYPE_BLOCKSTRETCHACTION, NULL, _dwg_BLOCKSTRETCHACTION_handles_fields, sizeof (Dwg_BLOCKSTRETCHACTION_handles) },	/* 44 */
  { "BLOCKVISIBILITYPARAMETER_state", (int)DWG_TYPE_BLOCKVISIBILITYPARAMETER, NULL, _dwg_BLOCKVISIBILITYPARAMETER_state_fields, sizeof (Dwg_BLOCKVISIBILITYPARAMETER_state) },	/* 45 */
  { "COMPOUNDOBJECTID", 0, NULL, _dwg_COMPOUNDOBJECTID_fields, sizeof (Dwg_COMPOUNDOBJECTID) },	/* 46 */
  ...
  { "EVAL_Edge", 0, NULL, _dwg_EVAL_Edge_fields, sizeof (Dwg_EVAL_Edge) },	/* 59 */
  ...
  { "PARTIAL_VIEWING_INDEX_Entry", (int)DWG_TYPE_PARTIAL_VIEWING_INDEX, NULL, _dwg_PARTIAL_VIEWING_INDEX_Entry_fields, sizeof (Dwg_PARTIAL_VIEWING_INDEX_Entry) },	/* 99 */
