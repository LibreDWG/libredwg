...
static const Dwg_DYNAPI_field _dwg_header_variables_fields[] = {
  ...
  { "TEXTSTYLE",	"H", sizeof (BITCODE_H),  OFF (struct _dwg_header_variables, TEXTSTYLE),
    1,0,0, 7 },
  { "TEXTSTYLE_r11",	"BS", sizeof (BITCODE_BS),  OFF (struct _dwg_header_variables, TEXTSTYLE_r11),
    0,0,0, 0 },
  ...
  { "unknown_57",	"BS", sizeof (BITCODE_BS),  OFF (struct _dwg_header_variables, unknown_57),
    0,0,0, 0 },
  { "unknown_58",	"RC", sizeof (BITCODE_RC),  OFF (struct _dwg_header_variables, unknown_58),
    0,0,0, 0 },
  { "unknown_59",	"RC", sizeof (BITCODE_RC),  OFF (struct _dwg_header_variables, unknown_59),
    0,0,0, 0 },
  { "unknown_6",	"RS", sizeof (BITCODE_RS),  OFF (struct _dwg_header_variables, unknown_6),
    0,0,0, 0 },
  { "unknown_60",	"RC", sizeof (BITCODE_RC),  OFF (struct _dwg_header_variables, unknown_60),
    0,0,0, 0 },
  ...
  { "unknown_text4",	"TV", sizeof (BITCODE_TV),  OFF (struct _dwg_header_variables, unknown_text4),
    1,1,1, 0 },
  { "unknown_unit1",	"T", sizeof (BITCODE_T),  OFF (struct _dwg_header_variables, unknown_unit1),
    1,1,1, 0 },
  { "unknown_unit2",	"T", sizeof (BITCODE_T),  OFF (struct _dwg_header_variables, unknown_unit2),
    1,1,1, 0 },
  { "unknown_unit3",	"T", sizeof (BITCODE_T),  OFF (struct _dwg_header_variables, unknown_unit3),
    1,1,1, 0 },
  { "unknown_unit4",	"T", sizeof (BITCODE_T),  OFF (struct _dwg_header_variables, unknown_unit4),
    1,1,1, 0 },
...
static const Dwg_DYNAPI_field _dwg_INSERT_fields[] = {
  ...
  { "seqend",	"H", sizeof (BITCODE_H),  OFF (struct _dwg_entity_INSERT, seqend),
    1,0,0, 0 },
  { "block_r11",	"RS", sizeof (BITCODE_RS),  OFF (struct _dwg_entity_INSERT, block_r11),
    0,0,0, 2 },
...
static const Dwg_DYNAPI_field _dwg_LAYER_fields[] = {
  ...
  { "color",	"CMC", sizeof (BITCODE_CMC),  OFF (struct _dwg_object_LAYER, color),
    0,0,0, 62 },
  { "color_r11",	"int16_t", sizeof (int16_t),  OFF (struct _dwg_object_LAYER, color_r11),
    0,0,0, 62 },
  { "ltype_r11",	"RS", sizeof (BITCODE_RS),  OFF (struct _dwg_object_LAYER, ltype_r11),
    0,0,0, 7 },
...
static const struct _name_type_fields dwg_name_types[] = {
  ...
  { "LARGE_RADIAL_DIMENSION", DWG_TYPE_LARGE_RADIAL_DIMENSION /*(651)*/, _dwg_LARGE_RADIAL_DIMENSION_fields, sizeof (struct _dwg_entity_LARGE_RADIAL_DIMENSION) },	/* 185 */
  { "LAYER", DWG_TYPE_LAYER /*(51)*/, _dwg_LAYER_fields, sizeof (struct _dwg_object_LAYER) },	/* 186 */
  { "LAYERFILTER", DWG_TYPE_LAYERFILTER /*(652)*/, _dwg_LAYERFILTER_fields, sizeof (struct _dwg_object_LAYERFILTER) },	/* 187 */
  { "LAYER_CONTROL", DWG_TYPE_LAYER_CONTROL /*(50)*/, _dwg_LAYER_CONTROL_fields, sizeof (struct _dwg_object_LAYER_CONTROL) },	/* 188 */
  { "LAYER_INDEX", DWG_TYPE_LAYER_INDEX /*(653)*/, _dwg_LAYER_INDEX_fields, sizeof (struct _dwg_object_LAYER_INDEX) },	/* 189 */
  { "LAYOUT", DWG_TYPE_LAYOUT /*(82)*/, _dwg_LAYOUT_fields, sizeof (struct _dwg_object_LAYOUT) },	/* 190 */
  { "LAYOUTPRINTCONFIG", DWG_TYPE_LAYOUTPRINTCONFIG /*(654)*/, _dwg_LAYOUTPRINTCONFIG_fields, sizeof (struct _dwg_object_LAYOUTPRINTCONFIG) },	/* 191 */
  { "LEADER", DWG_TYPE_LEADER /*(45)*/, _dwg_LEADER_fields, sizeof (struct _dwg_entity_LEADER) },	/* 192 */
  { "LEADEROBJECTCONTEXTDATA", DWG_TYPE_LEADEROBJECTCONTEXTDATA /*(655)*/, _dwg_LEADEROBJECTCONTEXTDATA_fields, sizeof (struct _dwg_object_LEADEROBJECTCONTEXTDATA) },	/* 193 */
  { "LIGHT", DWG_TYPE_LIGHT /*(656)*/, _dwg_LIGHT_fields, sizeof (struct _dwg_entity_LIGHT) },	/* 194 */
  { "LIGHTLIST", DWG_TYPE_LIGHTLIST /*(657)*/, _dwg_LIGHTLIST_fields, sizeof (struct _dwg_object_LIGHTLIST) },	/* 195 */
