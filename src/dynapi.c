...
/* from typedef struct _dwg_entity_VERTEX_MESH: (sorted by offset) */
static const Dwg_DYNAPI_field _dwg_VERTEX_MESH_fields[] = {
  { "parent",	"struct _dwg_object_entity*", sizeof (void *),  OFF (struct _dwg_entity_VERTEX_MESH, parent),
    1,1,0, 0 },
  { "flag",	"RC", sizeof (BITCODE_RC),  OFF (struct _dwg_entity_VERTEX_MESH, flag),
    0,0,0, 70 },
  { "start_width",	"BD", sizeof (BITCODE_BD),  OFF (struct _dwg_entity_VERTEX_MESH, start_width),
    0,0,0, 0 },
  { "end_width",	"BD", sizeof (BITCODE_BD),  OFF (struct _dwg_entity_VERTEX_MESH, end_width),
    0,0,0, 0 },
  { "point",	"3BD", sizeof (BITCODE_3BD),  OFF (struct _dwg_entity_VERTEX_MESH, point),
    1,0,0, 10 },
  {NULL,	NULL,	0,	0,	0,0,0, 0},
};
