...
static const Dwg_DYNAPI_field _dwg_object_entity_fields[] = {
  ...
  { "full_visualstyle",	"H", sizeof (BITCODE_H),  OFF (struct _dwg_object_entity, full_visualstyle),
    1,0,0, 348 },
  { "handling_r11",	"TV", sizeof (BITCODE_T),  OFF (struct _dwg_object_entity, handling_r11),
    1,1,1, 0 },
  { "handling_size",	"RC", sizeof (BITCODE_RC),  OFF (struct _dwg_object_entity, handling_size),
    0,0,0, 0 },
