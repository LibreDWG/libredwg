...
static const Dwg_DYNAPI_field _dwg_MTEXT_fields[] = {
  ...
  { "bg_fill_flag",	"BL", sizeof (BITCODE_BL),  OFF (struct _dwg_entity_MTEXT, bg_fill_flag),
    0,0,0, 90 },
  { "bg_fill_scale",	"BD", sizeof (BITCODE_BD),  OFF (struct _dwg_entity_MTEXT, bg_fill_scale),
    0,0,0, 45 },
...
static const Dwg_DYNAPI_field _dwg_ACSH_CHAMFER_CLASS_fields[] = {
  ...
  { "minor",	"BL", sizeof (BITCODE_BL),  OFF (struct _dwg_object_ACSH_CHAMFER_CLASS, minor),
    0,0,0, 91 },
  { "method",	"BL", sizeof (BITCODE_BL),  OFF (struct _dwg_object_ACSH_CHAMFER_CLASS, method),
    0,0,0, 92 },
...
static const Dwg_DYNAPI_field _dwg_ACSH_EXTRUSION_CLASS_fields[] = {
  ...
  { "direction",	"3BD", sizeof (BITCODE_3BD),  OFF (struct _dwg_object_ACSH_EXTRUSION_CLASS, direction),
    1,0,0, 10 },
  { "method",	"BL", sizeof (BITCODE_BL),  OFF (struct _dwg_object_ACSH_EXTRUSION_CLASS, method),
    0,0,0, 92 },
...
static const Dwg_DYNAPI_field _dwg_ACSH_FILLET_CLASS_fields[] = {
  ...
  { "minor",	"BL", sizeof (BITCODE_BL),  OFF (struct _dwg_object_ACSH_FILLET_CLASS, minor),
    0,0,0, 91 },
  { "method",	"BL", sizeof (BITCODE_BL),  OFF (struct _dwg_object_ACSH_FILLET_CLASS, method),
    0,0,0, 92 },
...
static const Dwg_DYNAPI_field _dwg_ACSH_SWEEP_CLASS_fields[] = {
  ...
  { "direction",	"3BD", sizeof (BITCODE_3BD),  OFF (struct _dwg_object_ACSH_SWEEP_CLASS, direction),
    1,0,0, 10 },
  { "method",	"BL", sizeof (BITCODE_BL),  OFF (struct _dwg_object_ACSH_SWEEP_CLASS, method),
    0,0,0, 92 },
...
static const Dwg_DYNAPI_field _dwg_ASSOCPERSSUBENTMANAGER_fields[] = {
  ...
  { "unknown_bl3",	"BL", sizeof (BITCODE_BL),  OFF (struct _dwg_object_ASSOCPERSSUBENTMANAGER, unknown_bl3),
    0,0,0, 90 },
  { "unknown_b4",	"B", sizeof (BITCODE_B),  OFF (struct _dwg_object_ASSOCPERSSUBENTMANAGER, unknown_b4),
    0,0,0, 290 },
  {NULL,	NULL,	0,	0,	0,0,0, 0},
};
...
static const Dwg_DYNAPI_field _dwg_AcDbMTextObjectEmbedded_fields[] = {
  ...
  { "bg_fill_flag",	"BL", sizeof (BITCODE_BL),  OFF (struct _dwg_AcDbMTextObjectEmbedded, bg_fill_flag),
    0,0,0, 0 },
  { "bg_fill_scale",	"BD", sizeof (BITCODE_BD),  OFF (struct _dwg_AcDbMTextObjectEmbedded, bg_fill_scale),
    0,0,0, 0 },
...
static const struct _name_type_fields dwg_name_types[] = {
  ...
  { "ABSHDRAWINGSETTINGS", DWG_TYPE_ABSHDRAWINGSETTINGS /*(747)*/, NULL, 0 },	/* 3 */
  { "ACAECUSTOBJ", DWG_TYPE_ACAECUSTOBJ /*(748)*/, NULL, 0 },	/* 4 */
  { "ACAEEEMGROBJ", DWG_TYPE_ACAEEEMGROBJ /*(749)*/, NULL, 0 },	/* 5 */
  { "ACAMCOMP", DWG_TYPE_ACAMCOMP /*(750)*/, NULL, 0 },	/* 6 */
  { "ACAMCOMPDEF", DWG_TYPE_ACAMCOMPDEF /*(751)*/, NULL, 0 },	/* 7 */
  { "ACAMCOMPDEFMGR", DWG_TYPE_ACAMCOMPDEFMGR /*(752)*/, NULL, 0 },	/* 8 */
  { "ACAMCONTEXTMODELER", DWG_TYPE_ACAMCONTEXTMODELER /*(753)*/, NULL, 0 },	/* 9 */
  { "ACAMGDIMSTD", DWG_TYPE_ACAMGDIMSTD /*(754)*/, NULL, 0 },	/* 10 */
  { "ACAMGFILTERDAT", DWG_TYPE_ACAMGFILTERDAT /*(755)*/, NULL, 0 },	/* 11 */
  { "ACAMGHOLECHARTSTDCSN", DWG_TYPE_ACAMGHOLECHARTSTDCSN /*(756)*/, NULL, 0 },	/* 12 */
  { "ACAMGHOLECHARTSTDDIN", DWG_TYPE_ACAMGHOLECHARTSTDDIN /*(757)*/, NULL, 0 },	/* 13 */
  { "ACAMGHOLECHARTSTDISO", DWG_TYPE_ACAMGHOLECHARTSTDISO /*(758)*/, NULL, 0 },	/* 14 */
  { "ACAMGLAYSTD", DWG_TYPE_ACAMGLAYSTD /*(759)*/, NULL, 0 },	/* 15 */
  { "ACAMGRCOMPDEF", DWG_TYPE_ACAMGRCOMPDEF /*(760)*/, NULL, 0 },	/* 16 */
  { "ACAMGRCOMPDEFSET", DWG_TYPE_ACAMGRCOMPDEFSET /*(761)*/, NULL, 0 },	/* 17 */
  { "ACAMGTITLESTD", DWG_TYPE_ACAMGTITLESTD /*(762)*/, NULL, 0 },	/* 18 */
  { "ACAMMVDBACKUPOBJECT", DWG_TYPE_ACAMMVDBACKUPOBJECT /*(763)*/, NULL, 0 },	/* 19 */
  { "ACAMPROJECT", DWG_TYPE_ACAMPROJECT /*(764)*/, NULL, 0 },	/* 20 */
  { "ACAMSHAFTCOMPDEF", DWG_TYPE_ACAMSHAFTCOMPDEF /*(765)*/, NULL, 0 },	/* 21 */
  { "ACAMSTDPCOMPDEF", DWG_TYPE_ACAMSTDPCOMPDEF /*(766)*/, NULL, 0 },	/* 22 */
  { "ACAMWBLOCKTEMPENTS", DWG_TYPE_ACAMWBLOCKTEMPENTS /*(767)*/, NULL, 0 },	/* 23 */
  { "ACARRAYJIGENTITY", DWG_TYPE_ACARRAYJIGENTITY /*(768)*/, NULL, 0 },	/* 24 */
  { "ACCMCONTEXT", DWG_TYPE_ACCMCONTEXT /*(769)*/, NULL, 0 },	/* 25 */
  { "ACDBCIRCARCRES", DWG_TYPE_ACDBCIRCARCRES /*(770)*/, NULL, 0 },	/* 26 */
  { "ACDBDIMENSIONRES", DWG_TYPE_ACDBDIMENSIONRES /*(771)*/, NULL, 0 },	/* 27 */
  { "ACDBENTITYCACHE", DWG_TYPE_ACDBENTITYCACHE /*(772)*/, NULL, 0 },	/* 28 */
  { "ACDBLINERES", DWG_TYPE_ACDBLINERES /*(773)*/, NULL, 0 },	/* 29 */
  { "ACDBSTDPARTRES_ARC", DWG_TYPE_ACDBSTDPARTRES_ARC /*(774)*/, NULL, 0 },	/* 30 */
  { "ACDBSTDPARTRES_LINE", DWG_TYPE_ACDBSTDPARTRES_LINE /*(775)*/, NULL, 0 },	/* 31 */
  { "ACDB_HATCHSCALECONTEXTDATA_CLASS", DWG_TYPE_ACDB_HATCHSCALECONTEXTDATA_CLASS /*(776)*/, NULL, 0 },	/* 32 */
  { "ACDB_HATCHVIEWCONTEXTDATA_CLASS", DWG_TYPE_ACDB_HATCHVIEWCONTEXTDATA_CLASS /*(777)*/, NULL, 0 },	/* 33 */
  { "ACDB_PROXY_ENTITY_DATA", DWG_TYPE_ACDB_PROXY_ENTITY_DATA /*(778)*/, NULL, 0 },	/* 34 */
  { "ACDSRECORD", DWG_TYPE_ACDSRECORD /*(500)*/, NULL, 0 },	/* 35 */
  { "ACDSSCHEMA", DWG_TYPE_ACDSSCHEMA /*(501)*/, NULL, 0 },	/* 36 */
  { "ACGREFACADMASTER", DWG_TYPE_ACGREFACADMASTER /*(779)*/, NULL, 0 },	/* 37 */
  { "ACGREFMASTER", DWG_TYPE_ACGREFMASTER /*(780)*/, NULL, 0 },	/* 38 */
  { "ACIMINTSYSVAR", DWG_TYPE_ACIMINTSYSVAR /*(781)*/, NULL, 0 },	/* 39 */
  { "ACIMREALSYSVAR", DWG_TYPE_ACIMREALSYSVAR /*(782)*/, NULL, 0 },	/* 40 */
  { "ACIMSTRSYSVAR", DWG_TYPE_ACIMSTRSYSVAR /*(783)*/, NULL, 0 },	/* 41 */
  { "ACIMSYSVARMAN", DWG_TYPE_ACIMSYSVARMAN /*(784)*/, NULL, 0 },	/* 42 */
  { "ACMANOOTATIONVIEWSTANDARDANSI", DWG_TYPE_ACMANOOTATIONVIEWSTANDARDANSI /*(785)*/, NULL, 0 },	/* 43 */
  { "ACMANOOTATIONVIEWSTANDARDCSN", DWG_TYPE_ACMANOOTATIONVIEWSTANDARDCSN /*(786)*/, NULL, 0 },	/* 44 */
  { "ACMANOOTATIONVIEWSTANDARDDIN", DWG_TYPE_ACMANOOTATIONVIEWSTANDARDDIN /*(787)*/, NULL, 0 },	/* 45 */
  { "ACMANOOTATIONVIEWSTANDARDISO", DWG_TYPE_ACMANOOTATIONVIEWSTANDARDISO /*(788)*/, NULL, 0 },	/* 46 */
  { "ACMAPLEGENDDBOBJECT", DWG_TYPE_ACMAPLEGENDDBOBJECT /*(789)*/, NULL, 0 },	/* 47 */
  { "ACMAPLEGENDITEMDBOBJECT", DWG_TYPE_ACMAPLEGENDITEMDBOBJECT /*(790)*/, NULL, 0 },	/* 48 */
  { "ACMAPMAPVIEWPORTDBOBJECT", DWG_TYPE_ACMAPMAPVIEWPORTDBOBJECT /*(791)*/, NULL, 0 },	/* 49 */
  { "ACMAPPRINTLAYOUTELEMENTDBOBJECTCONTAINER", DWG_TYPE_ACMAPPRINTLAYOUTELEMENTDBOBJECTCONTAINER /*(792)*/, NULL, 0 },	/* 50 */
  { "ACMBALLOON", DWG_TYPE_ACMBALLOON /*(793)*/, NULL, 0 },	/* 51 */
  { "ACMBOM", DWG_TYPE_ACMBOM /*(794)*/, NULL, 0 },	/* 52 */
  { "ACMBOMROW", DWG_TYPE_ACMBOMROW /*(795)*/, NULL, 0 },	/* 53 */
  { "ACMBOMROWSTRUCT", DWG_TYPE_ACMBOMROWSTRUCT /*(796)*/, NULL, 0 },	/* 54 */
  { "ACMBOMSTANDARDANSI", DWG_TYPE_ACMBOMSTANDARDANSI /*(797)*/, NULL, 0 },	/* 55 */
  { "ACMBOMSTANDARDCSN", DWG_TYPE_ACMBOMSTANDARDCSN /*(798)*/, NULL, 0 },	/* 56 */
  { "ACMBOMSTANDARDDIN", DWG_TYPE_ACMBOMSTANDARDDIN /*(799)*/, NULL, 0 },	/* 57 */
  { "ACMBOMSTANDARDISO", DWG_TYPE_ACMBOMSTANDARDISO /*(800)*/, NULL, 0 },	/* 58 */
  { "ACMCENTERLINESTANDARDANSI", DWG_TYPE_ACMCENTERLINESTANDARDANSI /*(801)*/, NULL, 0 },	/* 59 */
  { "ACMCENTERLINESTANDARDCSN", DWG_TYPE_ACMCENTERLINESTANDARDCSN /*(802)*/, NULL, 0 },	/* 60 */
  { "ACMCENTERLINESTANDARDDIN", DWG_TYPE_ACMCENTERLINESTANDARDDIN /*(803)*/, NULL, 0 },	/* 61 */
  { "ACMCENTERLINESTANDARDISO", DWG_TYPE_ACMCENTERLINESTANDARDISO /*(804)*/, NULL, 0 },	/* 62 */
  { "ACMDATADICTIONARY", DWG_TYPE_ACMDATADICTIONARY /*(805)*/, NULL, 0 },	/* 63 */
  { "ACMDATAENTRY", DWG_TYPE_ACMDATAENTRY /*(806)*/, NULL, 0 },	/* 64 */
  { "ACMDATAENTRYBLOCK", DWG_TYPE_ACMDATAENTRYBLOCK /*(807)*/, NULL, 0 },	/* 65 */
  { "ACMDATUMID", DWG_TYPE_ACMDATUMID /*(808)*/, NULL, 0 },	/* 66 */
  { "ACMDATUMSTANDARDANSI", DWG_TYPE_ACMDATUMSTANDARDANSI /*(809)*/, NULL, 0 },	/* 67 */
  { "ACMDATUMSTANDARDCSN", DWG_TYPE_ACMDATUMSTANDARDCSN /*(810)*/, NULL, 0 },	/* 68 */
  { "ACMDATUMSTANDARDDIN", DWG_TYPE_ACMDATUMSTANDARDDIN /*(811)*/, NULL, 0 },	/* 69 */
  { "ACMDATUMSTANDARDISO", DWG_TYPE_ACMDATUMSTANDARDISO /*(812)*/, NULL, 0 },	/* 70 */
  { "ACMDATUMSTANDARDISO2012", DWG_TYPE_ACMDATUMSTANDARDISO2012 /*(813)*/, NULL, 0 },	/* 71 */
  { "ACMDETAILSTANDARDANSI", DWG_TYPE_ACMDETAILSTANDARDANSI /*(814)*/, NULL, 0 },	/* 72 */
  { "ACMDETAILSTANDARDCSN", DWG_TYPE_ACMDETAILSTANDARDCSN /*(815)*/, NULL, 0 },	/* 73 */
  { "ACMDETAILSTANDARDDIN", DWG_TYPE_ACMDETAILSTANDARDDIN /*(816)*/, NULL, 0 },	/* 74 */
  { "ACMDETAILSTANDARDISO", DWG_TYPE_ACMDETAILSTANDARDISO /*(817)*/, NULL, 0 },	/* 75 */
  { "ACMDETAILTANDARDCUSTOM", DWG_TYPE_ACMDETAILTANDARDCUSTOM /*(818)*/, NULL, 0 },	/* 76 */
  { "ACMDIMBREAKPERSREACTOR", DWG_TYPE_ACMDIMBREAKPERSREACTOR /*(819)*/, NULL, 0 },	/* 77 */
  ...
  { "ACMEDRAWINGMAN", DWG_TYPE_ACMEDRAWINGMAN /*(820)*/, NULL, 0 },	/* 79 */
  ...
  { "ACMEVIEW", DWG_TYPE_ACMEVIEW /*(821)*/, NULL, 0 },	/* 82 */
  { "ACME_DATABASE", DWG_TYPE_ACME_DATABASE /*(822)*/, NULL, 0 },	/* 83 */
  { "ACME_DOCUMENT", DWG_TYPE_ACME_DOCUMENT /*(823)*/, NULL, 0 },	/* 84 */
  { "ACMFCFRAME", DWG_TYPE_ACMFCFRAME /*(824)*/, NULL, 0 },	/* 85 */
  { "ACMFCFSTANDARDANSI", DWG_TYPE_ACMFCFSTANDARDANSI /*(825)*/, NULL, 0 },	/* 86 */
  { "ACMFCFSTANDARDCSN", DWG_TYPE_ACMFCFSTANDARDCSN /*(826)*/, NULL, 0 },	/* 87 */
  { "ACMFCFSTANDARDDIN", DWG_TYPE_ACMFCFSTANDARDDIN /*(827)*/, NULL, 0 },	/* 88 */
  { "ACMFCFSTANDARDISO", DWG_TYPE_ACMFCFSTANDARDISO /*(828)*/, NULL, 0 },	/* 89 */
  { "ACMFCFSTANDARDISO2004", DWG_TYPE_ACMFCFSTANDARDISO2004 /*(829)*/, NULL, 0 },	/* 90 */
  { "ACMFCFSTANDARDISO2012", DWG_TYPE_ACMFCFSTANDARDISO2012 /*(830)*/, NULL, 0 },	/* 91 */
  { "ACMIDSTANDARDANSI", DWG_TYPE_ACMIDSTANDARDANSI /*(831)*/, NULL, 0 },	/* 92 */
  { "ACMIDSTANDARDCSN", DWG_TYPE_ACMIDSTANDARDCSN /*(832)*/, NULL, 0 },	/* 93 */
  { "ACMIDSTANDARDDIN", DWG_TYPE_ACMIDSTANDARDDIN /*(833)*/, NULL, 0 },	/* 94 */
  { "ACMIDSTANDARDISO", DWG_TYPE_ACMIDSTANDARDISO /*(834)*/, NULL, 0 },	/* 95 */
  { "ACMIDSTANDARDISO2004", DWG_TYPE_ACMIDSTANDARDISO2004 /*(835)*/, NULL, 0 },	/* 96 */
  { "ACMIDSTANDARDISO2012", DWG_TYPE_ACMIDSTANDARDISO2012 /*(836)*/, NULL, 0 },	/* 97 */
  { "ACMNOTESTANDARDANSI", DWG_TYPE_ACMNOTESTANDARDANSI /*(837)*/, NULL, 0 },	/* 98 */
  { "ACMNOTESTANDARDCSN", DWG_TYPE_ACMNOTESTANDARDCSN /*(838)*/, NULL, 0 },	/* 99 */
  { "ACMNOTESTANDARDDIN", DWG_TYPE_ACMNOTESTANDARDDIN /*(839)*/, NULL, 0 },	/* 100 */
  { "ACMNOTESTANDARDISO", DWG_TYPE_ACMNOTESTANDARDISO /*(840)*/, NULL, 0 },	/* 101 */
  { "ACMPARTLIST", DWG_TYPE_ACMPARTLIST /*(841)*/, NULL, 0 },	/* 102 */
  { "ACMPICKOBJ", DWG_TYPE_ACMPICKOBJ /*(842)*/, NULL, 0 },	/* 103 */
  { "ACMSECTIONSTANDARDANSI", DWG_TYPE_ACMSECTIONSTANDARDANSI /*(843)*/, NULL, 0 },	/* 104 */
  { "ACMSECTIONSTANDARDCSN2002", DWG_TYPE_ACMSECTIONSTANDARDCSN2002 /*(844)*/, NULL, 0 },	/* 105 */
  { "ACMSECTIONSTANDARDCUSTOM", DWG_TYPE_ACMSECTIONSTANDARDCUSTOM /*(845)*/, NULL, 0 },	/* 106 */
  { "ACMSECTIONSTANDARDDIN", DWG_TYPE_ACMSECTIONSTANDARDDIN /*(846)*/, NULL, 0 },	/* 107 */
  { "ACMSECTIONSTANDARDISO", DWG_TYPE_ACMSECTIONSTANDARDISO /*(847)*/, NULL, 0 },	/* 108 */
  { "ACMSECTIONSTANDARDISO2001", DWG_TYPE_ACMSECTIONSTANDARDISO2001 /*(848)*/, NULL, 0 },	/* 109 */
  { "ACMSTANDARDANSI", DWG_TYPE_ACMSTANDARDANSI /*(849)*/, NULL, 0 },	/* 110 */
  { "ACMSTANDARDCSN", DWG_TYPE_ACMSTANDARDCSN /*(850)*/, NULL, 0 },	/* 111 */
  { "ACMSTANDARDDIN", DWG_TYPE_ACMSTANDARDDIN /*(851)*/, NULL, 0 },	/* 112 */
  { "ACMSTANDARDISO", DWG_TYPE_ACMSTANDARDISO /*(852)*/, NULL, 0 },	/* 113 */
  { "ACMSURFSTANDARDANSI", DWG_TYPE_ACMSURFSTANDARDANSI /*(853)*/, NULL, 0 },	/* 114 */
  { "ACMSURFSTANDARDCSN", DWG_TYPE_ACMSURFSTANDARDCSN /*(854)*/, NULL, 0 },	/* 115 */
  { "ACMSURFSTANDARDDIN", DWG_TYPE_ACMSURFSTANDARDDIN /*(855)*/, NULL, 0 },	/* 116 */
  { "ACMSURFSTANDARDISO", DWG_TYPE_ACMSURFSTANDARDISO /*(856)*/, NULL, 0 },	/* 117 */
  { "ACMSURFSTANDARDISO2002", DWG_TYPE_ACMSURFSTANDARDISO2002 /*(857)*/, NULL, 0 },	/* 118 */
  { "ACMSURFSYM", DWG_TYPE_ACMSURFSYM /*(858)*/, NULL, 0 },	/* 119 */
  { "ACMTAPERSTANDARDANSI", DWG_TYPE_ACMTAPERSTANDARDANSI /*(859)*/, NULL, 0 },	/* 120 */
  { "ACMTAPERSTANDARDCSN", DWG_TYPE_ACMTAPERSTANDARDCSN /*(860)*/, NULL, 0 },	/* 121 */
  { "ACMTAPERSTANDARDDIN", DWG_TYPE_ACMTAPERSTANDARDDIN /*(861)*/, NULL, 0 },	/* 122 */
  { "ACMTAPERSTANDARDISO", DWG_TYPE_ACMTAPERSTANDARDISO /*(862)*/, NULL, 0 },	/* 123 */
  { "ACMTHREADLINESTANDARDANSI", DWG_TYPE_ACMTHREADLINESTANDARDANSI /*(863)*/, NULL, 0 },	/* 124 */
  { "ACMTHREADLINESTANDARDCSN", DWG_TYPE_ACMTHREADLINESTANDARDCSN /*(864)*/, NULL, 0 },	/* 125 */
  { "ACMTHREADLINESTANDARDDIN", DWG_TYPE_ACMTHREADLINESTANDARDDIN /*(865)*/, NULL, 0 },	/* 126 */
  { "ACMTHREADLINESTANDARDISO", DWG_TYPE_ACMTHREADLINESTANDARDISO /*(866)*/, NULL, 0 },	/* 127 */
  { "ACMWELDSTANDARDANSI", DWG_TYPE_ACMWELDSTANDARDANSI /*(867)*/, NULL, 0 },	/* 128 */
  { "ACMWELDSTANDARDCSN", DWG_TYPE_ACMWELDSTANDARDCSN /*(868)*/, NULL, 0 },	/* 129 */
  { "ACMWELDSTANDARDDIN", DWG_TYPE_ACMWELDSTANDARDDIN /*(869)*/, NULL, 0 },	/* 130 */
  { "ACMWELDSTANDARDISO", DWG_TYPE_ACMWELDSTANDARDISO /*(870)*/, NULL, 0 },	/* 131 */
  { "ACMWELDSYM", DWG_TYPE_ACMWELDSYM /*(871)*/, NULL, 0 },	/* 132 */
  { "ACRFATTGENMGR", DWG_TYPE_ACRFATTGENMGR /*(872)*/, NULL, 0 },	/* 133 */
  { "ACRFINSADJ", DWG_TYPE_ACRFINSADJ /*(873)*/, NULL, 0 },	/* 134 */
  { "ACRFINSADJUSTERMGR", DWG_TYPE_ACRFINSADJUSTERMGR /*(874)*/, NULL, 0 },	/* 135 */
  { "ACRFMCADAPIATTHOLDER", DWG_TYPE_ACRFMCADAPIATTHOLDER /*(875)*/, NULL, 0 },	/* 136 */
  { "ACRFOBJATTMGR", DWG_TYPE_ACRFOBJATTMGR /*(876)*/, NULL, 0 },	/* 137 */
  ...
  { "ACSH_SUBENT_MATERIAL_CLASS", DWG_TYPE_ACSH_SUBENT_MATERIAL_CLASS /*(877)*/, NULL, 0 },	/* 151 */
  ...
  { "AC_AM_2D_XREF_MGR", DWG_TYPE_AC_AM_2D_XREF_MGR /*(878)*/, NULL, 0 },	/* 155 */
  { "AC_AM_BASIC_VIEW", DWG_TYPE_AC_AM_BASIC_VIEW /*(879)*/, NULL, 0 },	/* 156 */
  { "AC_AM_BASIC_VIEW_DEF", DWG_TYPE_AC_AM_BASIC_VIEW_DEF /*(880)*/, NULL, 0 },	/* 157 */
  { "AC_AM_COMPLEX_HIDE_SITUATION", DWG_TYPE_AC_AM_COMPLEX_HIDE_SITUATION /*(881)*/, NULL, 0 },	/* 158 */
  { "AC_AM_COMP_VIEW_DEF", DWG_TYPE_AC_AM_COMP_VIEW_DEF /*(882)*/, NULL, 0 },	/* 159 */
  { "AC_AM_COMP_VIEW_INST", DWG_TYPE_AC_AM_COMP_VIEW_INST /*(883)*/, NULL, 0 },	/* 160 */
  { "AC_AM_DIRTY_NODES", DWG_TYPE_AC_AM_DIRTY_NODES /*(884)*/, NULL, 0 },	/* 161 */
  { "AC_AM_HIDE_SITUATION", DWG_TYPE_AC_AM_HIDE_SITUATION /*(885)*/, NULL, 0 },	/* 162 */
  { "AC_AM_MAPPER_CACHE", DWG_TYPE_AC_AM_MAPPER_CACHE /*(886)*/, NULL, 0 },	/* 163 */
  { "AC_AM_MASTER_VIEW_DEF", DWG_TYPE_AC_AM_MASTER_VIEW_DEF /*(887)*/, NULL, 0 },	/* 164 */
  { "AC_AM_MVD_DEP_MGR", DWG_TYPE_AC_AM_MVD_DEP_MGR /*(888)*/, NULL, 0 },	/* 165 */
  { "AC_AM_OVERRIDE_FILTER", DWG_TYPE_AC_AM_OVERRIDE_FILTER /*(889)*/, NULL, 0 },	/* 166 */
  { "AC_AM_PROPS_OVERRIDE", DWG_TYPE_AC_AM_PROPS_OVERRIDE /*(890)*/, NULL, 0 },	/* 167 */
  { "AC_AM_SHAFT_HIDE_SITUATION", DWG_TYPE_AC_AM_SHAFT_HIDE_SITUATION /*(891)*/, NULL, 0 },	/* 168 */
  { "AC_AM_STDP_VIEW_DEF", DWG_TYPE_AC_AM_STDP_VIEW_DEF /*(892)*/, NULL, 0 },	/* 169 */
  { "AC_AM_TRANSFORM_GHOST", DWG_TYPE_AC_AM_TRANSFORM_GHOST /*(893)*/, NULL, 0 },	/* 170 */
  { "ADAPPL", DWG_TYPE_ADAPPL /*(894)*/, NULL, 0 },	/* 171 */
  { "AECC_ALIGNMENT_DESIGN_CHECK_SET", DWG_TYPE_AECC_ALIGNMENT_DESIGN_CHECK_SET /*(895)*/, NULL, 0 },	/* 172 */
  { "AECC_ALIGNMENT_LABEL_SET", DWG_TYPE_AECC_ALIGNMENT_LABEL_SET /*(896)*/, NULL, 0 },	/* 173 */
  { "AECC_ALIGNMENT_LABEL_SET_EXT", DWG_TYPE_AECC_ALIGNMENT_LABEL_SET_EXT /*(897)*/, NULL, 0 },	/* 174 */
  { "AECC_ALIGNMENT_PARCEL_NODE", DWG_TYPE_AECC_ALIGNMENT_PARCEL_NODE /*(898)*/, NULL, 0 },	/* 175 */
  { "AECC_ALIGNMENT_STYLE", DWG_TYPE_AECC_ALIGNMENT_STYLE /*(899)*/, NULL, 0 },	/* 176 */
  { "AECC_APPURTENANCE_STYLE", DWG_TYPE_AECC_APPURTENANCE_STYLE /*(900)*/, NULL, 0 },	/* 177 */
  { "AECC_ASSEMBLY_STYLE", DWG_TYPE_AECC_ASSEMBLY_STYLE /*(901)*/, NULL, 0 },	/* 178 */
  { "AECC_BUILDING_SITE_STYLE", DWG_TYPE_AECC_BUILDING_SITE_STYLE /*(902)*/, NULL, 0 },	/* 179 */
  { "AECC_CANT_DIAGRAM_VIEW_STYLE", DWG_TYPE_AECC_CANT_DIAGRAM_VIEW_STYLE /*(903)*/, NULL, 0 },	/* 180 */
  { "AECC_CATCHMENT_STYLE", DWG_TYPE_AECC_CATCHMENT_STYLE /*(904)*/, NULL, 0 },	/* 181 */
  { "AECC_CLASS_NODE", DWG_TYPE_AECC_CLASS_NODE /*(905)*/, NULL, 0 },	/* 182 */
  { "AECC_CONTOURVIEW", DWG_TYPE_AECC_CONTOURVIEW /*(906)*/, NULL, 0 },	/* 183 */
  { "AECC_CORRIDOR_STYLE", DWG_TYPE_AECC_CORRIDOR_STYLE /*(907)*/, NULL, 0 },	/* 184 */
  { "AECC_DISP_REP_ALIGNMENT", DWG_TYPE_AECC_DISP_REP_ALIGNMENT /*(908)*/, NULL, 0 },	/* 185 */
  { "AECC_DISP_REP_ALIGNMENT_CANT_LABEL_GROUP", DWG_TYPE_AECC_DISP_REP_ALIGNMENT_CANT_LABEL_GROUP /*(909)*/, NULL, 0 },	/* 186 */
  { "AECC_DISP_REP_ALIGNMENT_CSV", DWG_TYPE_AECC_DISP_REP_ALIGNMENT_CSV /*(910)*/, NULL, 0 },	/* 187 */
  { "AECC_DISP_REP_ALIGNMENT_CURVE_LABEL", DWG_TYPE_AECC_DISP_REP_ALIGNMENT_CURVE_LABEL /*(911)*/, NULL, 0 },	/* 188 */
  { "AECC_DISP_REP_ALIGNMENT_DESIGNSPEED_LABEL_GROUP", DWG_TYPE_AECC_DISP_REP_ALIGNMENT_DESIGNSPEED_LABEL_GROUP /*(912)*/, NULL, 0 },	/* 189 */
  { "AECC_DISP_REP_ALIGNMENT_GEOMPT_LABEL_GROUP", DWG_TYPE_AECC_DISP_REP_ALIGNMENT_GEOMPT_LABEL_GROUP /*(913)*/, NULL, 0 },	/* 190 */
  { "AECC_DISP_REP_ALIGNMENT_INDEXED_PI_LABEL", DWG_TYPE_AECC_DISP_REP_ALIGNMENT_INDEXED_PI_LABEL /*(914)*/, NULL, 0 },	/* 191 */
  { "AECC_DISP_REP_ALIGNMENT_MINOR_STATION_LABEL_GROUP", DWG_TYPE_AECC_DISP_REP_ALIGNMENT_MINOR_STATION_LABEL_GROUP /*(915)*/, NULL, 0 },	/* 192 */
  { "AECC_DISP_REP_ALIGNMENT_PI_LABEL", DWG_TYPE_AECC_DISP_REP_ALIGNMENT_PI_LABEL /*(916)*/, NULL, 0 },	/* 193 */
  { "AECC_DISP_REP_ALIGNMENT_SPIRAL_LABEL", DWG_TYPE_AECC_DISP_REP_ALIGNMENT_SPIRAL_LABEL /*(917)*/, NULL, 0 },	/* 194 */
  { "AECC_DISP_REP_ALIGNMENT_STAEQU_LABEL_GROUP", DWG_TYPE_AECC_DISP_REP_ALIGNMENT_STAEQU_LABEL_GROUP /*(918)*/, NULL, 0 },	/* 195 */
  { "AECC_DISP_REP_ALIGNMENT_STATION_LABEL_GROUP", DWG_TYPE_AECC_DISP_REP_ALIGNMENT_STATION_LABEL_GROUP /*(919)*/, NULL, 0 },	/* 196 */
  { "AECC_DISP_REP_ALIGNMENT_STATION_OFFSET_LABEL", DWG_TYPE_AECC_DISP_REP_ALIGNMENT_STATION_OFFSET_LABEL /*(920)*/, NULL, 0 },	/* 197 */
  { "AECC_DISP_REP_ALIGNMENT_SUPERELEVATION_LABEL_GROUP", DWG_TYPE_AECC_DISP_REP_ALIGNMENT_SUPERELEVATION_LABEL_GROUP /*(921)*/, NULL, 0 },	/* 198 */
  { "AECC_DISP_REP_ALIGNMENT_TABLE", DWG_TYPE_AECC_DISP_REP_ALIGNMENT_TABLE /*(922)*/, NULL, 0 },	/* 199 */
  { "AECC_DISP_REP_ALIGNMENT_TANGENT_LABEL", DWG_TYPE_AECC_DISP_REP_ALIGNMENT_TANGENT_LABEL /*(923)*/, NULL, 0 },	/* 200 */
  { "AECC_DISP_REP_ALIGNMENT_VERTICAL_GEOMPT_LABELING", DWG_TYPE_AECC_DISP_REP_ALIGNMENT_VERTICAL_GEOMPT_LABELING /*(924)*/, NULL, 0 },	/* 201 */
  { "AECC_DISP_REP_APPURTENANCE", DWG_TYPE_AECC_DISP_REP_APPURTENANCE /*(925)*/, NULL, 0 },	/* 202 */
  { "AECC_DISP_REP_APPURTENANCE_CSV", DWG_TYPE_AECC_DISP_REP_APPURTENANCE_CSV /*(926)*/, NULL, 0 },	/* 203 */
  { "AECC_DISP_REP_APPURTENANCE_LABELING", DWG_TYPE_AECC_DISP_REP_APPURTENANCE_LABELING /*(927)*/, NULL, 0 },	/* 204 */
  { "AECC_DISP_REP_APPURTENANCE_PROFILE_LABELING", DWG_TYPE_AECC_DISP_REP_APPURTENANCE_PROFILE_LABELING /*(928)*/, NULL, 0 },	/* 205 */
  { "AECC_DISP_REP_ASSEMBLY", DWG_TYPE_AECC_DISP_REP_ASSEMBLY /*(929)*/, NULL, 0 },	/* 206 */
  { "AECC_DISP_REP_AUTO_CORRIDOR_FEATURE_LINE", DWG_TYPE_AECC_DISP_REP_AUTO_CORRIDOR_FEATURE_LINE /*(930)*/, NULL, 0 },	/* 207 */
  { "AECC_DISP_REP_AUTO_CORRIDOR_FEATURE_LINE_PROFILE", DWG_TYPE_AECC_DISP_REP_AUTO_CORRIDOR_FEATURE_LINE_PROFILE /*(931)*/, NULL, 0 },	/* 208 */
  { "AECC_DISP_REP_AUTO_CORRIDOR_FEATURE_LINE_SECTION", DWG_TYPE_AECC_DISP_REP_AUTO_CORRIDOR_FEATURE_LINE_SECTION /*(932)*/, NULL, 0 },	/* 209 */
  { "AECC_DISP_REP_AUTO_FEATURE_LINE", DWG_TYPE_AECC_DISP_REP_AUTO_FEATURE_LINE /*(933)*/, NULL, 0 },	/* 210 */
  { "AECC_DISP_REP_AUTO_FEATURE_LINE_CSV", DWG_TYPE_AECC_DISP_REP_AUTO_FEATURE_LINE_CSV /*(934)*/, NULL, 0 },	/* 211 */
  { "AECC_DISP_REP_AUTO_FEATURE_LINE_PROFILE", DWG_TYPE_AECC_DISP_REP_AUTO_FEATURE_LINE_PROFILE /*(935)*/, NULL, 0 },	/* 212 */
  { "AECC_DISP_REP_AUTO_FEATURE_LINE_SECTION", DWG_TYPE_AECC_DISP_REP_AUTO_FEATURE_LINE_SECTION /*(936)*/, NULL, 0 },	/* 213 */
  { "AECC_DISP_REP_BUILDINGSITE", DWG_TYPE_AECC_DISP_REP_BUILDINGSITE /*(937)*/, NULL, 0 },	/* 214 */
  { "AECC_DISP_REP_BUILDINGUTIL_CONNECTOR", DWG_TYPE_AECC_DISP_REP_BUILDINGUTIL_CONNECTOR /*(938)*/, NULL, 0 },	/* 215 */
  { "AECC_DISP_REP_CANT_DIAGRAM_VIEW", DWG_TYPE_AECC_DISP_REP_CANT_DIAGRAM_VIEW /*(939)*/, NULL, 0 },	/* 216 */
  { "AECC_DISP_REP_CATCHMENT_AREA", DWG_TYPE_AECC_DISP_REP_CATCHMENT_AREA /*(940)*/, NULL, 0 },	/* 217 */
  { "AECC_DISP_REP_CATCHMENT_AREA_LABEL", DWG_TYPE_AECC_DISP_REP_CATCHMENT_AREA_LABEL /*(941)*/, NULL, 0 },	/* 218 */
  { "AECC_DISP_REP_CORRIDOR", DWG_TYPE_AECC_DISP_REP_CORRIDOR /*(942)*/, NULL, 0 },	/* 219 */
  { "AECC_DISP_REP_CROSSING_PIPE_PROFILE_LABELING", DWG_TYPE_AECC_DISP_REP_CROSSING_PIPE_PROFILE_LABELING /*(943)*/, NULL, 0 },	/* 220 */
  { "AECC_DISP_REP_CROSSING_PRESSURE_PIPE_PROFILE_LABELING", DWG_TYPE_AECC_DISP_REP_CROSSING_PRESSURE_PIPE_PROFILE_LABELING /*(944)*/, NULL, 0 },	/* 221 */
  { "AECC_DISP_REP_CSVSTATIONSLIDER", DWG_TYPE_AECC_DISP_REP_CSVSTATIONSLIDER /*(945)*/, NULL, 0 },	/* 222 */
  { "AECC_DISP_REP_FACE", DWG_TYPE_AECC_DISP_REP_FACE /*(946)*/, NULL, 0 },	/* 223 */
  { "AECC_DISP_REP_FEATURE", DWG_TYPE_AECC_DISP_REP_FEATURE /*(947)*/, NULL, 0 },	/* 224 */
  { "AECC_DISP_REP_FEATURE_LABEL", DWG_TYPE_AECC_DISP_REP_FEATURE_LABEL /*(948)*/, NULL, 0 },	/* 225 */
  { "AECC_DISP_REP_FEATURE_LINE", DWG_TYPE_AECC_DISP_REP_FEATURE_LINE /*(949)*/, NULL, 0 },	/* 226 */
  { "AECC_DISP_REP_FEATURE_LINE_CSV", DWG_TYPE_AECC_DISP_REP_FEATURE_LINE_CSV /*(950)*/, NULL, 0 },	/* 227 */
  { "AECC_DISP_REP_FEATURE_LINE_PROFILE", DWG_TYPE_AECC_DISP_REP_FEATURE_LINE_PROFILE /*(951)*/, NULL, 0 },	/* 228 */
  { "AECC_DISP_REP_FEATURE_LINE_SECTION", DWG_TYPE_AECC_DISP_REP_FEATURE_LINE_SECTION /*(952)*/, NULL, 0 },	/* 229 */
  { "AECC_DISP_REP_FITTING", DWG_TYPE_AECC_DISP_REP_FITTING /*(953)*/, NULL, 0 },	/* 230 */
  { "AECC_DISP_REP_FITTING_CSV", DWG_TYPE_AECC_DISP_REP_FITTING_CSV /*(954)*/, NULL, 0 },	/* 231 */
  { "AECC_DISP_REP_FITTING_LABELING", DWG_TYPE_AECC_DISP_REP_FITTING_LABELING /*(955)*/, NULL, 0 },	/* 232 */
  { "AECC_DISP_REP_FITTING_PROFILE_LABELING", DWG_TYPE_AECC_DISP_REP_FITTING_PROFILE_LABELING /*(956)*/, NULL, 0 },	/* 233 */
  { "AECC_DISP_REP_FLOW_SEGMENT_LABEL", DWG_TYPE_AECC_DISP_REP_FLOW_SEGMENT_LABEL /*(957)*/, NULL, 0 },	/* 234 */
  { "AECC_DISP_REP_GENERAL_SEGMENT_LABEL", DWG_TYPE_AECC_DISP_REP_GENERAL_SEGMENT_LABEL /*(958)*/, NULL, 0 },	/* 235 */
  { "AECC_DISP_REP_GRADING", DWG_TYPE_AECC_DISP_REP_GRADING /*(959)*/, NULL, 0 },	/* 236 */
  { "AECC_DISP_REP_GRAPH", DWG_TYPE_AECC_DISP_REP_GRAPH /*(960)*/, NULL, 0 },	/* 237 */
  { "AECC_DISP_REP_GRAPHPROFILE_NETWORKPART", DWG_TYPE_AECC_DISP_REP_GRAPHPROFILE_NETWORKPART /*(961)*/, NULL, 0 },	/* 238 */
  { "AECC_DISP_REP_GRAPHPROFILE_PRESSUREPART", DWG_TYPE_AECC_DISP_REP_GRAPHPROFILE_PRESSUREPART /*(962)*/, NULL, 0 },	/* 239 */
  { "AECC_DISP_REP_GRID_SURFACE", DWG_TYPE_AECC_DISP_REP_GRID_SURFACE /*(963)*/, NULL, 0 },	/* 240 */
  { "AECC_DISP_REP_GRID_SURFACE_CSV", DWG_TYPE_AECC_DISP_REP_GRID_SURFACE_CSV /*(964)*/, NULL, 0 },	/* 241 */
  { "AECC_DISP_REP_HORGEOMETRY_BAND_LABEL_GROUP", DWG_TYPE_AECC_DISP_REP_HORGEOMETRY_BAND_LABEL_GROUP /*(965)*/, NULL, 0 },	/* 242 */
  { "AECC_DISP_REP_HYDRO_REGION", DWG_TYPE_AECC_DISP_REP_HYDRO_REGION /*(966)*/, NULL, 0 },	/* 243 */
  { "AECC_DISP_REP_INTERFERENCE_CHECK", DWG_TYPE_AECC_DISP_REP_INTERFERENCE_CHECK /*(967)*/, NULL, 0 },	/* 244 */
  { "AECC_DISP_REP_INTERFERENCE_PART", DWG_TYPE_AECC_DISP_REP_INTERFERENCE_PART /*(968)*/, NULL, 0 },	/* 245 */
  { "AECC_DISP_REP_INTERFERENCE_PART_SECTION", DWG_TYPE_AECC_DISP_REP_INTERFERENCE_PART_SECTION /*(969)*/, NULL, 0 },	/* 246 */
  { "AECC_DISP_REP_INTERSECTION", DWG_TYPE_AECC_DISP_REP_INTERSECTION /*(970)*/, NULL, 0 },	/* 247 */
  { "AECC_DISP_REP_INTERSECTION_LOCATION_LABELING", DWG_TYPE_AECC_DISP_REP_INTERSECTION_LOCATION_LABELING /*(971)*/, NULL, 0 },	/* 248 */
  { "AECC_DISP_REP_LABELING", DWG_TYPE_AECC_DISP_REP_LABELING /*(972)*/, NULL, 0 },	/* 249 */
  { "AECC_DISP_REP_LEGEND_TABLE", DWG_TYPE_AECC_DISP_REP_LEGEND_TABLE /*(973)*/, NULL, 0 },	/* 250 */
  { "AECC_DISP_REP_LINE_BETWEEN_POINTS_LABEL", DWG_TYPE_AECC_DISP_REP_LINE_BETWEEN_POINTS_LABEL /*(974)*/, NULL, 0 },	/* 251 */
  { "AECC_DISP_REP_LOTLINE_CSV", DWG_TYPE_AECC_DISP_REP_LOTLINE_CSV /*(975)*/, NULL, 0 },	/* 252 */
  { "AECC_DISP_REP_MASSHAULLINE", DWG_TYPE_AECC_DISP_REP_MASSHAULLINE /*(976)*/, NULL, 0 },	/* 253 */
  { "AECC_DISP_REP_MASS_HAUL_VIEW", DWG_TYPE_AECC_DISP_REP_MASS_HAUL_VIEW /*(977)*/, NULL, 0 },	/* 254 */
  { "AECC_DISP_REP_MATCHLINE_LABELING", DWG_TYPE_AECC_DISP_REP_MATCHLINE_LABELING /*(978)*/, NULL, 0 },	/* 255 */
  { "AECC_DISP_REP_MATCH_LINE", DWG_TYPE_AECC_DISP_REP_MATCH_LINE /*(979)*/, NULL, 0 },	/* 256 */
  { "AECC_DISP_REP_MATERIAL_SECTION", DWG_TYPE_AECC_DISP_REP_MATERIAL_SECTION /*(980)*/, NULL, 0 },	/* 257 */
  { "AECC_DISP_REP_NETWORK", DWG_TYPE_AECC_DISP_REP_NETWORK /*(981)*/, NULL, 0 },	/* 258 */
  { "AECC_DISP_REP_NOTE_LABEL", DWG_TYPE_AECC_DISP_REP_NOTE_LABEL /*(982)*/, NULL, 0 },	/* 259 */
  { "AECC_DISP_REP_OFFSET_ELEV_LABEL", DWG_TYPE_AECC_DISP_REP_OFFSET_ELEV_LABEL /*(983)*/, NULL, 0 },	/* 260 */
  { "AECC_DISP_REP_PARCEL_BOUNDARY", DWG_TYPE_AECC_DISP_REP_PARCEL_BOUNDARY /*(984)*/, NULL, 0 },	/* 261 */
  { "AECC_DISP_REP_PARCEL_FACE_LABEL", DWG_TYPE_AECC_DISP_REP_PARCEL_FACE_LABEL /*(985)*/, NULL, 0 },	/* 262 */
  { "AECC_DISP_REP_PARCEL_SEGMENT", DWG_TYPE_AECC_DISP_REP_PARCEL_SEGMENT /*(986)*/, NULL, 0 },	/* 263 */
  { "AECC_DISP_REP_PARCEL_SEGMENT_LABEL", DWG_TYPE_AECC_DISP_REP_PARCEL_SEGMENT_LABEL /*(987)*/, NULL, 0 },	/* 264 */
  { "AECC_DISP_REP_PARCEL_SEGMENT_TABLE", DWG_TYPE_AECC_DISP_REP_PARCEL_SEGMENT_TABLE /*(988)*/, NULL, 0 },	/* 265 */
  { "AECC_DISP_REP_PARCEL_TABLE", DWG_TYPE_AECC_DISP_REP_PARCEL_TABLE /*(989)*/, NULL, 0 },	/* 266 */
  { "AECC_DISP_REP_PIPE", DWG_TYPE_AECC_DISP_REP_PIPE /*(990)*/, NULL, 0 },	/* 267 */
  { "AECC_DISP_REP_PIPENETWORK_BAND_LABEL_GROUP", DWG_TYPE_AECC_DISP_REP_PIPENETWORK_BAND_LABEL_GROUP /*(991)*/, NULL, 0 },	/* 268 */
  { "AECC_DISP_REP_PIPE_CSV", DWG_TYPE_AECC_DISP_REP_PIPE_CSV /*(992)*/, NULL, 0 },	/* 269 */
  { "AECC_DISP_REP_PIPE_LABELING", DWG_TYPE_AECC_DISP_REP_PIPE_LABELING /*(993)*/, NULL, 0 },	/* 270 */
  { "AECC_DISP_REP_PIPE_PROFILE_LABELING", DWG_TYPE_AECC_DISP_REP_PIPE_PROFILE_LABELING /*(994)*/, NULL, 0 },	/* 271 */
  { "AECC_DISP_REP_PIPE_SECTION_LABELING", DWG_TYPE_AECC_DISP_REP_PIPE_SECTION_LABELING /*(995)*/, NULL, 0 },	/* 272 */
  { "AECC_DISP_REP_PIPE_TABLE", DWG_TYPE_AECC_DISP_REP_PIPE_TABLE /*(996)*/, NULL, 0 },	/* 273 */
  { "AECC_DISP_REP_POINT_ENT", DWG_TYPE_AECC_DISP_REP_POINT_ENT /*(997)*/, NULL, 0 },	/* 274 */
  { "AECC_DISP_REP_POINT_GROUP", DWG_TYPE_AECC_DISP_REP_POINT_GROUP /*(998)*/, NULL, 0 },	/* 275 */
  { "AECC_DISP_REP_POINT_TABLE", DWG_TYPE_AECC_DISP_REP_POINT_TABLE /*(999)*/, NULL, 0 },	/* 276 */
  { "AECC_DISP_REP_PRESSUREPIPENETWORK", DWG_TYPE_AECC_DISP_REP_PRESSUREPIPENETWORK /*(1000)*/, NULL, 0 },	/* 277 */
  { "AECC_DISP_REP_PRESSURE_PART_TABLE", DWG_TYPE_AECC_DISP_REP_PRESSURE_PART_TABLE /*(1001)*/, NULL, 0 },	/* 278 */
  { "AECC_DISP_REP_PRESSURE_PIPE", DWG_TYPE_AECC_DISP_REP_PRESSURE_PIPE /*(1002)*/, NULL, 0 },	/* 279 */
  { "AECC_DISP_REP_PRESSURE_PIPE_CSV", DWG_TYPE_AECC_DISP_REP_PRESSURE_PIPE_CSV /*(1003)*/, NULL, 0 },	/* 280 */
  { "AECC_DISP_REP_PRESSURE_PIPE_LABELING", DWG_TYPE_AECC_DISP_REP_PRESSURE_PIPE_LABELING /*(1004)*/, NULL, 0 },	/* 281 */
  { "AECC_DISP_REP_PRESSURE_PIPE_PROFILE_LABELING", DWG_TYPE_AECC_DISP_REP_PRESSURE_PIPE_PROFILE_LABELING /*(1005)*/, NULL, 0 },	/* 282 */
  { "AECC_DISP_REP_PRESSURE_PIPE_SECTION_LABELING", DWG_TYPE_AECC_DISP_REP_PRESSURE_PIPE_SECTION_LABELING /*(1006)*/, NULL, 0 },	/* 283 */
  { "AECC_DISP_REP_PROFILE", DWG_TYPE_AECC_DISP_REP_PROFILE /*(1007)*/, NULL, 0 },	/* 284 */
  { "AECC_DISP_REP_PROFILEDATA_BAND_LABEL_GROUP", DWG_TYPE_AECC_DISP_REP_PROFILEDATA_BAND_LABEL_GROUP /*(1008)*/, NULL, 0 },	/* 285 */
  { "AECC_DISP_REP_PROFILE_PROJECTION", DWG_TYPE_AECC_DISP_REP_PROFILE_PROJECTION /*(1009)*/, NULL, 0 },	/* 286 */
  { "AECC_DISP_REP_PROFILE_PROJECTION_LABEL", DWG_TYPE_AECC_DISP_REP_PROFILE_PROJECTION_LABEL /*(1010)*/, NULL, 0 },	/* 287 */
  { "AECC_DISP_REP_PROFILE_VIEW", DWG_TYPE_AECC_DISP_REP_PROFILE_VIEW /*(1011)*/, NULL, 0 },	/* 288 */
  { "AECC_DISP_REP_PROFILE_VIEW_DEPTH_LABEL", DWG_TYPE_AECC_DISP_REP_PROFILE_VIEW_DEPTH_LABEL /*(1012)*/, NULL, 0 },	/* 289 */
  { "AECC_DISP_REP_QUANTITY_TAKEOFF_AGGREGATE_EARTHWORK_TABLE", DWG_TYPE_AECC_DISP_REP_QUANTITY_TAKEOFF_AGGREGATE_EARTHWORK_TABLE /*(1013)*/, NULL, 0 },	/* 290 */
  { "AECC_DISP_REP_RIGHT_OF_WAY", DWG_TYPE_AECC_DISP_REP_RIGHT_OF_WAY /*(1014)*/, NULL, 0 },	/* 291 */
  { "AECC_DISP_REP_SAMPLELINE_LABELING", DWG_TYPE_AECC_DISP_REP_SAMPLELINE_LABELING /*(1015)*/, NULL, 0 },	/* 292 */
  { "AECC_DISP_REP_SAMPLE_LINE", DWG_TYPE_AECC_DISP_REP_SAMPLE_LINE /*(1016)*/, NULL, 0 },	/* 293 */
  { "AECC_DISP_REP_SAMPLE_LINE_GROUP", DWG_TYPE_AECC_DISP_REP_SAMPLE_LINE_GROUP /*(1017)*/, NULL, 0 },	/* 294 */
  { "AECC_DISP_REP_SECTION", DWG_TYPE_AECC_DISP_REP_SECTION /*(1018)*/, NULL, 0 },	/* 295 */
  { "AECC_DISP_REP_SECTIONALDATA_BAND_LABEL_GROUP", DWG_TYPE_AECC_DISP_REP_SECTIONALDATA_BAND_LABEL_GROUP /*(1019)*/, NULL, 0 },	/* 296 */
  { "AECC_DISP_REP_SECTIONDATA_BAND_LABEL_GROUP", DWG_TYPE_AECC_DISP_REP_SECTIONDATA_BAND_LABEL_GROUP /*(1020)*/, NULL, 0 },	/* 297 */
  { "AECC_DISP_REP_SECTIONSEGMENT_BAND_LABEL_GROUP", DWG_TYPE_AECC_DISP_REP_SECTIONSEGMENT_BAND_LABEL_GROUP /*(1021)*/, NULL, 0 },	/* 298 */
  { "AECC_DISP_REP_SECTION_CORRIDOR", DWG_TYPE_AECC_DISP_REP_SECTION_CORRIDOR /*(1022)*/, NULL, 0 },	/* 299 */
  { "AECC_DISP_REP_SECTION_CORRIDOR_POINT_LABEL_GROUP", DWG_TYPE_AECC_DISP_REP_SECTION_CORRIDOR_POINT_LABEL_GROUP /*(1023)*/, NULL, 0 },	/* 300 */
  { "AECC_DISP_REP_SECTION_GRADEBREAK_LABEL_GROUP", DWG_TYPE_AECC_DISP_REP_SECTION_GRADEBREAK_LABEL_GROUP /*(1024)*/, NULL, 0 },	/* 301 */
  { "AECC_DISP_REP_SECTION_MINOR_OFFSET_LABEL_GROUP", DWG_TYPE_AECC_DISP_REP_SECTION_MINOR_OFFSET_LABEL_GROUP /*(1025)*/, NULL, 0 },	/* 302 */
  { "AECC_DISP_REP_SECTION_OFFSET_LABEL_GROUP", DWG_TYPE_AECC_DISP_REP_SECTION_OFFSET_LABEL_GROUP /*(1026)*/, NULL, 0 },	/* 303 */
  { "AECC_DISP_REP_SECTION_PIPENETWORK", DWG_TYPE_AECC_DISP_REP_SECTION_PIPENETWORK /*(1027)*/, NULL, 0 },	/* 304 */
  { "AECC_DISP_REP_SECTION_PRESSUREPIPENETWORK", DWG_TYPE_AECC_DISP_REP_SECTION_PRESSUREPIPENETWORK /*(1028)*/, NULL, 0 },	/* 305 */
  { "AECC_DISP_REP_SECTION_PROJECTION", DWG_TYPE_AECC_DISP_REP_SECTION_PROJECTION /*(1029)*/, NULL, 0 },	/* 306 */
  { "AECC_DISP_REP_SECTION_PROJECTION_LABEL", DWG_TYPE_AECC_DISP_REP_SECTION_PROJECTION_LABEL /*(1030)*/, NULL, 0 },	/* 307 */
  { "AECC_DISP_REP_SECTION_SEGMENT_LABEL_GROUP", DWG_TYPE_AECC_DISP_REP_SECTION_SEGMENT_LABEL_GROUP /*(1031)*/, NULL, 0 },	/* 308 */
  { "AECC_DISP_REP_SECTION_VIEW", DWG_TYPE_AECC_DISP_REP_SECTION_VIEW /*(1032)*/, NULL, 0 },	/* 309 */
  { "AECC_DISP_REP_SECTION_VIEW_DEPTH_LABEL", DWG_TYPE_AECC_DISP_REP_SECTION_VIEW_DEPTH_LABEL /*(1033)*/, NULL, 0 },	/* 310 */
  { "AECC_DISP_REP_SECTION_VIEW_QUANTITY_TAKEOFF_TABLE", DWG_TYPE_AECC_DISP_REP_SECTION_VIEW_QUANTITY_TAKEOFF_TABLE /*(1034)*/, NULL, 0 },	/* 311 */
  { "AECC_DISP_REP_SHEET", DWG_TYPE_AECC_DISP_REP_SHEET /*(1035)*/, NULL, 0 },	/* 312 */
  { "AECC_DISP_REP_SPANNING_PIPE_LABELING", DWG_TYPE_AECC_DISP_REP_SPANNING_PIPE_LABELING /*(1036)*/, NULL, 0 },	/* 313 */
  { "AECC_DISP_REP_SPANNING_PIPE_PROFILE_LABELING", DWG_TYPE_AECC_DISP_REP_SPANNING_PIPE_PROFILE_LABELING /*(1037)*/, NULL, 0 },	/* 314 */
  { "AECC_DISP_REP_STATION_ELEV_LABEL", DWG_TYPE_AECC_DISP_REP_STATION_ELEV_LABEL /*(1038)*/, NULL, 0 },	/* 315 */
  { "AECC_DISP_REP_STRUCTURE", DWG_TYPE_AECC_DISP_REP_STRUCTURE /*(1039)*/, NULL, 0 },	/* 316 */
  { "AECC_DISP_REP_STRUCTURE_CSV", DWG_TYPE_AECC_DISP_REP_STRUCTURE_CSV /*(1040)*/, NULL, 0 },	/* 317 */
  { "AECC_DISP_REP_STRUCTURE_LABELING", DWG_TYPE_AECC_DISP_REP_STRUCTURE_LABELING /*(1041)*/, NULL, 0 },	/* 318 */
  { "AECC_DISP_REP_STRUCTURE_PROFILE_LABELING", DWG_TYPE_AECC_DISP_REP_STRUCTURE_PROFILE_LABELING /*(1042)*/, NULL, 0 },	/* 319 */
  { "AECC_DISP_REP_STRUCTURE_SECTION_LABELING", DWG_TYPE_AECC_DISP_REP_STRUCTURE_SECTION_LABELING /*(1043)*/, NULL, 0 },	/* 320 */
  { "AECC_DISP_REP_SUBASSEMBLY", DWG_TYPE_AECC_DISP_REP_SUBASSEMBLY /*(1044)*/, NULL, 0 },	/* 321 */
  { "AECC_DISP_REP_SUPERELEVATION_BAND_LABEL_GROUP", DWG_TYPE_AECC_DISP_REP_SUPERELEVATION_BAND_LABEL_GROUP /*(1045)*/, NULL, 0 },	/* 322 */
  { "AECC_DISP_REP_SUPERELEVATION_DIAGRAM_VIEW", DWG_TYPE_AECC_DISP_REP_SUPERELEVATION_DIAGRAM_VIEW /*(1046)*/, NULL, 0 },	/* 323 */
  { "AECC_DISP_REP_SURFACE_CONTOUR_LABEL_GROUP", DWG_TYPE_AECC_DISP_REP_SURFACE_CONTOUR_LABEL_GROUP /*(1047)*/, NULL, 0 },	/* 324 */
  { "AECC_DISP_REP_SURFACE_ELEVATION_LABEL", DWG_TYPE_AECC_DISP_REP_SURFACE_ELEVATION_LABEL /*(1048)*/, NULL, 0 },	/* 325 */
  { "AECC_DISP_REP_SURFACE_SLOPE_LABEL", DWG_TYPE_AECC_DISP_REP_SURFACE_SLOPE_LABEL /*(1049)*/, NULL, 0 },	/* 326 */
  { "AECC_DISP_REP_SURVEY_FIGURE_LABEL_GROUP", DWG_TYPE_AECC_DISP_REP_SURVEY_FIGURE_LABEL_GROUP /*(1050)*/, NULL, 0 },	/* 327 */
  { "AECC_DISP_REP_SVFIGURE", DWG_TYPE_AECC_DISP_REP_SVFIGURE /*(1051)*/, NULL, 0 },	/* 328 */
  { "AECC_DISP_REP_SVFIGURE_CSV", DWG_TYPE_AECC_DISP_REP_SVFIGURE_CSV /*(1052)*/, NULL, 0 },	/* 329 */
  { "AECC_DISP_REP_SVFIGURE_PROFILE", DWG_TYPE_AECC_DISP_REP_SVFIGURE_PROFILE /*(1053)*/, NULL, 0 },	/* 330 */
  { "AECC_DISP_REP_SVFIGURE_SECTION", DWG_TYPE_AECC_DISP_REP_SVFIGURE_SECTION /*(1054)*/, NULL, 0 },	/* 331 */
  { "AECC_DISP_REP_SVFIGURE_SEGMENT_LABEL", DWG_TYPE_AECC_DISP_REP_SVFIGURE_SEGMENT_LABEL /*(1055)*/, NULL, 0 },	/* 332 */
  { "AECC_DISP_REP_SVNETWORK", DWG_TYPE_AECC_DISP_REP_SVNETWORK /*(1056)*/, NULL, 0 },	/* 333 */
  { "AECC_DISP_REP_TANGENT_INTERSECTION_TABLE", DWG_TYPE_AECC_DISP_REP_TANGENT_INTERSECTION_TABLE /*(1057)*/, NULL, 0 },	/* 334 */
  { "AECC_DISP_REP_TIN_SURFACE", DWG_TYPE_AECC_DISP_REP_TIN_SURFACE /*(1058)*/, NULL, 0 },	/* 335 */
  { "AECC_DISP_REP_TIN_SURFACE_CSV", DWG_TYPE_AECC_DISP_REP_TIN_SURFACE_CSV /*(1059)*/, NULL, 0 },	/* 336 */
  { "AECC_DISP_REP_VALIGNMENT_CRESTCURVE_LABEL_GROUP", DWG_TYPE_AECC_DISP_REP_VALIGNMENT_CRESTCURVE_LABEL_GROUP /*(1060)*/, NULL, 0 },	/* 337 */
  { "AECC_DISP_REP_VALIGNMENT_CSV", DWG_TYPE_AECC_DISP_REP_VALIGNMENT_CSV /*(1061)*/, NULL, 0 },	/* 338 */
  { "AECC_DISP_REP_VALIGNMENT_HAGEOMPT_LABEL_GROUP", DWG_TYPE_AECC_DISP_REP_VALIGNMENT_HAGEOMPT_LABEL_GROUP /*(1062)*/, NULL, 0 },	/* 339 */
  { "AECC_DISP_REP_VALIGNMENT_LINE_LABEL_GROUP", DWG_TYPE_AECC_DISP_REP_VALIGNMENT_LINE_LABEL_GROUP /*(1063)*/, NULL, 0 },	/* 340 */
  { "AECC_DISP_REP_VALIGNMENT_MINOR_STATION_LABEL_GROUP", DWG_TYPE_AECC_DISP_REP_VALIGNMENT_MINOR_STATION_LABEL_GROUP /*(1064)*/, NULL, 0 },	/* 341 */
  { "AECC_DISP_REP_VALIGNMENT_PVI_LABEL_GROUP", DWG_TYPE_AECC_DISP_REP_VALIGNMENT_PVI_LABEL_GROUP /*(1065)*/, NULL, 0 },	/* 342 */
  { "AECC_DISP_REP_VALIGNMENT_SAGCURVE_LABEL_GROUP", DWG_TYPE_AECC_DISP_REP_VALIGNMENT_SAGCURVE_LABEL_GROUP /*(1066)*/, NULL, 0 },	/* 343 */
  { "AECC_DISP_REP_VALIGNMENT_STATION_LABEL_GROUP", DWG_TYPE_AECC_DISP_REP_VALIGNMENT_STATION_LABEL_GROUP /*(1067)*/, NULL, 0 },	/* 344 */
  { "AECC_DISP_REP_VERTICALGEOMETRY_BAND_LABEL_GROUP", DWG_TYPE_AECC_DISP_REP_VERTICALGEOMETRY_BAND_LABEL_GROUP /*(1068)*/, NULL, 0 },	/* 345 */
  { "AECC_DISP_REP_VIEWFRAME_LABELING", DWG_TYPE_AECC_DISP_REP_VIEWFRAME_LABELING /*(1069)*/, NULL, 0 },	/* 346 */
  { "AECC_DISP_REP_VIEW_FRAME", DWG_TYPE_AECC_DISP_REP_VIEW_FRAME /*(1070)*/, NULL, 0 },	/* 347 */
  { "AECC_FEATURELINE_STYLE", DWG_TYPE_AECC_FEATURELINE_STYLE /*(1071)*/, NULL, 0 },	/* 348 */
  { "AECC_FEATURE_STYLE", DWG_TYPE_AECC_FEATURE_STYLE /*(1072)*/, NULL, 0 },	/* 349 */
  { "AECC_FITTING_STYLE", DWG_TYPE_AECC_FITTING_STYLE /*(1073)*/, NULL, 0 },	/* 350 */
  { "AECC_FORMAT_MANAGER_OBJECT", DWG_TYPE_AECC_FORMAT_MANAGER_OBJECT /*(1074)*/, NULL, 0 },	/* 351 */
  { "AECC_GRADEVIEW", DWG_TYPE_AECC_GRADEVIEW /*(1075)*/, NULL, 0 },	/* 352 */
  { "AECC_GRADING_CRITERIA", DWG_TYPE_AECC_GRADING_CRITERIA /*(1076)*/, NULL, 0 },	/* 353 */
  { "AECC_GRADING_CRITERIA_SET", DWG_TYPE_AECC_GRADING_CRITERIA_SET /*(1077)*/, NULL, 0 },	/* 354 */
  { "AECC_GRADING_GROUP", DWG_TYPE_AECC_GRADING_GROUP /*(1078)*/, NULL, 0 },	/* 355 */
  { "AECC_GRADING_STYLE", DWG_TYPE_AECC_GRADING_STYLE /*(1079)*/, NULL, 0 },	/* 356 */
  { "AECC_IMPORT_STORM_SEWER_DEFAULTS", DWG_TYPE_AECC_IMPORT_STORM_SEWER_DEFAULTS /*(1080)*/, NULL, 0 },	/* 357 */
  { "AECC_INTERFERENCE_STYLE", DWG_TYPE_AECC_INTERFERENCE_STYLE /*(1081)*/, NULL, 0 },	/* 358 */
  { "AECC_INTERSECTION_STYLE", DWG_TYPE_AECC_INTERSECTION_STYLE /*(1082)*/, NULL, 0 },	/* 359 */
  { "AECC_LABEL_COLLECTOR_STYLE", DWG_TYPE_AECC_LABEL_COLLECTOR_STYLE /*(1083)*/, NULL, 0 },	/* 360 */
  { "AECC_LABEL_NODE", DWG_TYPE_AECC_LABEL_NODE /*(1084)*/, NULL, 0 },	/* 361 */
  { "AECC_LABEL_RADIAL_LINE_STYLE", DWG_TYPE_AECC_LABEL_RADIAL_LINE_STYLE /*(1085)*/, NULL, 0 },	/* 362 */
  { "AECC_LABEL_TEXT_ITERATOR_CURVE_OR_SPIRAL_STYLE", DWG_TYPE_AECC_LABEL_TEXT_ITERATOR_CURVE_OR_SPIRAL_STYLE /*(1086)*/, NULL, 0 },	/* 363 */
  { "AECC_LABEL_TEXT_ITERATOR_STYLE", DWG_TYPE_AECC_LABEL_TEXT_ITERATOR_STYLE /*(1087)*/, NULL, 0 },	/* 364 */
  { "AECC_LABEL_TEXT_STYLE", DWG_TYPE_AECC_LABEL_TEXT_STYLE /*(1088)*/, NULL, 0 },	/* 365 */
  { "AECC_LABEL_VECTOR_ARROW_STYLE", DWG_TYPE_AECC_LABEL_VECTOR_ARROW_STYLE /*(1089)*/, NULL, 0 },	/* 366 */
  { "AECC_LEGEND_TABLE_STYLE", DWG_TYPE_AECC_LEGEND_TABLE_STYLE /*(1090)*/, NULL, 0 },	/* 367 */
  { "AECC_MASS_HAUL_LINE_STYLE", DWG_TYPE_AECC_MASS_HAUL_LINE_STYLE /*(1091)*/, NULL, 0 },	/* 368 */
  { "AECC_MASS_HAUL_VIEW_STYLE", DWG_TYPE_AECC_MASS_HAUL_VIEW_STYLE /*(1092)*/, NULL, 0 },	/* 369 */
  { "AECC_MATCHLINE_STYLE", DWG_TYPE_AECC_MATCHLINE_STYLE /*(1093)*/, NULL, 0 },	/* 370 */
  { "AECC_MATERIAL_STYLE", DWG_TYPE_AECC_MATERIAL_STYLE /*(1094)*/, NULL, 0 },	/* 371 */
  { "AECC_NETWORK_PART_CATALOG_DEF_NODE", DWG_TYPE_AECC_NETWORK_PART_CATALOG_DEF_NODE /*(1095)*/, NULL, 0 },	/* 372 */
  { "AECC_NETWORK_PART_FAMILY_ITEM", DWG_TYPE_AECC_NETWORK_PART_FAMILY_ITEM /*(1096)*/, NULL, 0 },	/* 373 */
  { "AECC_NETWORK_PART_LIST", DWG_TYPE_AECC_NETWORK_PART_LIST /*(1097)*/, NULL, 0 },	/* 374 */
  { "AECC_NETWORK_RULE", DWG_TYPE_AECC_NETWORK_RULE /*(1098)*/, NULL, 0 },	/* 375 */
  { "AECC_PARCEL_NODE", DWG_TYPE_AECC_PARCEL_NODE /*(1099)*/, NULL, 0 },	/* 376 */
  { "AECC_PARCEL_STYLE", DWG_TYPE_AECC_PARCEL_STYLE /*(1100)*/, NULL, 0 },	/* 377 */
  { "AECC_PART_SIZE_FILTER", DWG_TYPE_AECC_PART_SIZE_FILTER /*(1101)*/, NULL, 0 },	/* 378 */
  { "AECC_PIPE_RULES", DWG_TYPE_AECC_PIPE_RULES /*(1102)*/, NULL, 0 },	/* 379 */
  { "AECC_PIPE_STYLE", DWG_TYPE_AECC_PIPE_STYLE /*(1103)*/, NULL, 0 },	/* 380 */
  { "AECC_PIPE_STYLE_EXTENSION", DWG_TYPE_AECC_PIPE_STYLE_EXTENSION /*(1104)*/, NULL, 0 },	/* 381 */
  { "AECC_POINTCLOUD_STYLE", DWG_TYPE_AECC_POINTCLOUD_STYLE /*(1105)*/, NULL, 0 },	/* 382 */
  { "AECC_POINTVIEW", DWG_TYPE_AECC_POINTVIEW /*(1106)*/, NULL, 0 },	/* 383 */
  { "AECC_POINT_STYLE", DWG_TYPE_AECC_POINT_STYLE /*(1107)*/, NULL, 0 },	/* 384 */
  { "AECC_PRESSURE_PART_LIST", DWG_TYPE_AECC_PRESSURE_PART_LIST /*(1108)*/, NULL, 0 },	/* 385 */
  { "AECC_PRESSURE_PIPE_STYLE", DWG_TYPE_AECC_PRESSURE_PIPE_STYLE /*(1109)*/, NULL, 0 },	/* 386 */
  { "AECC_PROFILESECTIONENTITY_STYLE", DWG_TYPE_AECC_PROFILESECTIONENTITY_STYLE /*(1110)*/, NULL, 0 },	/* 387 */
  { "AECC_PROFILE_DESIGN_CHECK_SET", DWG_TYPE_AECC_PROFILE_DESIGN_CHECK_SET /*(1111)*/, NULL, 0 },	/* 388 */
  { "AECC_PROFILE_LABEL_SET", DWG_TYPE_AECC_PROFILE_LABEL_SET /*(1112)*/, NULL, 0 },	/* 389 */
  { "AECC_PROFILE_STYLE", DWG_TYPE_AECC_PROFILE_STYLE /*(1113)*/, NULL, 0 },	/* 390 */
  { "AECC_PROFILE_VIEW_BAND_STYLE_SET", DWG_TYPE_AECC_PROFILE_VIEW_BAND_STYLE_SET /*(1114)*/, NULL, 0 },	/* 391 */
  { "AECC_PROFILE_VIEW_DATA_BAND_STYLE", DWG_TYPE_AECC_PROFILE_VIEW_DATA_BAND_STYLE /*(1115)*/, NULL, 0 },	/* 392 */
  { "AECC_PROFILE_VIEW_HORIZONTAL_GEOMETRY_BAND_STYLE", DWG_TYPE_AECC_PROFILE_VIEW_HORIZONTAL_GEOMETRY_BAND_STYLE /*(1116)*/, NULL, 0 },	/* 393 */
  { "AECC_PROFILE_VIEW_PIPE_NETWORK_BAND_STYLE", DWG_TYPE_AECC_PROFILE_VIEW_PIPE_NETWORK_BAND_STYLE /*(1117)*/, NULL, 0 },	/* 394 */
  { "AECC_PROFILE_VIEW_SECTIONAL_DATA_BAND_STYLE", DWG_TYPE_AECC_PROFILE_VIEW_SECTIONAL_DATA_BAND_STYLE /*(1118)*/, NULL, 0 },	/* 395 */
  { "AECC_PROFILE_VIEW_STYLE", DWG_TYPE_AECC_PROFILE_VIEW_STYLE /*(1119)*/, NULL, 0 },	/* 396 */
  { "AECC_PROFILE_VIEW_SUPERELEVATION_DIAGRAM_BAND_STYLE", DWG_TYPE_AECC_PROFILE_VIEW_SUPERELEVATION_DIAGRAM_BAND_STYLE /*(1120)*/, NULL, 0 },	/* 397 */
  { "AECC_PROFILE_VIEW_VERTICAL_GEOMETRY_BAND_STYLE", DWG_TYPE_AECC_PROFILE_VIEW_VERTICAL_GEOMETRY_BAND_STYLE /*(1121)*/, NULL, 0 },	/* 398 */
  { "AECC_QUANTITY_TAKEOFF_CRITERIA", DWG_TYPE_AECC_QUANTITY_TAKEOFF_CRITERIA /*(1122)*/, NULL, 0 },	/* 399 */
  { "AECC_ROADWAYLINK_STYLE", DWG_TYPE_AECC_ROADWAYLINK_STYLE /*(1123)*/, NULL, 0 },	/* 400 */
  { "AECC_ROADWAYMARKER_STYLE", DWG_TYPE_AECC_ROADWAYMARKER_STYLE /*(1124)*/, NULL, 0 },	/* 401 */
  { "AECC_ROADWAYSHAPE_STYLE", DWG_TYPE_AECC_ROADWAYSHAPE_STYLE /*(1125)*/, NULL, 0 },	/* 402 */
  { "AECC_ROADWAY_STYLE_SET", DWG_TYPE_AECC_ROADWAY_STYLE_SET /*(1126)*/, NULL, 0 },	/* 403 */
  { "AECC_ROOT_SETTINGS_NODE", DWG_TYPE_AECC_ROOT_SETTINGS_NODE /*(1127)*/, NULL, 0 },	/* 404 */
  { "AECC_SAMPLE_LINE_GROUP_STYLE", DWG_TYPE_AECC_SAMPLE_LINE_GROUP_STYLE /*(1128)*/, NULL, 0 },	/* 405 */
  { "AECC_SAMPLE_LINE_STYLE", DWG_TYPE_AECC_SAMPLE_LINE_STYLE /*(1129)*/, NULL, 0 },	/* 406 */
  { "AECC_SECTION_LABEL_SET", DWG_TYPE_AECC_SECTION_LABEL_SET /*(1130)*/, NULL, 0 },	/* 407 */
  { "AECC_SECTION_STYLE", DWG_TYPE_AECC_SECTION_STYLE /*(1131)*/, NULL, 0 },	/* 408 */
  { "AECC_SECTION_VIEW_BAND_STYLE_SET", DWG_TYPE_AECC_SECTION_VIEW_BAND_STYLE_SET /*(1132)*/, NULL, 0 },	/* 409 */
  { "AECC_SECTION_VIEW_DATA_BAND_STYLE", DWG_TYPE_AECC_SECTION_VIEW_DATA_BAND_STYLE /*(1133)*/, NULL, 0 },	/* 410 */
  { "AECC_SECTION_VIEW_ROAD_SURFACE_BAND_STYLE", DWG_TYPE_AECC_SECTION_VIEW_ROAD_SURFACE_BAND_STYLE /*(1134)*/, NULL, 0 },	/* 411 */
  { "AECC_SECTION_VIEW_STYLE", DWG_TYPE_AECC_SECTION_VIEW_STYLE /*(1135)*/, NULL, 0 },	/* 412 */
  { "AECC_SETTINGS_NODE", DWG_TYPE_AECC_SETTINGS_NODE /*(1136)*/, NULL, 0 },	/* 413 */
  { "AECC_SHEET_STYLE", DWG_TYPE_AECC_SHEET_STYLE /*(1137)*/, NULL, 0 },	/* 414 */
  { "AECC_SLOPE_PATTERN_STYLE", DWG_TYPE_AECC_SLOPE_PATTERN_STYLE /*(1138)*/, NULL, 0 },	/* 415 */
  { "AECC_STATION_FORMAT_STYLE", DWG_TYPE_AECC_STATION_FORMAT_STYLE /*(1139)*/, NULL, 0 },	/* 416 */
  { "AECC_STRUCTURE_RULES", DWG_TYPE_AECC_STRUCTURE_RULES /*(1140)*/, NULL, 0 },	/* 417 */
  { "AECC_STUCTURE_STYLE", DWG_TYPE_AECC_STUCTURE_STYLE /*(1141)*/, NULL, 0 },	/* 418 */
  { "AECC_SUPERELEVATION_DIAGRAM_VIEW_STYLE", DWG_TYPE_AECC_SUPERELEVATION_DIAGRAM_VIEW_STYLE /*(1142)*/, NULL, 0 },	/* 419 */
  { "AECC_SURFACE_STYLE", DWG_TYPE_AECC_SURFACE_STYLE /*(1143)*/, NULL, 0 },	/* 420 */
  { "AECC_SVFIGURE_STYLE", DWG_TYPE_AECC_SVFIGURE_STYLE /*(1144)*/, NULL, 0 },	/* 421 */
  { "AECC_SVNETWORK_STYLE", DWG_TYPE_AECC_SVNETWORK_STYLE /*(1145)*/, NULL, 0 },	/* 422 */
  { "AECC_TABLE_STYLE", DWG_TYPE_AECC_TABLE_STYLE /*(1146)*/, NULL, 0 },	/* 423 */
  { "AECC_TAG_MANAGER", DWG_TYPE_AECC_TAG_MANAGER /*(1147)*/, NULL, 0 },	/* 424 */
  { "AECC_TREE_NODE", DWG_TYPE_AECC_TREE_NODE /*(1148)*/, NULL, 0 },	/* 425 */
  { "AECC_USER_DEFINED_ATTRIBUTE_CLASSIFICATION", DWG_TYPE_AECC_USER_DEFINED_ATTRIBUTE_CLASSIFICATION /*(1149)*/, NULL, 0 },	/* 426 */
  { "AECC_VALIGNMENT_STYLE_EXTENSION", DWG_TYPE_AECC_VALIGNMENT_STYLE_EXTENSION /*(1150)*/, NULL, 0 },	/* 427 */
  { "AECC_VIEW_FRAME_STYLE", DWG_TYPE_AECC_VIEW_FRAME_STYLE /*(1151)*/, NULL, 0 },	/* 428 */
  { "AECS_DISP_PROPS_MEMBER", DWG_TYPE_AECS_DISP_PROPS_MEMBER /*(1152)*/, NULL, 0 },	/* 429 */
  { "AECS_DISP_PROPS_MEMBER_LOGICAL", DWG_TYPE_AECS_DISP_PROPS_MEMBER_LOGICAL /*(1153)*/, NULL, 0 },	/* 430 */
  { "AECS_DISP_PROPS_MEMBER_PLAN", DWG_TYPE_AECS_DISP_PROPS_MEMBER_PLAN /*(1154)*/, NULL, 0 },	/* 431 */
  { "AECS_DISP_PROPS_MEMBER_PLAN_SKETCH", DWG_TYPE_AECS_DISP_PROPS_MEMBER_PLAN_SKETCH /*(1155)*/, NULL, 0 },	/* 432 */
  { "AECS_DISP_PROPS_MEMBER_PROJECTED", DWG_TYPE_AECS_DISP_PROPS_MEMBER_PROJECTED /*(1156)*/, NULL, 0 },	/* 433 */
  { "AECS_DISP_REP_MEMBER_ELEVATION_DESIGN", DWG_TYPE_AECS_DISP_REP_MEMBER_ELEVATION_DESIGN /*(1157)*/, NULL, 0 },	/* 434 */
  { "AECS_DISP_REP_MEMBER_ELEVATION_DETAIL", DWG_TYPE_AECS_DISP_REP_MEMBER_ELEVATION_DETAIL /*(1158)*/, NULL, 0 },	/* 435 */
  { "AECS_DISP_REP_MEMBER_LOGICAL", DWG_TYPE_AECS_DISP_REP_MEMBER_LOGICAL /*(1159)*/, NULL, 0 },	/* 436 */
  { "AECS_DISP_REP_MEMBER_MODEL_DESIGN", DWG_TYPE_AECS_DISP_REP_MEMBER_MODEL_DESIGN /*(1160)*/, NULL, 0 },	/* 437 */
  { "AECS_DISP_REP_MEMBER_MODEL_DETAIL", DWG_TYPE_AECS_DISP_REP_MEMBER_MODEL_DETAIL /*(1161)*/, NULL, 0 },	/* 438 */
  { "AECS_DISP_REP_MEMBER_PLAN_DESIGN", DWG_TYPE_AECS_DISP_REP_MEMBER_PLAN_DESIGN /*(1162)*/, NULL, 0 },	/* 439 */
  { "AECS_DISP_REP_MEMBER_PLAN_DETAIL", DWG_TYPE_AECS_DISP_REP_MEMBER_PLAN_DETAIL /*(1163)*/, NULL, 0 },	/* 440 */
  { "AECS_DISP_REP_MEMBER_PLAN_SKETCH", DWG_TYPE_AECS_DISP_REP_MEMBER_PLAN_SKETCH /*(1164)*/, NULL, 0 },	/* 441 */
  { "AECS_MEMBER_NODE_SHAPE", DWG_TYPE_AECS_MEMBER_NODE_SHAPE /*(1165)*/, NULL, 0 },	/* 442 */
  { "AECS_MEMBER_STYLE", DWG_TYPE_AECS_MEMBER_STYLE /*(1166)*/, NULL, 0 },	/* 443 */
  { "AEC_2DSECTION_STYLE", DWG_TYPE_AEC_2DSECTION_STYLE /*(1167)*/, NULL, 0 },	/* 444 */
  { "AEC_AECDBDISPREPBDGELEVLINEPLAN100", DWG_TYPE_AEC_AECDBDISPREPBDGELEVLINEPLAN100 /*(1168)*/, NULL, 0 },	/* 445 */
  { "AEC_AECDBDISPREPBDGELEVLINEPLAN50", DWG_TYPE_AEC_AECDBDISPREPBDGELEVLINEPLAN50 /*(1169)*/, NULL, 0 },	/* 446 */
  { "AEC_AECDBDISPREPBDGSECTIONLINEPLAN100", DWG_TYPE_AEC_AECDBDISPREPBDGSECTIONLINEPLAN100 /*(1170)*/, NULL, 0 },	/* 447 */
  { "AEC_AECDBDISPREPBDGSECTIONLINEPLAN50", DWG_TYPE_AEC_AECDBDISPREPBDGSECTIONLINEPLAN50 /*(1171)*/, NULL, 0 },	/* 448 */
  { "AEC_AECDBDISPREPCEILINGGRIDPLAN100", DWG_TYPE_AEC_AECDBDISPREPCEILINGGRIDPLAN100 /*(1172)*/, NULL, 0 },	/* 449 */
  { "AEC_AECDBDISPREPCEILINGGRIDPLAN50", DWG_TYPE_AEC_AECDBDISPREPCEILINGGRIDPLAN50 /*(1173)*/, NULL, 0 },	/* 450 */
  { "AEC_AECDBDISPREPCOLUMNGRIDPLAN100", DWG_TYPE_AEC_AECDBDISPREPCOLUMNGRIDPLAN100 /*(1174)*/, NULL, 0 },	/* 451 */
  { "AEC_AECDBDISPREPCOLUMNGRIDPLAN50", DWG_TYPE_AEC_AECDBDISPREPCOLUMNGRIDPLAN50 /*(1175)*/, NULL, 0 },	/* 452 */
  { "AEC_AECDBDISPREPCURTAINWALLLAYOUTPLAN100", DWG_TYPE_AEC_AECDBDISPREPCURTAINWALLLAYOUTPLAN100 /*(1176)*/, NULL, 0 },	/* 453 */
  { "AEC_AECDBDISPREPCURTAINWALLLAYOUTPLAN50", DWG_TYPE_AEC_AECDBDISPREPCURTAINWALLLAYOUTPLAN50 /*(1177)*/, NULL, 0 },	/* 454 */
  { "AEC_AECDBDISPREPCURTAINWALLUNITPLAN100", DWG_TYPE_AEC_AECDBDISPREPCURTAINWALLUNITPLAN100 /*(1178)*/, NULL, 0 },	/* 455 */
  { "AEC_AECDBDISPREPCURTAINWALLUNITPLAN50", DWG_TYPE_AEC_AECDBDISPREPCURTAINWALLUNITPLAN50 /*(1179)*/, NULL, 0 },	/* 456 */
  { "AEC_AECDBDISPREPMVBLOCKREFPLAN100", DWG_TYPE_AEC_AECDBDISPREPMVBLOCKREFPLAN100 /*(1180)*/, NULL, 0 },	/* 457 */
  { "AEC_AECDBDISPREPMVBLOCKREFPLAN50", DWG_TYPE_AEC_AECDBDISPREPMVBLOCKREFPLAN50 /*(1181)*/, NULL, 0 },	/* 458 */
  { "AEC_AECDBDISPREPROOFPLAN100", DWG_TYPE_AEC_AECDBDISPREPROOFPLAN100 /*(1182)*/, NULL, 0 },	/* 459 */
  { "AEC_AECDBDISPREPROOFPLAN50", DWG_TYPE_AEC_AECDBDISPREPROOFPLAN50 /*(1183)*/, NULL, 0 },	/* 460 */
  { "AEC_AECDBDISPREPROOFSLABPLAN100", DWG_TYPE_AEC_AECDBDISPREPROOFSLABPLAN100 /*(1184)*/, NULL, 0 },	/* 461 */
  { "AEC_AECDBDISPREPROOFSLABPLAN50", DWG_TYPE_AEC_AECDBDISPREPROOFSLABPLAN50 /*(1185)*/, NULL, 0 },	/* 462 */
  { "AEC_AECDBDISPREPSLABPLAN100", DWG_TYPE_AEC_AECDBDISPREPSLABPLAN100 /*(1186)*/, NULL, 0 },	/* 463 */
  { "AEC_AECDBDISPREPSLABPLAN50", DWG_TYPE_AEC_AECDBDISPREPSLABPLAN50 /*(1187)*/, NULL, 0 },	/* 464 */
  { "AEC_AECDBDISPREPSPACEPLAN100", DWG_TYPE_AEC_AECDBDISPREPSPACEPLAN100 /*(1188)*/, NULL, 0 },	/* 465 */
  { "AEC_AECDBDISPREPSPACEPLAN50", DWG_TYPE_AEC_AECDBDISPREPSPACEPLAN50 /*(1189)*/, NULL, 0 },	/* 466 */
  { "AEC_AECDBDISPREPWALLPLAN100", DWG_TYPE_AEC_AECDBDISPREPWALLPLAN100 /*(1190)*/, NULL, 0 },	/* 467 */
  { "AEC_AECDBDISPREPWALLPLAN50", DWG_TYPE_AEC_AECDBDISPREPWALLPLAN50 /*(1191)*/, NULL, 0 },	/* 468 */
  { "AEC_AECDBDISPREPWINDOWASSEMBLYPLAN100", DWG_TYPE_AEC_AECDBDISPREPWINDOWASSEMBLYPLAN100 /*(1192)*/, NULL, 0 },	/* 469 */
  { "AEC_AECDBDISPREPWINDOWASSEMBLYPLAN50", DWG_TYPE_AEC_AECDBDISPREPWINDOWASSEMBLYPLAN50 /*(1193)*/, NULL, 0 },	/* 470 */
  { "AEC_AECDBDISPREPZONE100", DWG_TYPE_AEC_AECDBDISPREPZONE100 /*(1194)*/, NULL, 0 },	/* 471 */
  { "AEC_AECDBDISPREPZONE50", DWG_TYPE_AEC_AECDBDISPREPZONE50 /*(1195)*/, NULL, 0 },	/* 472 */
  { "AEC_AECDBZONEDEF", DWG_TYPE_AEC_AECDBZONEDEF /*(1196)*/, NULL, 0 },	/* 473 */
  { "AEC_AECDBZONESTYLE", DWG_TYPE_AEC_AECDBZONESTYLE /*(1197)*/, NULL, 0 },	/* 474 */
  { "AEC_ANCHOR_OPENINGBASE_TO_WALL", DWG_TYPE_AEC_ANCHOR_OPENINGBASE_TO_WALL /*(1198)*/, NULL, 0 },	/* 475 */
  { "AEC_CLASSIFICATION_DEF", DWG_TYPE_AEC_CLASSIFICATION_DEF /*(1199)*/, NULL, 0 },	/* 476 */
  { "AEC_CLASSIFICATION_SYSTEM_DEF", DWG_TYPE_AEC_CLASSIFICATION_SYSTEM_DEF /*(1200)*/, NULL, 0 },	/* 477 */
  { "AEC_CLEANUP_GROUP_DEF", DWG_TYPE_AEC_CLEANUP_GROUP_DEF /*(1201)*/, NULL, 0 },	/* 478 */
  { "AEC_CURTAIN_WALL_LAYOUT_STYLE", DWG_TYPE_AEC_CURTAIN_WALL_LAYOUT_STYLE /*(1202)*/, NULL, 0 },	/* 479 */
  { "AEC_CURTAIN_WALL_UNIT_STYLE", DWG_TYPE_AEC_CURTAIN_WALL_UNIT_STYLE /*(1203)*/, NULL, 0 },	/* 480 */
  { "AEC_CVSECTIONVIEW", DWG_TYPE_AEC_CVSECTIONVIEW /*(1204)*/, NULL, 0 },	/* 481 */
  { "AEC_DB_DISP_REP_DIM_GROUP_PLAN", DWG_TYPE_AEC_DB_DISP_REP_DIM_GROUP_PLAN /*(1205)*/, NULL, 0 },	/* 482 */
  { "AEC_DB_DISP_REP_DIM_GROUP_PLAN100", DWG_TYPE_AEC_DB_DISP_REP_DIM_GROUP_PLAN100 /*(1206)*/, NULL, 0 },	/* 483 */
  { "AEC_DB_DISP_REP_DIM_GROUP_PLAN50", DWG_TYPE_AEC_DB_DISP_REP_DIM_GROUP_PLAN50 /*(1207)*/, NULL, 0 },	/* 484 */
  { "AEC_DIM_STYLE", DWG_TYPE_AEC_DIM_STYLE /*(1208)*/, NULL, 0 },	/* 485 */
  { "AEC_DISPLAYTHEME_STYLE", DWG_TYPE_AEC_DISPLAYTHEME_STYLE /*(1209)*/, NULL, 0 },	/* 486 */
  { "AEC_DISPREPAECDBDISPREPMASSELEMPLAN100", DWG_TYPE_AEC_DISPREPAECDBDISPREPMASSELEMPLAN100 /*(1263)*/, NULL, 0 },	/* 487 */
  { "AEC_DISPREPAECDBDISPREPMASSELEMPLAN50", DWG_TYPE_AEC_DISPREPAECDBDISPREPMASSELEMPLAN50 /*(1264)*/, NULL, 0 },	/* 488 */
  { "AEC_DISPREPAECDBDISPREPMASSGROUPPLAN100", DWG_TYPE_AEC_DISPREPAECDBDISPREPMASSGROUPPLAN100 /*(1265)*/, NULL, 0 },	/* 489 */
  { "AEC_DISPREPAECDBDISPREPMASSGROUPPLAN50", DWG_TYPE_AEC_DISPREPAECDBDISPREPMASSGROUPPLAN50 /*(1266)*/, NULL, 0 },	/* 490 */
  { "AEC_DISPREPAECDBDISPREPOPENINGPLAN100", DWG_TYPE_AEC_DISPREPAECDBDISPREPOPENINGPLAN100 /*(1267)*/, NULL, 0 },	/* 491 */
  { "AEC_DISPREPAECDBDISPREPOPENINGPLAN50", DWG_TYPE_AEC_DISPREPAECDBDISPREPOPENINGPLAN50 /*(1268)*/, NULL, 0 },	/* 492 */
  { "AEC_DISPREPAECDBDISPREPOPENINGPLANREFLECTED", DWG_TYPE_AEC_DISPREPAECDBDISPREPOPENINGPLANREFLECTED /*(1269)*/, NULL, 0 },	/* 493 */
  { "AEC_DISPREPAECDBDISPREPOPENINGSILLPLAN", DWG_TYPE_AEC_DISPREPAECDBDISPREPOPENINGSILLPLAN /*(1270)*/, NULL, 0 },	/* 494 */
  { "AEC_DISPROPSMASSELEMPLANCOMMON", DWG_TYPE_AEC_DISPROPSMASSELEMPLANCOMMON /*(1409)*/, NULL, 0 },	/* 495 */
  { "AEC_DISPROPSMASSGROUPPLANCOMMON", DWG_TYPE_AEC_DISPROPSMASSGROUPPLANCOMMON /*(1410)*/, NULL, 0 },	/* 496 */
  { "AEC_DISPROPSOPENINGPLANCOMMON", DWG_TYPE_AEC_DISPROPSOPENINGPLANCOMMON /*(1411)*/, NULL, 0 },	/* 497 */
  { "AEC_DISPROPSOPENINGPLANCOMMONHATCHED", DWG_TYPE_AEC_DISPROPSOPENINGPLANCOMMONHATCHED /*(1412)*/, NULL, 0 },	/* 498 */
  { "AEC_DISPROPSOPENINGSILLPLAN", DWG_TYPE_AEC_DISPROPSOPENINGSILLPLAN /*(1413)*/, NULL, 0 },	/* 499 */
  { "AEC_DISP_PROPS_2D_SECTION", DWG_TYPE_AEC_DISP_PROPS_2D_SECTION /*(1210)*/, NULL, 0 },	/* 500 */
  { "AEC_DISP_PROPS_CLIP_VOLUME", DWG_TYPE_AEC_DISP_PROPS_CLIP_VOLUME /*(1211)*/, NULL, 0 },	/* 501 */
  { "AEC_DISP_PROPS_CLIP_VOLUME_RESULT", DWG_TYPE_AEC_DISP_PROPS_CLIP_VOLUME_RESULT /*(1212)*/, NULL, 0 },	/* 502 */
  { "AEC_DISP_PROPS_DIM", DWG_TYPE_AEC_DISP_PROPS_DIM /*(1213)*/, NULL, 0 },	/* 503 */
  { "AEC_DISP_PROPS_DISPLAYTHEME", DWG_TYPE_AEC_DISP_PROPS_DISPLAYTHEME /*(1214)*/, NULL, 0 },	/* 504 */
  { "AEC_DISP_PROPS_DOOR", DWG_TYPE_AEC_DISP_PROPS_DOOR /*(1215)*/, NULL, 0 },	/* 505 */
  { "AEC_DISP_PROPS_DOOR_NOMINAL", DWG_TYPE_AEC_DISP_PROPS_DOOR_NOMINAL /*(1216)*/, NULL, 0 },	/* 506 */
  { "AEC_DISP_PROPS_DOOR_PLAN_100", DWG_TYPE_AEC_DISP_PROPS_DOOR_PLAN_100 /*(1217)*/, NULL, 0 },	/* 507 */
  { "AEC_DISP_PROPS_DOOR_PLAN_50", DWG_TYPE_AEC_DISP_PROPS_DOOR_PLAN_50 /*(1218)*/, NULL, 0 },	/* 508 */
  { "AEC_DISP_PROPS_DOOR_THRESHOLD_PLAN", DWG_TYPE_AEC_DISP_PROPS_DOOR_THRESHOLD_PLAN /*(1219)*/, NULL, 0 },	/* 509 */
  { "AEC_DISP_PROPS_DOOR_THRESHOLD_SYMBOL_PLAN", DWG_TYPE_AEC_DISP_PROPS_DOOR_THRESHOLD_SYMBOL_PLAN /*(1220)*/, NULL, 0 },	/* 510 */
  { "AEC_DISP_PROPS_EDITINPLACEPROFILE_MODEL", DWG_TYPE_AEC_DISP_PROPS_EDITINPLACEPROFILE_MODEL /*(1221)*/, NULL, 0 },	/* 511 */
  { "AEC_DISP_PROPS_ENT", DWG_TYPE_AEC_DISP_PROPS_ENT /*(1222)*/, NULL, 0 },	/* 512 */
  { "AEC_DISP_PROPS_ENT_REF", DWG_TYPE_AEC_DISP_PROPS_ENT_REF /*(1223)*/, NULL, 0 },	/* 513 */
  { "AEC_DISP_PROPS_GRID_ASSEMBLY_MODEL", DWG_TYPE_AEC_DISP_PROPS_GRID_ASSEMBLY_MODEL /*(1224)*/, NULL, 0 },	/* 514 */
  { "AEC_DISP_PROPS_GRID_ASSEMBLY_PLAN", DWG_TYPE_AEC_DISP_PROPS_GRID_ASSEMBLY_PLAN /*(1225)*/, NULL, 0 },	/* 515 */
  { "AEC_DISP_PROPS_LAYOUT_CURVE", DWG_TYPE_AEC_DISP_PROPS_LAYOUT_CURVE /*(1226)*/, NULL, 0 },	/* 516 */
  { "AEC_DISP_PROPS_LAYOUT_GRID2D", DWG_TYPE_AEC_DISP_PROPS_LAYOUT_GRID2D /*(1227)*/, NULL, 0 },	/* 517 */
  { "AEC_DISP_PROPS_LAYOUT_GRID3D", DWG_TYPE_AEC_DISP_PROPS_LAYOUT_GRID3D /*(1228)*/, NULL, 0 },	/* 518 */
  { "AEC_DISP_PROPS_MASKBLOCK", DWG_TYPE_AEC_DISP_PROPS_MASKBLOCK /*(1229)*/, NULL, 0 },	/* 519 */
  { "AEC_DISP_PROPS_MASS_ELEM_MODEL", DWG_TYPE_AEC_DISP_PROPS_MASS_ELEM_MODEL /*(1230)*/, NULL, 0 },	/* 520 */
  { "AEC_DISP_PROPS_MASS_GROUP", DWG_TYPE_AEC_DISP_PROPS_MASS_GROUP /*(1231)*/, NULL, 0 },	/* 521 */
  { "AEC_DISP_PROPS_MATERIAL", DWG_TYPE_AEC_DISP_PROPS_MATERIAL /*(1232)*/, NULL, 0 },	/* 522 */
  { "AEC_DISP_PROPS_OPENING", DWG_TYPE_AEC_DISP_PROPS_OPENING /*(1233)*/, NULL, 0 },	/* 523 */
  { "AEC_DISP_PROPS_POLYGON_MODEL", DWG_TYPE_AEC_DISP_PROPS_POLYGON_MODEL /*(1234)*/, NULL, 0 },	/* 524 */
  { "AEC_DISP_PROPS_POLYGON_TRUECOLOUR", DWG_TYPE_AEC_DISP_PROPS_POLYGON_TRUECOLOUR /*(1235)*/, NULL, 0 },	/* 525 */
  { "AEC_DISP_PROPS_RAILING_MODEL", DWG_TYPE_AEC_DISP_PROPS_RAILING_MODEL /*(1236)*/, NULL, 0 },	/* 526 */
  { "AEC_DISP_PROPS_RAILING_PLAN", DWG_TYPE_AEC_DISP_PROPS_RAILING_PLAN /*(1237)*/, NULL, 0 },	/* 527 */
  { "AEC_DISP_PROPS_ROOF", DWG_TYPE_AEC_DISP_PROPS_ROOF /*(1238)*/, NULL, 0 },	/* 528 */
  { "AEC_DISP_PROPS_ROOFSLAB", DWG_TYPE_AEC_DISP_PROPS_ROOFSLAB /*(1239)*/, NULL, 0 },	/* 529 */
  { "AEC_DISP_PROPS_ROOFSLAB_PLAN", DWG_TYPE_AEC_DISP_PROPS_ROOFSLAB_PLAN /*(1240)*/, NULL, 0 },	/* 530 */
  { "AEC_DISP_PROPS_SCHEDULE_TABLE", DWG_TYPE_AEC_DISP_PROPS_SCHEDULE_TABLE /*(1241)*/, NULL, 0 },	/* 531 */
  { "AEC_DISP_PROPS_SLAB", DWG_TYPE_AEC_DISP_PROPS_SLAB /*(1242)*/, NULL, 0 },	/* 532 */
  { "AEC_DISP_PROPS_SLAB_PLAN", DWG_TYPE_AEC_DISP_PROPS_SLAB_PLAN /*(1243)*/, NULL, 0 },	/* 533 */
  { "AEC_DISP_PROPS_SLICE", DWG_TYPE_AEC_DISP_PROPS_SLICE /*(1244)*/, NULL, 0 },	/* 534 */
  { "AEC_DISP_PROPS_SPACE_DECOMPOSED", DWG_TYPE_AEC_DISP_PROPS_SPACE_DECOMPOSED /*(1245)*/, NULL, 0 },	/* 535 */
  { "AEC_DISP_PROPS_SPACE_MODEL", DWG_TYPE_AEC_DISP_PROPS_SPACE_MODEL /*(1246)*/, NULL, 0 },	/* 536 */
  { "AEC_DISP_PROPS_SPACE_PLAN", DWG_TYPE_AEC_DISP_PROPS_SPACE_PLAN /*(1247)*/, NULL, 0 },	/* 537 */
  { "AEC_DISP_PROPS_STAIR_MODEL", DWG_TYPE_AEC_DISP_PROPS_STAIR_MODEL /*(1248)*/, NULL, 0 },	/* 538 */
  { "AEC_DISP_PROPS_STAIR_PLAN", DWG_TYPE_AEC_DISP_PROPS_STAIR_PLAN /*(1249)*/, NULL, 0 },	/* 539 */
  { "AEC_DISP_PROPS_STAIR_PLAN_OVERLAPPING", DWG_TYPE_AEC_DISP_PROPS_STAIR_PLAN_OVERLAPPING /*(1250)*/, NULL, 0 },	/* 540 */
  { "AEC_DISP_PROPS_WALL_GRAPH", DWG_TYPE_AEC_DISP_PROPS_WALL_GRAPH /*(1251)*/, NULL, 0 },	/* 541 */
  { "AEC_DISP_PROPS_WALL_MODEL", DWG_TYPE_AEC_DISP_PROPS_WALL_MODEL /*(1252)*/, NULL, 0 },	/* 542 */
  { "AEC_DISP_PROPS_WALL_PLAN", DWG_TYPE_AEC_DISP_PROPS_WALL_PLAN /*(1253)*/, NULL, 0 },	/* 543 */
  { "AEC_DISP_PROPS_WALL_SCHEM", DWG_TYPE_AEC_DISP_PROPS_WALL_SCHEM /*(1254)*/, NULL, 0 },	/* 544 */
  { "AEC_DISP_PROPS_WINDOW", DWG_TYPE_AEC_DISP_PROPS_WINDOW /*(1255)*/, NULL, 0 },	/* 545 */
  { "AEC_DISP_PROPS_WINDOW_ASSEMBLY_SILL_PLAN", DWG_TYPE_AEC_DISP_PROPS_WINDOW_ASSEMBLY_SILL_PLAN /*(1256)*/, NULL, 0 },	/* 546 */
  { "AEC_DISP_PROPS_WINDOW_NOMINAL", DWG_TYPE_AEC_DISP_PROPS_WINDOW_NOMINAL /*(1257)*/, NULL, 0 },	/* 547 */
  { "AEC_DISP_PROPS_WINDOW_PLAN_100", DWG_TYPE_AEC_DISP_PROPS_WINDOW_PLAN_100 /*(1258)*/, NULL, 0 },	/* 548 */
  { "AEC_DISP_PROPS_WINDOW_PLAN_50", DWG_TYPE_AEC_DISP_PROPS_WINDOW_PLAN_50 /*(1259)*/, NULL, 0 },	/* 549 */
  { "AEC_DISP_PROPS_WINDOW_SILL_PLAN", DWG_TYPE_AEC_DISP_PROPS_WINDOW_SILL_PLAN /*(1260)*/, NULL, 0 },	/* 550 */
  { "AEC_DISP_PROPS_ZONE", DWG_TYPE_AEC_DISP_PROPS_ZONE /*(1261)*/, NULL, 0 },	/* 551 */
  { "AEC_DISP_REP_2D_SECTION", DWG_TYPE_AEC_DISP_REP_2D_SECTION /*(1262)*/, NULL, 0 },	/* 552 */
  { "AEC_DISP_REP_ANCHOR", DWG_TYPE_AEC_DISP_REP_ANCHOR /*(1271)*/, NULL, 0 },	/* 553 */
  { "AEC_DISP_REP_ANCHOR_BUB_TO_GRID", DWG_TYPE_AEC_DISP_REP_ANCHOR_BUB_TO_GRID /*(1272)*/, NULL, 0 },	/* 554 */
  { "AEC_DISP_REP_ANCHOR_BUB_TO_GRID_MODEL", DWG_TYPE_AEC_DISP_REP_ANCHOR_BUB_TO_GRID_MODEL /*(1273)*/, NULL, 0 },	/* 555 */
  { "AEC_DISP_REP_ANCHOR_BUB_TO_GRID_RCP", DWG_TYPE_AEC_DISP_REP_ANCHOR_BUB_TO_GRID_RCP /*(1274)*/, NULL, 0 },	/* 556 */
  { "AEC_DISP_REP_ANCHOR_ENT_TO_NODE", DWG_TYPE_AEC_DISP_REP_ANCHOR_ENT_TO_NODE /*(1275)*/, NULL, 0 },	/* 557 */
  { "AEC_DISP_REP_ANCHOR_EXT_TAG_TO_ENT", DWG_TYPE_AEC_DISP_REP_ANCHOR_EXT_TAG_TO_ENT /*(1276)*/, NULL, 0 },	/* 558 */
  { "AEC_DISP_REP_ANCHOR_TAG_TO_ENT", DWG_TYPE_AEC_DISP_REP_ANCHOR_TAG_TO_ENT /*(1277)*/, NULL, 0 },	/* 559 */
  { "AEC_DISP_REP_BDG_ELEVLINE_MODEL", DWG_TYPE_AEC_DISP_REP_BDG_ELEVLINE_MODEL /*(1278)*/, NULL, 0 },	/* 560 */
  { "AEC_DISP_REP_BDG_ELEVLINE_PLAN", DWG_TYPE_AEC_DISP_REP_BDG_ELEVLINE_PLAN /*(1279)*/, NULL, 0 },	/* 561 */
  { "AEC_DISP_REP_BDG_ELEVLINE_RCP", DWG_TYPE_AEC_DISP_REP_BDG_ELEVLINE_RCP /*(1280)*/, NULL, 0 },	/* 562 */
  { "AEC_DISP_REP_BDG_SECTIONLINE_MODEL", DWG_TYPE_AEC_DISP_REP_BDG_SECTIONLINE_MODEL /*(1281)*/, NULL, 0 },	/* 563 */
  { "AEC_DISP_REP_BDG_SECTIONLINE_PLAN", DWG_TYPE_AEC_DISP_REP_BDG_SECTIONLINE_PLAN /*(1282)*/, NULL, 0 },	/* 564 */
  { "AEC_DISP_REP_BDG_SECTIONLINE_RCP", DWG_TYPE_AEC_DISP_REP_BDG_SECTIONLINE_RCP /*(1283)*/, NULL, 0 },	/* 565 */
  { "AEC_DISP_REP_BDG_SECTION_MODEL", DWG_TYPE_AEC_DISP_REP_BDG_SECTION_MODEL /*(1284)*/, NULL, 0 },	/* 566 */
  { "AEC_DISP_REP_BDG_SECTION_SUBDIV", DWG_TYPE_AEC_DISP_REP_BDG_SECTION_SUBDIV /*(1285)*/, NULL, 0 },	/* 567 */
  { "AEC_DISP_REP_CEILING_GRID", DWG_TYPE_AEC_DISP_REP_CEILING_GRID /*(1286)*/, NULL, 0 },	/* 568 */
  { "AEC_DISP_REP_CEILING_GRID_MODEL", DWG_TYPE_AEC_DISP_REP_CEILING_GRID_MODEL /*(1287)*/, NULL, 0 },	/* 569 */
  { "AEC_DISP_REP_CEILING_GRID_RCP", DWG_TYPE_AEC_DISP_REP_CEILING_GRID_RCP /*(1288)*/, NULL, 0 },	/* 570 */
  { "AEC_DISP_REP_CLIP_VOLUME_MODEL", DWG_TYPE_AEC_DISP_REP_CLIP_VOLUME_MODEL /*(1289)*/, NULL, 0 },	/* 571 */
  { "AEC_DISP_REP_CLIP_VOLUME_PLAN", DWG_TYPE_AEC_DISP_REP_CLIP_VOLUME_PLAN /*(1290)*/, NULL, 0 },	/* 572 */
  { "AEC_DISP_REP_CLIP_VOLUME_RESULT", DWG_TYPE_AEC_DISP_REP_CLIP_VOLUME_RESULT /*(1291)*/, NULL, 0 },	/* 573 */
  { "AEC_DISP_REP_CLIP_VOLUME_RESULT_SUBDIV", DWG_TYPE_AEC_DISP_REP_CLIP_VOLUME_RESULT_SUBDIV /*(1292)*/, NULL, 0 },	/* 574 */
  { "AEC_DISP_REP_COLUMN_GRID", DWG_TYPE_AEC_DISP_REP_COLUMN_GRID /*(1325)*/, NULL, 0 },	/* 575 */
  { "AEC_DISP_REP_COLUMN_GRID_MODEL", DWG_TYPE_AEC_DISP_REP_COLUMN_GRID_MODEL /*(1326)*/, NULL, 0 },	/* 576 */
  { "AEC_DISP_REP_COLUMN_GRID_RCP", DWG_TYPE_AEC_DISP_REP_COLUMN_GRID_RCP /*(1327)*/, NULL, 0 },	/* 577 */
  { "AEC_DISP_REP_COL_BLOCK", DWG_TYPE_AEC_DISP_REP_COL_BLOCK /*(1293)*/, NULL, 0 },	/* 578 */
  { "AEC_DISP_REP_COL_CIRCARC2D", DWG_TYPE_AEC_DISP_REP_COL_CIRCARC2D /*(1294)*/, NULL, 0 },	/* 579 */
  { "AEC_DISP_REP_COL_CONCOINCIDENT", DWG_TYPE_AEC_DISP_REP_COL_CONCOINCIDENT /*(1295)*/, NULL, 0 },	/* 580 */
  { "AEC_DISP_REP_COL_CONCONCENTRIC", DWG_TYPE_AEC_DISP_REP_COL_CONCONCENTRIC /*(1296)*/, NULL, 0 },	/* 581 */
  { "AEC_DISP_REP_COL_CONEQUALDISTANCE", DWG_TYPE_AEC_DISP_REP_COL_CONEQUALDISTANCE /*(1297)*/, NULL, 0 },	/* 582 */
  { "AEC_DISP_REP_COL_CONMIDPOINT", DWG_TYPE_AEC_DISP_REP_COL_CONMIDPOINT /*(1298)*/, NULL, 0 },	/* 583 */
  { "AEC_DISP_REP_COL_CONNECTOR", DWG_TYPE_AEC_DISP_REP_COL_CONNECTOR /*(1299)*/, NULL, 0 },	/* 584 */
  { "AEC_DISP_REP_COL_CONNORMAL", DWG_TYPE_AEC_DISP_REP_COL_CONNORMAL /*(1300)*/, NULL, 0 },	/* 585 */
  { "AEC_DISP_REP_COL_CONPARALLEL", DWG_TYPE_AEC_DISP_REP_COL_CONPARALLEL /*(1301)*/, NULL, 0 },	/* 586 */
  { "AEC_DISP_REP_COL_CONPERPENDICULAR", DWG_TYPE_AEC_DISP_REP_COL_CONPERPENDICULAR /*(1302)*/, NULL, 0 },	/* 587 */
  { "AEC_DISP_REP_COL_CONSYMMETRIC", DWG_TYPE_AEC_DISP_REP_COL_CONSYMMETRIC /*(1303)*/, NULL, 0 },	/* 588 */
  { "AEC_DISP_REP_COL_CONTANGENT", DWG_TYPE_AEC_DISP_REP_COL_CONTANGENT /*(1304)*/, NULL, 0 },	/* 589 */
  { "AEC_DISP_REP_COL_DIMANGLE", DWG_TYPE_AEC_DISP_REP_COL_DIMANGLE /*(1305)*/, NULL, 0 },	/* 590 */
  { "AEC_DISP_REP_COL_DIMDIAMETER", DWG_TYPE_AEC_DISP_REP_COL_DIMDIAMETER /*(1306)*/, NULL, 0 },	/* 591 */
  { "AEC_DISP_REP_COL_DIMDISTANCE", DWG_TYPE_AEC_DISP_REP_COL_DIMDISTANCE /*(1307)*/, NULL, 0 },	/* 592 */
  { "AEC_DISP_REP_COL_DIMLENGTH", DWG_TYPE_AEC_DISP_REP_COL_DIMLENGTH /*(1308)*/, NULL, 0 },	/* 593 */
  { "AEC_DISP_REP_COL_DIMMAJORRADIUS", DWG_TYPE_AEC_DISP_REP_COL_DIMMAJORRADIUS /*(1309)*/, NULL, 0 },	/* 594 */
  { "AEC_DISP_REP_COL_DIMMINORRADIUS", DWG_TYPE_AEC_DISP_REP_COL_DIMMINORRADIUS /*(1310)*/, NULL, 0 },	/* 595 */
  { "AEC_DISP_REP_COL_ELLIPARC2D", DWG_TYPE_AEC_DISP_REP_COL_ELLIPARC2D /*(1311)*/, NULL, 0 },	/* 596 */
  { "AEC_DISP_REP_COL_LAYOUTDATA", DWG_TYPE_AEC_DISP_REP_COL_LAYOUTDATA /*(1312)*/, NULL, 0 },	/* 597 */
  { "AEC_DISP_REP_COL_LINE2D", DWG_TYPE_AEC_DISP_REP_COL_LINE2D /*(1313)*/, NULL, 0 },	/* 598 */
  { "AEC_DISP_REP_COL_MODIFIER_ADD", DWG_TYPE_AEC_DISP_REP_COL_MODIFIER_ADD /*(1314)*/, NULL, 0 },	/* 599 */
  { "AEC_DISP_REP_COL_MODIFIER_CUTPLANE", DWG_TYPE_AEC_DISP_REP_COL_MODIFIER_CUTPLANE /*(1315)*/, NULL, 0 },	/* 600 */
  { "AEC_DISP_REP_COL_MODIFIER_EXTRUSION", DWG_TYPE_AEC_DISP_REP_COL_MODIFIER_EXTRUSION /*(1316)*/, NULL, 0 },	/* 601 */
  { "AEC_DISP_REP_COL_MODIFIER_GROUP", DWG_TYPE_AEC_DISP_REP_COL_MODIFIER_GROUP /*(1317)*/, NULL, 0 },	/* 602 */
  { "AEC_DISP_REP_COL_MODIFIER_LOFT", DWG_TYPE_AEC_DISP_REP_COL_MODIFIER_LOFT /*(1318)*/, NULL, 0 },	/* 603 */
  { "AEC_DISP_REP_COL_MODIFIER_PATH", DWG_TYPE_AEC_DISP_REP_COL_MODIFIER_PATH /*(1319)*/, NULL, 0 },	/* 604 */
  { "AEC_DISP_REP_COL_MODIFIER_REVOLVE", DWG_TYPE_AEC_DISP_REP_COL_MODIFIER_REVOLVE /*(1320)*/, NULL, 0 },	/* 605 */
  { "AEC_DISP_REP_COL_MODIFIER_SUBTRACT", DWG_TYPE_AEC_DISP_REP_COL_MODIFIER_SUBTRACT /*(1321)*/, NULL, 0 },	/* 606 */
  { "AEC_DISP_REP_COL_MODIFIER_TRANSITION", DWG_TYPE_AEC_DISP_REP_COL_MODIFIER_TRANSITION /*(1322)*/, NULL, 0 },	/* 607 */
  { "AEC_DISP_REP_COL_POINT2D", DWG_TYPE_AEC_DISP_REP_COL_POINT2D /*(1323)*/, NULL, 0 },	/* 608 */
  { "AEC_DISP_REP_COL_PROFILE", DWG_TYPE_AEC_DISP_REP_COL_PROFILE /*(1324)*/, NULL, 0 },	/* 609 */
  { "AEC_DISP_REP_COL_WORKPLANE", DWG_TYPE_AEC_DISP_REP_COL_WORKPLANE /*(1328)*/, NULL, 0 },	/* 610 */
  { "AEC_DISP_REP_COL_WORKPLANE_REF", DWG_TYPE_AEC_DISP_REP_COL_WORKPLANE_REF /*(1329)*/, NULL, 0 },	/* 611 */
  { "AEC_DISP_REP_CONFIG", DWG_TYPE_AEC_DISP_REP_CONFIG /*(1330)*/, NULL, 0 },	/* 612 */
  { "AEC_DISP_REP_CURTAIN_WALL_LAYOUT_MODEL", DWG_TYPE_AEC_DISP_REP_CURTAIN_WALL_LAYOUT_MODEL /*(1331)*/, NULL, 0 },	/* 613 */
  { "AEC_DISP_REP_CURTAIN_WALL_LAYOUT_PLAN", DWG_TYPE_AEC_DISP_REP_CURTAIN_WALL_LAYOUT_PLAN /*(1332)*/, NULL, 0 },	/* 614 */
  { "AEC_DISP_REP_CURTAIN_WALL_UNIT_MODEL", DWG_TYPE_AEC_DISP_REP_CURTAIN_WALL_UNIT_MODEL /*(1333)*/, NULL, 0 },	/* 615 */
  { "AEC_DISP_REP_CURTAIN_WALL_UNIT_PLAN", DWG_TYPE_AEC_DISP_REP_CURTAIN_WALL_UNIT_PLAN /*(1334)*/, NULL, 0 },	/* 616 */
  { "AEC_DISP_REP_DCM_DIMRADIUS", DWG_TYPE_AEC_DISP_REP_DCM_DIMRADIUS /*(1335)*/, NULL, 0 },	/* 617 */
  { "AEC_DISP_REP_DISPLAYTHEME", DWG_TYPE_AEC_DISP_REP_DISPLAYTHEME /*(1336)*/, NULL, 0 },	/* 618 */
  { "AEC_DISP_REP_DOOR_ELEV", DWG_TYPE_AEC_DISP_REP_DOOR_ELEV /*(1337)*/, NULL, 0 },	/* 619 */
  { "AEC_DISP_REP_DOOR_MODEL", DWG_TYPE_AEC_DISP_REP_DOOR_MODEL /*(1338)*/, NULL, 0 },	/* 620 */
  { "AEC_DISP_REP_DOOR_NOMINAL", DWG_TYPE_AEC_DISP_REP_DOOR_NOMINAL /*(1339)*/, NULL, 0 },	/* 621 */
  { "AEC_DISP_REP_DOOR_PLAN", DWG_TYPE_AEC_DISP_REP_DOOR_PLAN /*(1340)*/, NULL, 0 },	/* 622 */
  { "AEC_DISP_REP_DOOR_PLAN_50", DWG_TYPE_AEC_DISP_REP_DOOR_PLAN_50 /*(1341)*/, NULL, 0 },	/* 623 */
  { "AEC_DISP_REP_DOOR_PLAN_HEKTO", DWG_TYPE_AEC_DISP_REP_DOOR_PLAN_HEKTO /*(1342)*/, NULL, 0 },	/* 624 */
  { "AEC_DISP_REP_DOOR_RCP", DWG_TYPE_AEC_DISP_REP_DOOR_RCP /*(1343)*/, NULL, 0 },	/* 625 */
  { "AEC_DISP_REP_DOOR_THRESHOLD_PLAN", DWG_TYPE_AEC_DISP_REP_DOOR_THRESHOLD_PLAN /*(1344)*/, NULL, 0 },	/* 626 */
  { "AEC_DISP_REP_DOOR_THRESHOLD_SYMBOL_PLAN", DWG_TYPE_AEC_DISP_REP_DOOR_THRESHOLD_SYMBOL_PLAN /*(1345)*/, NULL, 0 },	/* 627 */
  { "AEC_DISP_REP_EDITINPLACEPROFILE", DWG_TYPE_AEC_DISP_REP_EDITINPLACEPROFILE /*(1346)*/, NULL, 0 },	/* 628 */
  { "AEC_DISP_REP_ENT_REF", DWG_TYPE_AEC_DISP_REP_ENT_REF /*(1347)*/, NULL, 0 },	/* 629 */
  { "AEC_DISP_REP_LAYOUT_CURVE", DWG_TYPE_AEC_DISP_REP_LAYOUT_CURVE /*(1348)*/, NULL, 0 },	/* 630 */
  { "AEC_DISP_REP_LAYOUT_GRID2D", DWG_TYPE_AEC_DISP_REP_LAYOUT_GRID2D /*(1349)*/, NULL, 0 },	/* 631 */
  { "AEC_DISP_REP_LAYOUT_GRID3D", DWG_TYPE_AEC_DISP_REP_LAYOUT_GRID3D /*(1350)*/, NULL, 0 },	/* 632 */
  { "AEC_DISP_REP_MASKBLOCK_REF", DWG_TYPE_AEC_DISP_REP_MASKBLOCK_REF /*(1351)*/, NULL, 0 },	/* 633 */
  { "AEC_DISP_REP_MASKBLOCK_REF_RCP", DWG_TYPE_AEC_DISP_REP_MASKBLOCK_REF_RCP /*(1352)*/, NULL, 0 },	/* 634 */
  { "AEC_DISP_REP_MASS_ELEM_MODEL", DWG_TYPE_AEC_DISP_REP_MASS_ELEM_MODEL /*(1353)*/, NULL, 0 },	/* 635 */
  { "AEC_DISP_REP_MASS_ELEM_RCP", DWG_TYPE_AEC_DISP_REP_MASS_ELEM_RCP /*(1354)*/, NULL, 0 },	/* 636 */
  { "AEC_DISP_REP_MASS_ELEM_SCHEM", DWG_TYPE_AEC_DISP_REP_MASS_ELEM_SCHEM /*(1355)*/, NULL, 0 },	/* 637 */
  { "AEC_DISP_REP_MASS_GROUP_MODEL", DWG_TYPE_AEC_DISP_REP_MASS_GROUP_MODEL /*(1356)*/, NULL, 0 },	/* 638 */
  { "AEC_DISP_REP_MASS_GROUP_PLAN", DWG_TYPE_AEC_DISP_REP_MASS_GROUP_PLAN /*(1357)*/, NULL, 0 },	/* 639 */
  { "AEC_DISP_REP_MASS_GROUP_RCP", DWG_TYPE_AEC_DISP_REP_MASS_GROUP_RCP /*(1358)*/, NULL, 0 },	/* 640 */
  { "AEC_DISP_REP_MATERIAL", DWG_TYPE_AEC_DISP_REP_MATERIAL /*(1359)*/, NULL, 0 },	/* 641 */
  { "AEC_DISP_REP_MVBLOCK_REF", DWG_TYPE_AEC_DISP_REP_MVBLOCK_REF /*(1360)*/, NULL, 0 },	/* 642 */
  { "AEC_DISP_REP_MVBLOCK_REF_MODEL", DWG_TYPE_AEC_DISP_REP_MVBLOCK_REF_MODEL /*(1361)*/, NULL, 0 },	/* 643 */
  { "AEC_DISP_REP_MVBLOCK_REF_RCP", DWG_TYPE_AEC_DISP_REP_MVBLOCK_REF_RCP /*(1362)*/, NULL, 0 },	/* 644 */
  { "AEC_DISP_REP_OPENING", DWG_TYPE_AEC_DISP_REP_OPENING /*(1363)*/, NULL, 0 },	/* 645 */
  { "AEC_DISP_REP_OPENING_MODEL", DWG_TYPE_AEC_DISP_REP_OPENING_MODEL /*(1364)*/, NULL, 0 },	/* 646 */
  { "AEC_DISP_REP_POLYGON_MODEL", DWG_TYPE_AEC_DISP_REP_POLYGON_MODEL /*(1365)*/, NULL, 0 },	/* 647 */
  { "AEC_DISP_REP_POLYGON_TRUECOLOUR", DWG_TYPE_AEC_DISP_REP_POLYGON_TRUECOLOUR /*(1366)*/, NULL, 0 },	/* 648 */
  { "AEC_DISP_REP_RAILING_MODEL", DWG_TYPE_AEC_DISP_REP_RAILING_MODEL /*(1367)*/, NULL, 0 },	/* 649 */
  { "AEC_DISP_REP_RAILING_PLAN", DWG_TYPE_AEC_DISP_REP_RAILING_PLAN /*(1368)*/, NULL, 0 },	/* 650 */
  { "AEC_DISP_REP_RAILING_PLAN_100", DWG_TYPE_AEC_DISP_REP_RAILING_PLAN_100 /*(1369)*/, NULL, 0 },	/* 651 */
  { "AEC_DISP_REP_RAILING_PLAN_50", DWG_TYPE_AEC_DISP_REP_RAILING_PLAN_50 /*(1370)*/, NULL, 0 },	/* 652 */
  { "AEC_DISP_REP_ROOFSLAB_MODEL", DWG_TYPE_AEC_DISP_REP_ROOFSLAB_MODEL /*(1374)*/, NULL, 0 },	/* 653 */
  { "AEC_DISP_REP_ROOFSLAB_PLAN", DWG_TYPE_AEC_DISP_REP_ROOFSLAB_PLAN /*(1375)*/, NULL, 0 },	/* 654 */
  { "AEC_DISP_REP_ROOF_MODEL", DWG_TYPE_AEC_DISP_REP_ROOF_MODEL /*(1371)*/, NULL, 0 },	/* 655 */
  { "AEC_DISP_REP_ROOF_PLAN", DWG_TYPE_AEC_DISP_REP_ROOF_PLAN /*(1372)*/, NULL, 0 },	/* 656 */
  { "AEC_DISP_REP_ROOF_RCP", DWG_TYPE_AEC_DISP_REP_ROOF_RCP /*(1373)*/, NULL, 0 },	/* 657 */
  { "AEC_DISP_REP_SCHEDULE_TABLE", DWG_TYPE_AEC_DISP_REP_SCHEDULE_TABLE /*(1376)*/, NULL, 0 },	/* 658 */
  { "AEC_DISP_REP_SET", DWG_TYPE_AEC_DISP_REP_SET /*(1377)*/, NULL, 0 },	/* 659 */
  { "AEC_DISP_REP_SLAB_MODEL", DWG_TYPE_AEC_DISP_REP_SLAB_MODEL /*(1378)*/, NULL, 0 },	/* 660 */
  { "AEC_DISP_REP_SLAB_PLAN", DWG_TYPE_AEC_DISP_REP_SLAB_PLAN /*(1379)*/, NULL, 0 },	/* 661 */
  { "AEC_DISP_REP_SLICE", DWG_TYPE_AEC_DISP_REP_SLICE /*(1380)*/, NULL, 0 },	/* 662 */
  { "AEC_DISP_REP_SPACE_DECOMPOSED", DWG_TYPE_AEC_DISP_REP_SPACE_DECOMPOSED /*(1381)*/, NULL, 0 },	/* 663 */
  { "AEC_DISP_REP_SPACE_MODEL", DWG_TYPE_AEC_DISP_REP_SPACE_MODEL /*(1382)*/, NULL, 0 },	/* 664 */
  { "AEC_DISP_REP_SPACE_PLAN", DWG_TYPE_AEC_DISP_REP_SPACE_PLAN /*(1383)*/, NULL, 0 },	/* 665 */
  { "AEC_DISP_REP_SPACE_RCP", DWG_TYPE_AEC_DISP_REP_SPACE_RCP /*(1384)*/, NULL, 0 },	/* 666 */
  { "AEC_DISP_REP_SPACE_VOLUME", DWG_TYPE_AEC_DISP_REP_SPACE_VOLUME /*(1385)*/, NULL, 0 },	/* 667 */
  { "AEC_DISP_REP_STAIR_MODEL", DWG_TYPE_AEC_DISP_REP_STAIR_MODEL /*(1386)*/, NULL, 0 },	/* 668 */
  { "AEC_DISP_REP_STAIR_PLAN", DWG_TYPE_AEC_DISP_REP_STAIR_PLAN /*(1387)*/, NULL, 0 },	/* 669 */
  { "AEC_DISP_REP_STAIR_PLAN_100", DWG_TYPE_AEC_DISP_REP_STAIR_PLAN_100 /*(1388)*/, NULL, 0 },	/* 670 */
  { "AEC_DISP_REP_STAIR_PLAN_50", DWG_TYPE_AEC_DISP_REP_STAIR_PLAN_50 /*(1389)*/, NULL, 0 },	/* 671 */
  { "AEC_DISP_REP_STAIR_PLAN_OVERLAPPING", DWG_TYPE_AEC_DISP_REP_STAIR_PLAN_OVERLAPPING /*(1390)*/, NULL, 0 },	/* 672 */
  { "AEC_DISP_REP_STAIR_RCP", DWG_TYPE_AEC_DISP_REP_STAIR_RCP /*(1391)*/, NULL, 0 },	/* 673 */
  { "AEC_DISP_REP_WALL_GRAPH", DWG_TYPE_AEC_DISP_REP_WALL_GRAPH /*(1392)*/, NULL, 0 },	/* 674 */
  { "AEC_DISP_REP_WALL_MODEL", DWG_TYPE_AEC_DISP_REP_WALL_MODEL /*(1393)*/, NULL, 0 },	/* 675 */
  { "AEC_DISP_REP_WALL_PLAN", DWG_TYPE_AEC_DISP_REP_WALL_PLAN /*(1394)*/, NULL, 0 },	/* 676 */
  { "AEC_DISP_REP_WALL_RCP", DWG_TYPE_AEC_DISP_REP_WALL_RCP /*(1395)*/, NULL, 0 },	/* 677 */
  { "AEC_DISP_REP_WALL_SCHEM", DWG_TYPE_AEC_DISP_REP_WALL_SCHEM /*(1396)*/, NULL, 0 },	/* 678 */
  { "AEC_DISP_REP_WINDOWASSEMBLY_SILL_PLAN", DWG_TYPE_AEC_DISP_REP_WINDOWASSEMBLY_SILL_PLAN /*(1399)*/, NULL, 0 },	/* 679 */
  { "AEC_DISP_REP_WINDOW_ASSEMBLY_MODEL", DWG_TYPE_AEC_DISP_REP_WINDOW_ASSEMBLY_MODEL /*(1397)*/, NULL, 0 },	/* 680 */
  { "AEC_DISP_REP_WINDOW_ASSEMBLY_PLAN", DWG_TYPE_AEC_DISP_REP_WINDOW_ASSEMBLY_PLAN /*(1398)*/, NULL, 0 },	/* 681 */
  { "AEC_DISP_REP_WINDOW_ELEV", DWG_TYPE_AEC_DISP_REP_WINDOW_ELEV /*(1400)*/, NULL, 0 },	/* 682 */
  { "AEC_DISP_REP_WINDOW_MODEL", DWG_TYPE_AEC_DISP_REP_WINDOW_MODEL /*(1401)*/, NULL, 0 },	/* 683 */
  { "AEC_DISP_REP_WINDOW_NOMINAL", DWG_TYPE_AEC_DISP_REP_WINDOW_NOMINAL /*(1402)*/, NULL, 0 },	/* 684 */
  { "AEC_DISP_REP_WINDOW_PLAN", DWG_TYPE_AEC_DISP_REP_WINDOW_PLAN /*(1403)*/, NULL, 0 },	/* 685 */
  { "AEC_DISP_REP_WINDOW_PLAN_100", DWG_TYPE_AEC_DISP_REP_WINDOW_PLAN_100 /*(1404)*/, NULL, 0 },	/* 686 */
  { "AEC_DISP_REP_WINDOW_PLAN_50", DWG_TYPE_AEC_DISP_REP_WINDOW_PLAN_50 /*(1405)*/, NULL, 0 },	/* 687 */
  { "AEC_DISP_REP_WINDOW_RCP", DWG_TYPE_AEC_DISP_REP_WINDOW_RCP /*(1406)*/, NULL, 0 },	/* 688 */
  { "AEC_DISP_REP_WINDOW_SILL_PLAN", DWG_TYPE_AEC_DISP_REP_WINDOW_SILL_PLAN /*(1407)*/, NULL, 0 },	/* 689 */
  { "AEC_DISP_REP_ZONE", DWG_TYPE_AEC_DISP_REP_ZONE /*(1408)*/, NULL, 0 },	/* 690 */
  { "AEC_DISP_ROPS_RAILING_PLAN_100", DWG_TYPE_AEC_DISP_ROPS_RAILING_PLAN_100 /*(1414)*/, NULL, 0 },	/* 691 */
  { "AEC_DISP_ROPS_RAILING_PLAN_50", DWG_TYPE_AEC_DISP_ROPS_RAILING_PLAN_50 /*(1415)*/, NULL, 0 },	/* 692 */
  { "AEC_DISP_ROPS_STAIR_PLAN_100", DWG_TYPE_AEC_DISP_ROPS_STAIR_PLAN_100 /*(1416)*/, NULL, 0 },	/* 693 */
  { "AEC_DISP_ROPS_STAIR_PLAN_50", DWG_TYPE_AEC_DISP_ROPS_STAIR_PLAN_50 /*(1417)*/, NULL, 0 },	/* 694 */
  { "AEC_DOOR_STYLE", DWG_TYPE_AEC_DOOR_STYLE /*(1418)*/, NULL, 0 },	/* 695 */
  { "AEC_ENDCAP_STYLE", DWG_TYPE_AEC_ENDCAP_STYLE /*(1419)*/, NULL, 0 },	/* 696 */
  { "AEC_FRAME_DEF", DWG_TYPE_AEC_FRAME_DEF /*(1420)*/, NULL, 0 },	/* 697 */
  { "AEC_LAYERKEY_STYLE", DWG_TYPE_AEC_LAYERKEY_STYLE /*(1421)*/, NULL, 0 },	/* 698 */
  { "AEC_LIST_DEF", DWG_TYPE_AEC_LIST_DEF /*(1422)*/, NULL, 0 },	/* 699 */
  { "AEC_MASKBLOCK_DEF", DWG_TYPE_AEC_MASKBLOCK_DEF /*(1423)*/, NULL, 0 },	/* 700 */
  { "AEC_MASS_ELEM_STYLE", DWG_TYPE_AEC_MASS_ELEM_STYLE /*(1424)*/, NULL, 0 },	/* 701 */
  { "AEC_MATERIAL_DEF", DWG_TYPE_AEC_MATERIAL_DEF /*(1425)*/, NULL, 0 },	/* 702 */
  { "AEC_MVBLOCK_DEF", DWG_TYPE_AEC_MVBLOCK_DEF /*(1426)*/, NULL, 0 },	/* 703 */
  { "AEC_MVBLOCK_REF", DWG_TYPE_AEC_MVBLOCK_REF /*(1427)*/, NULL, 0 },	/* 704 */
  { "AEC_NOTIFICATION_TRACKER", DWG_TYPE_AEC_NOTIFICATION_TRACKER /*(1428)*/, NULL, 0 },	/* 705 */
  { "AEC_POLYGON", DWG_TYPE_AEC_POLYGON /*(1429)*/, NULL, 0 },	/* 706 */
  { "AEC_POLYGON_STYLE", DWG_TYPE_AEC_POLYGON_STYLE /*(1430)*/, NULL, 0 },	/* 707 */
  { "AEC_PROPERTY_SET_DEF", DWG_TYPE_AEC_PROPERTY_SET_DEF /*(1431)*/, NULL, 0 },	/* 708 */
  { "AEC_RAILING_STYLE", DWG_TYPE_AEC_RAILING_STYLE /*(1432)*/, NULL, 0 },	/* 709 */
  { "AEC_REFEDIT_STATUS_TRACKER", DWG_TYPE_AEC_REFEDIT_STATUS_TRACKER /*(1433)*/, NULL, 0 },	/* 710 */
  { "AEC_ROOFSLABEDGE_STYLE", DWG_TYPE_AEC_ROOFSLABEDGE_STYLE /*(1434)*/, NULL, 0 },	/* 711 */
  { "AEC_ROOFSLAB_STYLE", DWG_TYPE_AEC_ROOFSLAB_STYLE /*(1435)*/, NULL, 0 },	/* 712 */
  { "AEC_SCHEDULE_DATA_FORMAT", DWG_TYPE_AEC_SCHEDULE_DATA_FORMAT /*(1436)*/, NULL, 0 },	/* 713 */
  { "AEC_SLABEDGE_STYLE", DWG_TYPE_AEC_SLABEDGE_STYLE /*(1437)*/, NULL, 0 },	/* 714 */
  { "AEC_SLAB_STYLE", DWG_TYPE_AEC_SLAB_STYLE /*(1438)*/, NULL, 0 },	/* 715 */
  { "AEC_SPACE_STYLES", DWG_TYPE_AEC_SPACE_STYLES /*(1439)*/, NULL, 0 },	/* 716 */
  { "AEC_STAIR_STYLE", DWG_TYPE_AEC_STAIR_STYLE /*(1440)*/, NULL, 0 },	/* 717 */
  { "AEC_STAIR_WINDER_STYLE", DWG_TYPE_AEC_STAIR_WINDER_STYLE /*(1441)*/, NULL, 0 },	/* 718 */
  { "AEC_STAIR_WINDER_TYPE_BALANCED", DWG_TYPE_AEC_STAIR_WINDER_TYPE_BALANCED /*(1442)*/, NULL, 0 },	/* 719 */
  { "AEC_STAIR_WINDER_TYPE_MANUAL", DWG_TYPE_AEC_STAIR_WINDER_TYPE_MANUAL /*(1443)*/, NULL, 0 },	/* 720 */
  { "AEC_STAIR_WINDER_TYPE_SINGLE_POINT", DWG_TYPE_AEC_STAIR_WINDER_TYPE_SINGLE_POINT /*(1444)*/, NULL, 0 },	/* 721 */
  { "AEC_VARS_AECBBLDSRV", DWG_TYPE_AEC_VARS_AECBBLDSRV /*(1445)*/, NULL, 0 },	/* 722 */
  { "AEC_VARS_ARCHBASE", DWG_TYPE_AEC_VARS_ARCHBASE /*(1446)*/, NULL, 0 },	/* 723 */
  { "AEC_VARS_DWG_SETUP", DWG_TYPE_AEC_VARS_DWG_SETUP /*(1447)*/, NULL, 0 },	/* 724 */
  { "AEC_VARS_MUNICH", DWG_TYPE_AEC_VARS_MUNICH /*(1448)*/, NULL, 0 },	/* 725 */
  { "AEC_VARS_STRUCTUREBASE", DWG_TYPE_AEC_VARS_STRUCTUREBASE /*(1449)*/, NULL, 0 },	/* 726 */
  { "AEC_WALLMOD_STYLE", DWG_TYPE_AEC_WALLMOD_STYLE /*(1450)*/, NULL, 0 },	/* 727 */
  { "AEC_WALL_STYLE", DWG_TYPE_AEC_WALL_STYLE /*(1451)*/, NULL, 0 },	/* 728 */
  { "AEC_WINDOW_ASSEMBLY_STYLE", DWG_TYPE_AEC_WINDOW_ASSEMBLY_STYLE /*(1452)*/, NULL, 0 },	/* 729 */
  { "AEC_WINDOW_STYLE", DWG_TYPE_AEC_WINDOW_STYLE /*(1453)*/, NULL, 0 },	/* 730 */
  ...
  { "ALIGNMENTGRIPENTITY", DWG_TYPE_ALIGNMENTGRIPENTITY /*(1454)*/, NULL, 0 },	/* 732 */
  ...
  { "AMCONTEXTMGR", DWG_TYPE_AMCONTEXTMGR /*(1455)*/, NULL, 0 },	/* 734 */
  { "AMDTADMENUSTATE", DWG_TYPE_AMDTADMENUSTATE /*(1456)*/, NULL, 0 },	/* 735 */
  { "AMDTAMMENUSTATE", DWG_TYPE_AMDTAMMENUSTATE /*(1457)*/, NULL, 0 },	/* 736 */
  { "AMDTBROWSERDBTAB", DWG_TYPE_AMDTBROWSERDBTAB /*(1458)*/, NULL, 0 },	/* 737 */
  { "AMDTDMMENUSTATE", DWG_TYPE_AMDTDMMENUSTATE /*(1459)*/, NULL, 0 },	/* 738 */
  { "AMDTEDGESTANDARDDIN", DWG_TYPE_AMDTEDGESTANDARDDIN /*(1460)*/, NULL, 0 },	/* 739 */
  { "AMDTEDGESTANDARDDIN13715", DWG_TYPE_AMDTEDGESTANDARDDIN13715 /*(1461)*/, NULL, 0 },	/* 740 */
  { "AMDTEDGESTANDARDISO", DWG_TYPE_AMDTEDGESTANDARDISO /*(1462)*/, NULL, 0 },	/* 741 */
  { "AMDTEDGESTANDARDISO13715", DWG_TYPE_AMDTEDGESTANDARDISO13715 /*(1463)*/, NULL, 0 },	/* 742 */
  { "AMDTFORMULAUPDATEDISPATCHER", DWG_TYPE_AMDTFORMULAUPDATEDISPATCHER /*(1464)*/, NULL, 0 },	/* 743 */
  { "AMDTINTERNALREACTOR", DWG_TYPE_AMDTINTERNALREACTOR /*(1465)*/, NULL, 0 },	/* 744 */
  { "AMDTMCOMMENUSTATE", DWG_TYPE_AMDTMCOMMENUSTATE /*(1466)*/, NULL, 0 },	/* 745 */
  { "AMDTMENUSTATEMGR", DWG_TYPE_AMDTMENUSTATEMGR /*(1467)*/, NULL, 0 },	/* 746 */
  { "AMDTNOTE", DWG_TYPE_AMDTNOTE /*(1468)*/, NULL, 0 },	/* 747 */
  { "AMDTNOTETEMPLATEDB", DWG_TYPE_AMDTNOTETEMPLATEDB /*(1469)*/, NULL, 0 },	/* 748 */
  { "AMDTSECTIONSYM", DWG_TYPE_AMDTSECTIONSYM /*(1470)*/, NULL, 0 },	/* 749 */
  { "AMDTSECTIONSYMLABEL", DWG_TYPE_AMDTSECTIONSYMLABEL /*(1471)*/, NULL, 0 },	/* 750 */
  { "AMDTSYSATTR", DWG_TYPE_AMDTSYSATTR /*(1472)*/, NULL, 0 },	/* 751 */
  { "AMGOBJPROPCFG", DWG_TYPE_AMGOBJPROPCFG /*(1473)*/, NULL, 0 },	/* 752 */
  { "AMGSETTINGSOBJ", DWG_TYPE_AMGSETTINGSOBJ /*(1474)*/, NULL, 0 },	/* 753 */
  { "AMIMASTER", DWG_TYPE_AMIMASTER /*(1475)*/, NULL, 0 },	/* 754 */
  { "AM_DRAWING_MGR", DWG_TYPE_AM_DRAWING_MGR /*(1476)*/, NULL, 0 },	/* 755 */
  { "AM_DWGMGR_NAME", DWG_TYPE_AM_DWGMGR_NAME /*(1477)*/, NULL, 0 },	/* 756 */
  { "AM_DWG_DOCUMENT", DWG_TYPE_AM_DWG_DOCUMENT /*(1478)*/, NULL, 0 },	/* 757 */
  { "AM_DWG_SHEET", DWG_TYPE_AM_DWG_SHEET /*(1479)*/, NULL, 0 },	/* 758 */
  { "AM_VIEWDIMPARMAP", DWG_TYPE_AM_VIEWDIMPARMAP /*(1480)*/, NULL, 0 },	/* 759 */
  ...
  { "BINRECORD", DWG_TYPE_BINRECORD /*(1481)*/, NULL, 0 },	/* 815 */
  ...
  { "CAMSCATALOGAPPOBJECT", DWG_TYPE_CAMSCATALOGAPPOBJECT /*(1482)*/, NULL, 0 },	/* 863 */
  { "CAMSSTRUCTBTNSTATE", DWG_TYPE_CAMSSTRUCTBTNSTATE /*(1483)*/, NULL, 0 },	/* 864 */
  { "CATALOGSTATE", DWG_TYPE_CATALOGSTATE /*(1484)*/, NULL, 0 },	/* 865 */
  { "CBROWSERAPPOBJECT", DWG_TYPE_CBROWSERAPPOBJECT /*(1485)*/, NULL, 0 },	/* 866 */
  ...
  { "DEPMGR", DWG_TYPE_DEPMGR /*(1486)*/, NULL, 0 },	/* 875 */
  ...
  { "DMBASEELEMENT", DWG_TYPE_DMBASEELEMENT /*(1487)*/, NULL, 0 },	/* 892 */
  { "DMDEFAULTSTYLE", DWG_TYPE_DMDEFAULTSTYLE /*(1488)*/, NULL, 0 },	/* 893 */
  ...
  { "DMLEGEND", DWG_TYPE_DMLEGEND /*(1489)*/, NULL, 0 },	/* 895 */
  { "DMMAP", DWG_TYPE_DMMAP /*(1490)*/, NULL, 0 },	/* 896 */
  { "DMMAPMANAGER", DWG_TYPE_DMMAPMANAGER /*(1491)*/, NULL, 0 },	/* 897 */
  { "DMSTYLECATEGORY", DWG_TYPE_DMSTYLECATEGORY /*(1492)*/, NULL, 0 },	/* 898 */
  { "DMSTYLELIBRARY", DWG_TYPE_DMSTYLELIBRARY /*(1493)*/, NULL, 0 },	/* 899 */
  { "DMSTYLEREFERENCE", DWG_TYPE_DMSTYLEREFERENCE /*(1494)*/, NULL, 0 },	/* 900 */
  { "DMSTYLIZEDENTITIESTABLE", DWG_TYPE_DMSTYLIZEDENTITIESTABLE /*(1495)*/, NULL, 0 },	/* 901 */
  { "DMSURROGATESTYLESETS", DWG_TYPE_DMSURROGATESTYLESETS /*(1496)*/, NULL, 0 },	/* 902 */
  { "DM_PLACEHOLDER", DWG_TYPE_DM_PLACEHOLDER /*(1497)*/, NULL, 0 },	/* 903 */
  ...
  { "EXACTERMXREFMAP", DWG_TYPE_EXACTERMXREFMAP /*(1498)*/, NULL, 0 },	/* 913 */
  { "EXACXREFPANELOBJECT", DWG_TYPE_EXACXREFPANELOBJECT /*(1499)*/, NULL, 0 },	/* 914 */
  { "EXPO_NOTIFYBLOCK", DWG_TYPE_EXPO_NOTIFYBLOCK /*(1500)*/, NULL, 0 },	/* 915 */
  { "EXPO_NOTIFYHALL", DWG_TYPE_EXPO_NOTIFYHALL /*(1501)*/, NULL, 0 },	/* 916 */
  { "EXPO_NOTIFYPILLAR", DWG_TYPE_EXPO_NOTIFYPILLAR /*(1502)*/, NULL, 0 },	/* 917 */
  { "EXPO_NOTIFYSTAND", DWG_TYPE_EXPO_NOTIFYSTAND /*(1503)*/, NULL, 0 },	/* 918 */
  { "EXPO_NOTIFYSTANDNOPOLY", DWG_TYPE_EXPO_NOTIFYSTANDNOPOLY /*(1504)*/, NULL, 0 },	/* 919 */
  ...
  { "GSMANAGER", DWG_TYPE_GSMANAGER /*(1505)*/, NULL, 0 },	/* 934 */
  ...
  { "IRD_DSC_DICT", DWG_TYPE_IRD_DSC_DICT /*(1506)*/, NULL, 0 },	/* 945 */
  { "IRD_DSC_RECORD", DWG_TYPE_IRD_DSC_RECORD /*(1507)*/, NULL, 0 },	/* 946 */
  { "IRD_OBJ_RECORD", DWG_TYPE_IRD_OBJ_RECORD /*(1508)*/, NULL, 0 },	/* 947 */
  ...
  { "LOAD", DWG_TYPE_LOAD /*(746)*/, _dwg_LOAD_fields, sizeof (struct _dwg_entity_LOAD) },	/* 963 */
  ...
  { "MAPFSMRVOBJECT", DWG_TYPE_MAPFSMRVOBJECT /*(1509)*/, NULL, 0 },	/* 969 */
  { "MAPGWSUNDOOBJECT", DWG_TYPE_MAPGWSUNDOOBJECT /*(1510)*/, NULL, 0 },	/* 970 */
  { "MAPIAMMOUDLE", DWG_TYPE_MAPIAMMOUDLE /*(1511)*/, NULL, 0 },	/* 971 */
  { "MAPMETADATAOBJECT", DWG_TYPE_MAPMETADATAOBJECT /*(1512)*/, NULL, 0 },	/* 972 */
  { "MAPRESOURCEMANAGEROBJECT", DWG_TYPE_MAPRESOURCEMANAGEROBJECT /*(1513)*/, NULL, 0 },	/* 973 */
  ...
  { "McDbContainer2", DWG_TYPE_McDbContainer2 /*(1514)*/, NULL, 0 },	/* 989 */
  { "McDbMarker", DWG_TYPE_McDbMarker /*(1515)*/, NULL, 0 },	/* 990 */
  { "NAMEDAPPL", DWG_TYPE_NAMEDAPPL /*(1516)*/, NULL, 0 },	/* 991 */
  ...
  { "NEWSTDPARTPARLIST", DWG_TYPE_NEWSTDPARTPARLIST /*(1517)*/, NULL, 0 },	/* 994 */
  { "NOTEPOSITION", DWG_TYPE_NOTEPOSITION /*(1518)*/, NULL, 0 },	/* 995 */
  ...
  { "OBJCLONER", DWG_TYPE_OBJCLONER /*(1519)*/, NULL, 0 },	/* 998 */
  ...
  { "PARAMMGR", DWG_TYPE_PARAMMGR /*(1520)*/, NULL, 0 },	/* 1003 */
  { "PARAMSCOPE", DWG_TYPE_PARAMSCOPE /*(1521)*/, NULL, 0 },	/* 1004 */
  ...
  { "PILLAR", DWG_TYPE_PILLAR /*(1522)*/, NULL, 0 },	/* 1009 */
  ...
  { "RADIMOBJECTCONTEXTDATA", DWG_TYPE_RADIMOBJECTCONTEXTDATA /*(695)*/, _dwg_RADIMOBJECTCONTEXTDATA_fields, sizeof (struct _dwg_object_RADIMOBJECTCONTEXTDATA) },	/* 1032 */
  { "RAPIDRTRENDERSETTINGS", DWG_TYPE_RAPIDRTRENDERSETTINGS /*(696)*/, _dwg_RAPIDRTRENDERSETTINGS_fields, sizeof (struct _dwg_object_RAPIDRTRENDERSETTINGS) },	/* 1033 */
  { "RASTERVARIABLES", DWG_TYPE_RASTERVARIABLES /*(697)*/, _dwg_RASTERVARIABLES_fields, sizeof (struct _dwg_object_RASTERVARIABLES) },	/* 1034 */
  { "RAY", DWG_TYPE_RAY /*(40)*/, _dwg_RAY_fields, sizeof (struct _dwg_entity_RAY) },	/* 1035 */
  { "REGION", DWG_TYPE_REGION /*(37)*/, _dwg_3DSOLID_fields, sizeof (struct _dwg_entity_3DSOLID) },	/* 1036 */
  { "RENDERENTRY", DWG_TYPE_RENDERENTRY /*(698)*/, _dwg_RENDERENTRY_fields, sizeof (struct _dwg_object_RENDERENTRY) },	/* 1037 */
  { "RENDERENVIRONMENT", DWG_TYPE_RENDERENVIRONMENT /*(699)*/, _dwg_RENDERENVIRONMENT_fields, sizeof (struct _dwg_object_RENDERENVIRONMENT) },	/* 1038 */
  { "RENDERGLOBAL", DWG_TYPE_RENDERGLOBAL /*(700)*/, _dwg_RENDERGLOBAL_fields, sizeof (struct _dwg_object_RENDERGLOBAL) },	/* 1039 */
  { "RENDERSETTINGS", DWG_TYPE_RENDERSETTINGS /*(701)*/, _dwg_RENDERSETTINGS_fields, sizeof (struct _dwg_object_RENDERSETTINGS) },	/* 1040 */
  { "REPEAT", DWG_TYPE_REPEAT /*(741)*/, _dwg_REPEAT_fields, sizeof (struct _dwg_entity_REPEAT) },	/* 1041 */
  { "REVOLVEDSURFACE", DWG_TYPE_REVOLVEDSURFACE /*(702)*/, _dwg_REVOLVEDSURFACE_fields, sizeof (struct _dwg_entity_REVOLVEDSURFACE) },	/* 1042 */
  { "ROTATEACTIONENTITY", DWG_TYPE_ROTATEACTIONENTITY /*(704)*/, NULL, 0 },	/* 1043 */
  { "ROTATIONGRIPENTITY", DWG_TYPE_ROTATIONGRIPENTITY /*(738)*/, _dwg_ROTATIONGRIPENTITY_fields, sizeof (struct _dwg_entity_ROTATIONGRIPENTITY) },	/* 1044 */
  { "ROTATIONPARAMETERENTITY", DWG_TYPE_ROTATIONPARAMETERENTITY /*(703)*/, _dwg_ROTATIONPARAMETERENTITY_fields, sizeof (struct _dwg_entity_ROTATIONPARAMETERENTITY) },	/* 1045 */
  { "RTEXT", DWG_TYPE_RTEXT /*(705)*/, _dwg_RTEXT_fields, sizeof (struct _dwg_entity_RTEXT) },	/* 1046 */
  { "SCALE", DWG_TYPE_SCALE /*(706)*/, _dwg_SCALE_fields, sizeof (struct _dwg_object_SCALE) },	/* 1047 */
  { "SCALEACTIONENTITY", DWG_TYPE_SCALEACTIONENTITY /*(707)*/, NULL, 0 },	/* 1048 */
  { "SECTIONOBJECT", DWG_TYPE_SECTIONOBJECT /*(708)*/, _dwg_SECTIONOBJECT_fields, sizeof (struct _dwg_entity_SECTIONOBJECT) },	/* 1049 */
  { "SECTIONVIEWSTYLE", DWG_TYPE_SECTIONVIEWSTYLE /*(709)*/, _dwg_SECTIONVIEWSTYLE_fields, sizeof (struct _dwg_object_SECTIONVIEWSTYLE) },	/* 1050 */
  { "SECTION_MANAGER", DWG_TYPE_SECTION_MANAGER /*(710)*/, _dwg_SECTION_MANAGER_fields, sizeof (struct _dwg_object_SECTION_MANAGER) },	/* 1051 */
  { "SECTION_SETTINGS", DWG_TYPE_SECTION_SETTINGS /*(711)*/, _dwg_SECTION_SETTINGS_fields, sizeof (struct _dwg_object_SECTION_SETTINGS) },	/* 1052 */
  { "SEQEND", DWG_TYPE_SEQEND /*(6)*/, _dwg_SEQEND_fields, sizeof (struct _dwg_entity_SEQEND) },	/* 1053 */
  { "SHAPE", DWG_TYPE_SHAPE /*(33)*/, _dwg_SHAPE_fields, sizeof (struct _dwg_entity_SHAPE) },	/* 1054 */
  { "SKYLIGHT_BACKGROUND", DWG_TYPE_SKYLIGHT_BACKGROUND /*(712)*/, _dwg_SKYLIGHT_BACKGROUND_fields, sizeof (struct _dwg_object_SKYLIGHT_BACKGROUND) },	/* 1055 */
  { "SOLID", DWG_TYPE_SOLID /*(31)*/, _dwg_SOLID_fields, sizeof (struct _dwg_entity_SOLID) },	/* 1056 */
  { "SOLID_BACKGROUND", DWG_TYPE_SOLID_BACKGROUND /*(713)*/, _dwg_SOLID_BACKGROUND_fields, sizeof (struct _dwg_object_SOLID_BACKGROUND) },	/* 1057 */
  { "SORTENTSTABLE", DWG_TYPE_SORTENTSTABLE /*(714)*/, _dwg_SORTENTSTABLE_fields, sizeof (struct _dwg_object_SORTENTSTABLE) },	/* 1058 */
  { "SPATIAL_FILTER", DWG_TYPE_SPATIAL_FILTER /*(715)*/, _dwg_SPATIAL_FILTER_fields, sizeof (struct _dwg_object_SPATIAL_FILTER) },	/* 1059 */
  { "SPATIAL_INDEX", DWG_TYPE_SPATIAL_INDEX /*(716)*/, _dwg_SPATIAL_INDEX_fields, sizeof (struct _dwg_object_SPATIAL_INDEX) },	/* 1060 */
  { "SPLINE", DWG_TYPE_SPLINE /*(36)*/, _dwg_SPLINE_fields, sizeof (struct _dwg_entity_SPLINE) },	/* 1061 */
  { "STDPART2D", DWG_TYPE_STDPART2D /*(1523)*/, NULL, 0 },	/* 1062 */
  { "STRETCHACTIONENTITY", DWG_TYPE_STRETCHACTIONENTITY /*(717)*/, NULL, 0 },	/* 1063 */
  { "STYLE", DWG_TYPE_STYLE /*(53)*/, _dwg_STYLE_fields, sizeof (struct _dwg_object_STYLE) },	/* 1064 */
  { "STYLE_CONTROL", DWG_TYPE_STYLE_CONTROL /*(52)*/, _dwg_STYLE_CONTROL_fields, sizeof (struct _dwg_object_STYLE_CONTROL) },	/* 1065 */
  { "SUN", DWG_TYPE_SUN /*(718)*/, _dwg_SUN_fields, sizeof (struct _dwg_object_SUN) },	/* 1066 */
  { "SUNSTUDY", DWG_TYPE_SUNSTUDY /*(719)*/, _dwg_SUNSTUDY_fields, sizeof (struct _dwg_object_SUNSTUDY) },	/* 1067 */
  { "SWEPTSURFACE", DWG_TYPE_SWEPTSURFACE /*(720)*/, _dwg_SWEPTSURFACE_fields, sizeof (struct _dwg_entity_SWEPTSURFACE) },	/* 1068 */
  { "TABLE", DWG_TYPE_TABLE /*(721)*/, _dwg_TABLE_fields, sizeof (struct _dwg_entity_TABLE) },	/* 1069 */
  { "TABLECONTENT", DWG_TYPE_TABLECONTENT /*(722)*/, _dwg_TABLECONTENT_fields, sizeof (struct _dwg_object_TABLECONTENT) },	/* 1070 */
  { "TABLEGEOMETRY", DWG_TYPE_TABLEGEOMETRY /*(723)*/, _dwg_TABLEGEOMETRY_fields, sizeof (struct _dwg_object_TABLEGEOMETRY) },	/* 1071 */
  { "TABLESTYLE", DWG_TYPE_TABLESTYLE /*(724)*/, _dwg_TABLESTYLE_fields, sizeof (struct _dwg_object_TABLESTYLE) },	/* 1072 */
  { "TCH_ARROW", DWG_TYPE_TCH_ARROW /*(1524)*/, NULL, 0 },	/* 1073 */
  { "TCH_AXIS_LABEL", DWG_TYPE_TCH_AXIS_LABEL /*(1525)*/, NULL, 0 },	/* 1074 */
  { "TCH_BLOCK_INSERT", DWG_TYPE_TCH_BLOCK_INSERT /*(1526)*/, NULL, 0 },	/* 1075 */
  { "TCH_COLUMN", DWG_TYPE_TCH_COLUMN /*(1527)*/, NULL, 0 },	/* 1076 */
  { "TCH_DBCONFIG", DWG_TYPE_TCH_DBCONFIG /*(1528)*/, NULL, 0 },	/* 1077 */
  { "TCH_DIMENSION2", DWG_TYPE_TCH_DIMENSION2 /*(1529)*/, NULL, 0 },	/* 1078 */
  { "TCH_DRAWINGINDEX", DWG_TYPE_TCH_DRAWINGINDEX /*(1530)*/, NULL, 0 },	/* 1079 */
  { "TCH_HANDRAIL", DWG_TYPE_TCH_HANDRAIL /*(1531)*/, NULL, 0 },	/* 1080 */
  { "TCH_LINESTAIR", DWG_TYPE_TCH_LINESTAIR /*(1532)*/, NULL, 0 },	/* 1081 */
  { "TCH_OPENING", DWG_TYPE_TCH_OPENING /*(1533)*/, NULL, 0 },	/* 1082 */
  { "TCH_RECTSTAIR", DWG_TYPE_TCH_RECTSTAIR /*(1534)*/, NULL, 0 },	/* 1083 */
  { "TCH_SLAB", DWG_TYPE_TCH_SLAB /*(1535)*/, NULL, 0 },	/* 1084 */
  { "TCH_SPACE", DWG_TYPE_TCH_SPACE /*(1536)*/, NULL, 0 },	/* 1085 */
  { "TCH_TEXT", DWG_TYPE_TCH_TEXT /*(1537)*/, NULL, 0 },	/* 1086 */
  { "TCH_WALL", DWG_TYPE_TCH_WALL /*(1538)*/, NULL, 0 },	/* 1087 */
  { "TEXT", DWG_TYPE_TEXT /*(1)*/, _dwg_TEXT_fields, sizeof (struct _dwg_entity_TEXT) },	/* 1088 */
  { "TEXTOBJECTCONTEXTDATA", DWG_TYPE_TEXTOBJECTCONTEXTDATA /*(725)*/, _dwg_TEXTOBJECTCONTEXTDATA_fields, sizeof (struct _dwg_object_TEXTOBJECTCONTEXTDATA) },	/* 1089 */
  { "TGrupoPuntos", DWG_TYPE_TGrupoPuntos /*(1539)*/, NULL, 0 },	/* 1090 */
  { "TOLERANCE", DWG_TYPE_TOLERANCE /*(46)*/, _dwg_TOLERANCE_fields, sizeof (struct _dwg_entity_TOLERANCE) },	/* 1091 */
  { "TRACE", DWG_TYPE_TRACE /*(32)*/, _dwg_TRACE_fields, sizeof (struct _dwg_entity_TRACE) },	/* 1092 */
  { "TVDEVICEPROPERTIES", DWG_TYPE_TVDEVICEPROPERTIES /*(726)*/, _dwg_TVDEVICEPROPERTIES_fields, sizeof (struct _dwg_object_TVDEVICEPROPERTIES) },	/* 1093 */
  { "UCS", DWG_TYPE_UCS /*(63)*/, _dwg_UCS_fields, sizeof (struct _dwg_object_UCS) },	/* 1094 */
  { "UCS_CONTROL", DWG_TYPE_UCS_CONTROL /*(62)*/, _dwg_UCS_CONTROL_fields, sizeof (struct _dwg_object_UCS_CONTROL) },	/* 1095 */
  { "UNKNOWN_ENT", DWG_TYPE_UNKNOWN_ENT /*(65534)*/, _dwg_UNKNOWN_ENT_fields, sizeof (struct _dwg_entity_UNKNOWN_ENT) },	/* 1096 */
  { "UNKNOWN_OBJ", DWG_TYPE_UNKNOWN_OBJ /*(65535)*/, _dwg_UNKNOWN_OBJ_fields, sizeof (struct _dwg_object_UNKNOWN_OBJ) },	/* 1097 */
  { "UNUSED", DWG_TYPE_UNUSED /*(0)*/, NULL, 0 },	/* 1098 */
  ...
  { "VISIBILITYGRIPENTITY", DWG_TYPE_VISIBILITYGRIPENTITY /*(727)*/, _dwg_VISIBILITYGRIPENTITY_fields, sizeof (struct _dwg_entity_VISIBILITYGRIPENTITY) },	/* 1111 */
  { "VISIBILITYPARAMETERENTITY", DWG_TYPE_VISIBILITYPARAMETERENTITY /*(728)*/, _dwg_VISIBILITYPARAMETERENTITY_fields, sizeof (struct _dwg_entity_VISIBILITYPARAMETERENTITY) },	/* 1112 */
  { "VISUALSTYLE", DWG_TYPE_VISUALSTYLE /*(729)*/, _dwg_VISUALSTYLE_fields, sizeof (struct _dwg_object_VISUALSTYLE) },	/* 1113 */
  { "VPORT", DWG_TYPE_VPORT /*(65)*/, _dwg_VPORT_fields, sizeof (struct _dwg_object_VPORT) },	/* 1114 */
  { "VPORT_CONTROL", DWG_TYPE_VPORT_CONTROL /*(64)*/, _dwg_VPORT_CONTROL_fields, sizeof (struct _dwg_object_VPORT_CONTROL) },	/* 1115 */
  { "VX_CONTROL", DWG_TYPE_VX_CONTROL /*(70)*/, _dwg_VX_CONTROL_fields, sizeof (struct _dwg_object_VX_CONTROL) },	/* 1116 */
  { "VX_TABLE_RECORD", DWG_TYPE_VX_TABLE_RECORD /*(71)*/, _dwg_VX_TABLE_RECORD_fields, sizeof (struct _dwg_object_VX_TABLE_RECORD) },	/* 1117 */
  { "WIPEOUT", DWG_TYPE_WIPEOUT /*(730)*/, _dwg_WIPEOUT_fields, sizeof (struct _dwg_entity_WIPEOUT) },	/* 1118 */
  { "WIPEOUTVARIABLES", DWG_TYPE_WIPEOUTVARIABLES /*(731)*/, _dwg_WIPEOUTVARIABLES_fields, sizeof (struct _dwg_object_WIPEOUTVARIABLES) },	/* 1119 */
  { "XLINE", DWG_TYPE_XLINE /*(41)*/, _dwg_RAY_fields, sizeof (struct _dwg_entity_RAY) },	/* 1120 */
  { "XRECORD", DWG_TYPE_XRECORD /*(79)*/, _dwg_XRECORD_fields, sizeof (struct _dwg_object_XRECORD) },	/* 1121 */
  { "XREFPANELOBJECT", DWG_TYPE_XREFPANELOBJECT /*(732)*/, NULL, 0 },	/* 1122 */
  { "XYGRIPENTITY", DWG_TYPE_XYGRIPENTITY /*(739)*/, _dwg_XYGRIPENTITY_fields, sizeof (struct _dwg_entity_XYGRIPENTITY) },	/* 1123 */
  { "XYPARAMETERENTITY", DWG_TYPE_XYPARAMETERENTITY /*(733)*/, _dwg_XYPARAMETERENTITY_fields, sizeof (struct _dwg_entity_XYPARAMETERENTITY) },	/* 1124 */
