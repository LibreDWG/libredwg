...
static const uint8_t cptbl_alnum_cp864[] = {
  75,		// size of vector
  0xa2,	// ARABIC LETTER ALEF WITH MADDA ABOVE FINAL FORM
  0xa5,	// ARABIC LETTER ALEF WITH HAMZA ABOVE FINAL FORM
  0xa8,	// ARABIC LETTER ALEF FINAL FORM
  0xa9,	// ARABIC LETTER BEH ISOLATED FORM
  0xaa,	// ARABIC LETTER TEH ISOLATED FORM
  0xab,	// ARABIC LETTER THEH ISOLATED FORM
  0xad,	// ARABIC LETTER JEEM ISOLATED FORM
  0xae,	// ARABIC LETTER HAH ISOLATED FORM
  0xaf,	// ARABIC LETTER KHAH ISOLATED FORM
  0xb0,	// ARABIC-INDIC DIGIT ZERO
  0xb1,	// ARABIC-INDIC DIGIT ONE
  0xb2,	// ARABIC-INDIC DIGIT TWO
  0xb3,	// ARABIC-INDIC DIGIT THREE
  0xb4,	// ARABIC-INDIC DIGIT FOUR
  0xb5,	// ARABIC-INDIC DIGIT FIVE
  0xb6,	// ARABIC-INDIC DIGIT SIX
  0xb7,	// ARABIC-INDIC DIGIT SEVEN
  0xb8,	// ARABIC-INDIC DIGIT EIGHT
  0xb9,	// ARABIC-INDIC DIGIT NINE
  0xba,	// ARABIC LETTER FEH ISOLATED FORM
  0xbc,	// ARABIC LETTER SEEN ISOLATED FORM
  0xbd,	// ARABIC LETTER SHEEN ISOLATED FORM
  0xbe,	// ARABIC LETTER SAD ISOLATED FORM
  0xc1,	// ARABIC LETTER HAMZA ISOLATED FORM
  0xc2,	// ARABIC LETTER ALEF WITH MADDA ABOVE ISOLATED FORM
  0xc3,	// ARABIC LETTER ALEF WITH HAMZA ABOVE ISOLATED FORM
  0xc4,	// ARABIC LETTER WAW WITH HAMZA ABOVE ISOLATED FORM
  0xc5,	// ARABIC LETTER AIN FINAL FORM
  0xc6,	// ARABIC LETTER YEH WITH HAMZA ABOVE INITIAL FORM
  0xc7,	// ARABIC LETTER ALEF ISOLATED FORM
  0xc8,	// ARABIC LETTER BEH INITIAL FORM
  0xc9,	// ARABIC LETTER TEH MARBUTA ISOLATED FORM
  0xca,	// ARABIC LETTER TEH INITIAL FORM
  0xcb,	// ARABIC LETTER THEH INITIAL FORM
  0xcc,	// ARABIC LETTER JEEM INITIAL FORM
  0xcd,	// ARABIC LETTER HAH INITIAL FORM
  0xce,	// ARABIC LETTER KHAH INITIAL FORM
  0xcf,	// ARABIC LETTER DAL ISOLATED FORM
  0xd0,	// ARABIC LETTER THAL ISOLATED FORM
  0xd1,	// ARABIC LETTER REH ISOLATED FORM
  0xd2,	// ARABIC LETTER ZAIN ISOLATED FORM
  0xd3,	// ARABIC LETTER SEEN INITIAL FORM
  0xd4,	// ARABIC LETTER SHEEN INITIAL FORM
  0xd5,	// ARABIC LETTER SAD INITIAL FORM
  0xd6,	// ARABIC LETTER DAD INITIAL FORM
  0xd7,	// ARABIC LETTER TAH ISOLATED FORM
  0xd8,	// ARABIC LETTER ZAH ISOLATED FORM
  0xd9,	// ARABIC LETTER AIN INITIAL FORM
  0xda,	// ARABIC LETTER GHAIN INITIAL FORM
  0xdf,	// ARABIC LETTER AIN ISOLATED FORM
  0xe1,	// ARABIC LETTER FEH INITIAL FORM
  0xe2,	// ARABIC LETTER QAF INITIAL FORM
  0xe3,	// ARABIC LETTER KAF INITIAL FORM
  0xe4,	// ARABIC LETTER LAM INITIAL FORM
  0xe5,	// ARABIC LETTER MEEM INITIAL FORM
  0xe6,	// ARABIC LETTER NOON INITIAL FORM
  0xe7,	// ARABIC LETTER HEH INITIAL FORM
  0xe8,	// ARABIC LETTER WAW ISOLATED FORM
  0xe9,	// ARABIC LETTER ALEF MAKSURA ISOLATED FORM
  0xea,	// ARABIC LETTER YEH INITIAL FORM
  0xeb,	// ARABIC LETTER DAD ISOLATED FORM
  0xec,	// ARABIC LETTER AIN MEDIAL FORM
  0xed,	// ARABIC LETTER GHAIN FINAL FORM
  0xee,	// ARABIC LETTER GHAIN ISOLATED FORM
  0xef,	// ARABIC LETTER MEEM ISOLATED FORM
  0xf2,	// ARABIC LETTER NOON ISOLATED FORM
  0xf3,	// ARABIC LETTER HEH ISOLATED FORM
  0xf4,	// ARABIC LETTER HEH MEDIAL FORM
  0xf5,	// ARABIC LETTER ALEF MAKSURA FINAL FORM
  0xf6,	// ARABIC LETTER YEH FINAL FORM
  0xf7,	// ARABIC LETTER GHAIN MEDIAL FORM
  0xf8,	// ARABIC LETTER QAF ISOLATED FORM
  0xfb,	// ARABIC LETTER LAM ISOLATED FORM
  0xfc,	// ARABIC LETTER KAF ISOLATED FORM
  0xfd,	// ARABIC LETTER YEH ISOLATED FORM
};
#define MIN_CP864	0
