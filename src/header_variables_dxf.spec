  ...
  SINCE(R_2004)
    {
      ...
      SINCE(R_2007) {
        ...
        HEADER_RC (XCLIPFRAME, 290);
      }
      PRE(R_2007) {
        HEADER_RC (DIMASSOC, 70);
      }
  ...
  SINCE(R_2007)
    {
      ...
      //HEADER_HANDLE (INTERFEREOBJVS, 5, 345);
      //HEADER_HANDLE (INTERFEREVPVS, 5, 346);
      //HEADER_HANDLE (DRAGVS, 5, 349);
