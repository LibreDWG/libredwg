...
/*
 * dxfclasses.c: create classes, lookup the initial class values from its DXF
 * name. generated via gperf from dxfclasses.in
 *
 * written Reini Urban
 */
...
// v3.1 changed len type from unsigned int to size_t (gperf
// d519d1a821511eaa22eae6d9019a548aea21e6)
#ifdef GPERF_VERSION
...
#endif
// internal
static const struct Dwg_DXFClass *in_word_set (register const char *str,
                                               register SIZE_TYPE len);
    ...
    hash (register const char *str, register SIZE_TYPE len)
{
  static const unsigned short asso_values[]
      = { 818, 818, 818, 818, 818, 818, 818, 818, 818, 818, 818, 818, 818,
          818, 818, 818, 818, 818, 818, 818, 818, 818, 818, 818, 818, 818,
          818, 818, 818, 818, 818, 818, 818, 818, 818, 818, 818, 818, 818,
          818, 818, 818, 818, 818, 818, 818, 818, 818, 818, 818, 818, 25,
          818, 818, 818, 818, 818, 818, 818, 818, 818, 818, 818, 818, 818,
          0,   175, 5,   165, 25,  30,  215, 5,   70,  35,  55,  50,  228,
          209, 20,  10,  75,  90,  5,   55,  5,   0,   100, 100, 90,  0,
          818, 818, 818, 818, 35,  80,  818, 818, 818, 818, 818, 818, 818,
          818, 818, 818, 818, 818, 818, 818, 818, 818, 818, 818, 818, 818,
  ...
  switch (hval)
    ...
    && (__cplusplus >= 201703L                                                \
        || (__cplusplus >= 201103L && defined __clang_major__                 \
...
#line 146 "src/dxfclasses.in"
          { (int)(size_t) & ((struct stringpool_t *)0)->stringpool_str26,
            "AcDbNurbSurface", ODBX, 1 },
          { -1 },
          { -1 },
          { -1 },
#line 171 "src/dxfclasses.in"
          { (int)(size_t) & ((struct stringpool_t *)0)->stringpool_str30,
            "AcDbAssocAction", ODBX, 0 },
          { -1 },
          { -1 },
          { -1 },
          { -1 },
...
#line 193 "src/dxfclasses.in"
          { (int)(size_t) & ((struct stringpool_t *)0)->stringpool_str77,
            "AcDbAssocExtendSurfaceActionBody", ODBX, 0 },
...
#line 95 "src/dxfclasses.in"
          { (int)(size_t) & ((struct stringpool_t *)0)->stringpool_str160,
            "AcDbProxyEntityWrapper", ODBX_OR_A2000CLASS, 0 },
          { -1 },
#line 227 "src/dxfclasses.in"
          { (int)(size_t) & ((struct stringpool_t *)0)->stringpool_str162,
            "AcDbBlockXYParameterEntity", ODBX, 1 },
          { -1 },
          { -1 },
          { -1 },
          { -1 },
...
#line 255 "src/dxfclasses.in"
          { (int)(size_t) & ((struct stringpool_t *)0)->stringpool_str367,
            "AcDbBlockAlignmentParameter", ODBX, 0 },
#line 98 "src/dxfclasses.in"
          { (int)(size_t) & ((struct stringpool_t *)0)->stringpool_str368,
            "AcDbDictionaryVar", A2000CLASS, 0 },
#line 133 "src/dxfclasses.in"
          { (int)(size_t) & ((struct stringpool_t *)0)->stringpool_str369,
            "AcDbArcAlignedText", EXPRESS, 1 },
          { -1 },
          { -1 },
#line 220 "src/dxfclasses.in"
          { (int)(size_t) & ((struct stringpool_t *)0)->stringpool_str372,
            "AcDbBlockAlignmentParameterEntity", ODBX, 1 },
          { -1 },
...
#line 234 "src/dxfclasses.in"
          { (int)(size_t) & ((struct stringpool_t *)0)->stringpool_str524,
            "AcDbBlockAlignedConstraintParameter", ODBX, 0 },
          { -1 },
          { -1 },
          { -1 },
          { -1 },
...
#line 294 "src/dxfclasses.in"
          { (int)(size_t) & ((struct stringpool_t *)0)->stringpool_str572,
            "AcDbRadialDimensionLargeObjectContextData", ODBX, 0 },
          { -1 },
          { -1 },
          { -1 },
          { -1 },
...
#line 278 "src/dxfclasses.in"
          { (int)(size_t) & ((struct stringpool_t *)0)->stringpool_str581,
            "AcDbIBLBackground", SCENEOE, 0 },
          { -1 },
          { -1 },
          { -1 },
          { -1 },
...
#line 279 "src/dxfclasses.in"
          { (int)(size_t) & ((struct stringpool_t *)0)->stringpool_str629,
            "AcDbSkyBackground", SCENEOE, 0 },
          { -1 },
          { -1 },
          { -1 },
          { -1 },
...
#line 292 "src/dxfclasses.in"
          { (int)(size_t) & ((struct stringpool_t *)0)->stringpool_str647,
            "AcDbMLeaderObjectContextData", ODBX, 0 },
          { -1 },
          { -1 },
          { -1 },
          { -1 },
...
#line 121 "src/dxfclasses.in"
          { (int)(size_t) & ((struct stringpool_t *)0)->stringpool_str674,
            "AcDbRasterImageDefReactor", ISM, 0 },
          { -1 },
          { -1 },
          { -1 },
          { -1 },
...
#line 267 "src/dxfclasses.in"
          { (int)(size_t) & ((struct stringpool_t *)0)->stringpool_str689,
            "AcDbDynamicBlockProxyNode", ODBX, 0 },
          { -1 },
          { -1 },
          { -1 },
          { -1 },
...
#line 268 "src/dxfclasses.in"
          { (int)(size_t) & ((struct stringpool_t *)0)->stringpool_str817,
            "AcDbDynamicBlockPurgePreventer", ODBX, 0 } };
...
*/
EXPORT int
dwg_require_class (Dwg_Data *restrict dwg, const char *const restrict dxfname,
                   const int len)
{
      ...
      switch ((enum apptypes)result->apptype)
        ...
        case ODBXCLASS:
          return dwg_add_class (dwg, dxfname, result->cppname,
                                "ObjectDBX Classes", result->isent);
        case ODBX_OR_A2000CLASS:
          return dwg_add_class (dwg, dxfname, result->cppname,
                                ...
                                result->isent);
        case A2000CLASS:
          return dwg_add_class (dwg, dxfname, result->cppname, "AutoCAD 2000",
                                result->isent);
        case SCENEOECLASS:
          return dwg_add_class (dwg, dxfname, result->cppname, "SCENEOE",
                                result->isent);
        case ISMCLASS:
          return dwg_add_class (dwg, dxfname, result->cppname, "ISM",
                                result->isent);
        case POINTCLOUDCLASS:
          return dwg_add_class (dwg, dxfname, result->cppname,
                                "AcDbPointCloudObj",
                                result->isent); // appname?
        case DGNLSCLASS:
          return dwg_add_class (dwg, dxfname, result->cppname, "AcDgnLS",
                                result->isent);
        case AEC60CLASS:
          return dwg_add_class (dwg, dxfname, result->cppname,
                                "AecArchBase60|Product Desc: "
        ...
        case EXPRESSCLASS:
          {
            ...
            return dwg_add_class (dwg, dxfname, result->cppname, appname,
                                  result->isent);
          }
        case SPECIALCLASS:
          {
            ...
            if (strEQc (dxfname, "MLEADERSTYLE"))
              ...
              strcpy (appname,
                      "Wipeout|Product Desc:     WipeOut Dbx Application");
            else if (strEQc (dxfname, "DIMASSOC"))
              strcpy (appname, "AcDbDimAssoc|Product Desc:     AcDim ARX App "
                               "For Dimension");
            else if (memBEGINc (dxfname, "PARTIAL_VIEWING_"))
              strcpy (appname, "OdDbPartialViewing|https://www.opendesign.com "
                               "Teigha(R) Core Db");
            else
              {
          ...
          break;
        default:
          fprintf (stderr, "dxfclass_require: Invalid apptype %d",
                   (int)result->apptype);
          return -3;
        }
    }
