...
// macOS 12.6.5 lies about its version, reporting 3.0 but emitting size_t
#ifdef GPERF_VERSION
#  if GPERF_VERSION < 301 && !defined HAVE_GPERF_SIZE_T
...
#endif
// internal
static const struct Dwg_DXFClass *in_word_set (const char *str, SIZE_TYPE len);
