...
unsigned char *
dwg_sentinel (const Dwg_Sentinel s)
{
  static const unsigned char sentinels[37][16] = {
    ...
    { 0xC4, 0x6E, 0x68, 0x54, 0xF8, 0x6E, 0x33, 0x30, 0x63, 0x3E, 0xC1, 0x85,
      0x2A, 0xDC, 0x94, 0x01 },
    // DWG_SENTINEL_R11_ENTITIES_END
    { 0x3B, 0x91, 0x97, 0xAB, 0x07, 0x91, 0xCC, 0xCF, 0x9C, 0xC1, 0x3E, 0x7A,
      0xD5, 0x23, 0x6B, 0xFE },
    // DWG_SENTINEL_R11_BLOCKS_BEGIN
    { 0xDB, 0xEF, 0xB3, 0xF0, 0xC7, 0x3E, 0x6D, 0xA6, 0xC9, 0xB6, 0x24, 0x5C,
      0x4C, 0x6F, 0x32, 0xCB },
    // DWG_SENTINEL_R11_BLOCKS_END
    { 0x24, 0x10, 0x4C, 0x0F, 0x38, 0xC1, 0x92, 0x59, 0x36, 0x49, 0xDB, 0xA3,
      0xB3, 0x90, 0xCD, 0x34 },
    // DWG_SENTINEL_R11_LAYERS_BEGIN
    { 0x0E, 0xC4, 0x64, 0x6F, 0xBB, 0x1D, 0xD3, 0x8B, 0x00, 0x49, 0xC2, 0xEF,
      0x18, 0xEA, 0x6F, 0xFB },
    // DWG_SENTINEL_R11_LAYERS_END
    { 0xF1, 0x3B, 0x9B, 0x90, 0x44, 0xE2, 0x2C, 0x74, 0xFF, 0xB6, 0x3D, 0x10,
      0xE7, 0x15, 0x90, 0x04 },
    // DWG_SENTINEL_R11_STYLES_BEGIN
    { 0xE2, 0x3E, 0xC1, 0x82, 0x43, 0x9F, 0x61, 0x77, 0x50, 0xAB, 0xC7, 0x66,
      0x96, 0x00, 0x06, 0x18 },
    // DWG_SENTINEL_R11_STYLES_END
    { 0x1D, 0xC1, 0x3E, 0x7D, 0xBC, 0x60, 0x9E, 0x88, 0xAF, 0x54, 0x38, 0x99,
      0x69, 0xFF, 0xF9, 0xE7 },
    // DWG_SENTINEL_R11_LINETYPES_BEGIN
    { 0xAC, 0x90, 0x1A, 0xCA, 0x1C, 0xBD, 0x95, 0x15, 0x16, 0x16, 0x4C, 0x14,
      0xCE, 0x18, 0x88, 0xAF },
    // DWG_SENTINEL_R11_LINETYPES_END
    { 0x53, 0x6F, 0xE5, 0x35, 0xE3, 0x42, 0x6A, 0xEA, 0xE9, 0xE9, 0xB3, 0xEB,
      0x31, 0xE7, 0x77, 0x50 },
    // DWG_SENTINEL_R11_VIEWS_BEGIN
    { 0xC1, 0x3C, 0xAA, 0x56, 0x68, 0xF4, 0xB4, 0x1E, 0x4B, 0x74, 0xF4, 0x08,
      0x42, 0x4D, 0xBF, 0xA5 },
    // DWG_SENTINEL_R11_VIEWS_END
    { 0x3E, 0xC3, 0x55, 0xA9, 0x97, 0x0B, 0x4B, 0xE1, 0xB4, 0x8B, 0x0B, 0xF7,
      0xBD, 0xB2, 0x40, 0x5A },
    // DWG_SENTINEL_R11_UCS_BEGIN
    { 0x60, 0x4A, 0xFA, 0x3D, 0x84, 0x90, 0xCC, 0x5B, 0xEF, 0xE7, 0xD6, 0xA5,
      0x7F, 0x1E, 0x61, 0xCD },
    // DWG_SENTINEL_R11_UCS_END
    { 0x9F, 0xB5, 0x05, 0xC2, 0x7B, 0x6F, 0x33, 0xA4, 0x10, 0x18, 0x29, 0x5A,
      0x80, 0xE1, 0x9E, 0x32 },
    // DWG_SENTINEL_R11_VPORTS_BEGIN
    { 0xF6, 0xED, 0x44, 0x61, 0x2A, 0xDC, 0xE4, 0x7B, 0x4E, 0xB9, 0x2B, 0xBB,
      0x66, 0x60, 0x63, 0x8D },
    // DWG_SENTINEL_R11_VPORTS_END
    { 0x09, 0x12, 0xBB, 0x9E, 0xD5, 0x23, 0x1B, 0x84, 0xB1, 0x46, 0xD4, 0x44,
      0x99, 0x9F, 0x9C, 0x72 },
    // DWG_SENTINEL_R11_APPIDS_BEGIN
    { 0xE1, 0x25, 0xC2, 0x50, 0x36, 0x68, 0x6C, 0x0C, 0x3B, 0xD3, 0x5D, 0x56,
      0xC1, 0x79, 0x1C, 0x3A },
    // DWG_SENTINEL_R11_APPIDS_END
    { 0x1E, 0xDA, 0x3D, 0xAF, 0xC9, 0x97, 0x93, 0xF3, 0xC4, 0x2C, 0xA2, 0xA9,
      0x3E, 0x86, 0xE3, 0xC5 },
    // DWG_SENTINEL_R11_DIMSTYLES_BEGIN
    { 0xB4, 0x18, 0x3E, 0x42, 0xC9, 0x9F, 0xFF, 0xE5, 0xB6, 0xE2, 0xCB, 0xB3,
      0x75, 0xC3, 0xC3, 0xB0 },
    // DWG_SENTINEL_R11_DIMSTYLES_END
    { 0x4B, 0xE7, 0xC1, 0xBD, 0x36, 0x60, 0x00, 0x1A, 0x49, 0x1D, 0x34, 0x4C,
      0x8A, 0x3C, 0x3C, 0x4F },
    // DWG_SENTINEL_R11_VXS_BEGIN
    { 0xE0, 0xCA, 0x36, 0x7C, 0xCE, 0xE7, 0x58, 0x6F, 0x2B, 0x7D, 0x74, 0x55,
      0x05, 0xF1, 0x44, 0x7F },
    // DWG_SENTINEL_R11_VXS_END
    { 0x1F, 0x35, 0xC9, 0x83, 0x31, 0x18, 0xA7, 0x90, 0xD4, 0x82, 0x8B, 0xAA,
      0xFA, 0x0E, 0xBB, 0x80 },
    // DWG_SENTINEL_R11_BLOCK_ENTITIES_BEGIN
    { 0x72, 0x2B, 0x7D, 0xEC, 0x3E, 0x8C, 0x88, 0x6C, 0x7A, 0x72, 0x0A, 0xFD,
      0xC8, 0x6C, 0x84, 0x26 },
    // DWG_SENTINEL_R11_BLOCK_ENTITIES_END
    { 0x8D, 0xD4, 0x82, 0x13, 0xC1, 0x73, 0x77, 0x93, 0x85, 0x8D, 0xF5, 0x02,
      0x37, 0x93, 0x7B, 0xD9 },
    // DWG_SENTINEL_R11_EXTRA_ENTITIES_BEGIN
    { 0xD5, 0xF9, 0xD3, 0xBB, 0x0A, 0xA9, 0x69, 0xA6, 0xCD, 0x1C, 0x87, 0xC7,
      0xEE, 0x80, 0x4B, 0x17 },
    // DWG_SENTINEL_R11_EXTRA_ENTITIES_END
    { 0x2A, 0x06, 0x2C, 0x44, 0xF5, 0x56, 0x96, 0x59, 0x32, 0xE3, 0x78, 0x38,
      0x11, 0x7F, 0xB4, 0xE8 },
    // DWG_SENTINEL_R11_AUX_HEADER_BEGIN
    { 0x29, 0x8D, 0xD1, 0x49, 0xA9, 0x73, 0x1F, 0xEA, 0x99, 0xDE, 0x32, 0xF9,
      0x4D, 0x0A, 0xE0, 0x19 },
    // DWG_SENTINEL_R11_AUX_HEADER_END
    { 0xD6, 0x72, 0x2E, 0xB6, 0x56, 0x8C, 0xE0, 0x15, 0x66, 0x21, 0xCD, 0x06,
      0xB2, 0xF5, 0x1F, 0xE6 }
  };
  return (unsigned char *)sentinels[s];
}
