...
#line 113 "src/objects.in"
      {(int)(size_t)&((struct stringpool_t *)0)->stringpool_str362,              "POLYLINE",                   DWG_TYPE_POLYLINE_R11,	1,	STABLE},
      {-1}, {-1}, {-1}, {-1}, {-1},
...
#line 138 "src/objects.in"
      {(int)(size_t)&((struct stringpool_t *)0)->stringpool_str565,                "VERTEX",                     DWG_TYPE_VERTEX_R11,	1,	STABLE},
      {-1}, {-1},
